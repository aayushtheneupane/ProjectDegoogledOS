    ...
    private void populateConstraint(Constraint constraint, TypedArray typedArray) {
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            switch (i2) {
                ...
                default:
                    switch (i2) {
                        case R$styleable.ConstraintSet_layout_constraintWidth_default:
                            constraint.rotation = typedArray.getFloat(index, constraint.rotation);
                            break;
                        case R$styleable.ConstraintSet_layout_constraintWidth_max:
                            constraint.circleConstraint = lookupID(typedArray, index, constraint.circleConstraint);
                            break;
                        case R$styleable.ConstraintSet_layout_constraintWidth_min:
                        ...
                        case 63:
                            ...
                            break;
                        case R$styleable.ConstraintSet_layout_editor_absoluteX:
