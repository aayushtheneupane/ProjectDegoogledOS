...
public class MediaRouteButton extends View {
    ...
    public MediaRouteButton(Context context, AttributeSet attributeSet, int i) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context2, R$styleable.MediaRouteButton, attributeSet, obtainStyledAttributes, i, 0);
        }
        if (isInEditMode()) {
            this.mRouter = null;
            this.mCallback = null;
        ...
        if (this.mRemoteIndicator == null) {
            if (resourceId != 0) {
                ...
                if (constantState2 != null) {
                    ...
                    this.mRemoteIndicatorLoader = new RemoteIndicatorLoader(resourceId, getContext());
                    this.mRemoteIndicatorLoader.executeOnExecutor(AsyncTask.SERIAL_EXECUTOR, new Void[0]);
                }
            } else {
    ...
    public boolean showDialog() {
        ...
        if (fragmentManager != null) {
            ...
            if (selectedRoute.isDefaultOrBluetooth() || !selectedRoute.matchesSelector(this.mSelector)) {
                ...
                beginTransaction.add((Fragment) onCreateChooserDialogFragment, "android.support.v7.mediarouter:MediaRouteChooserDialogFragment");
                ...
                beginTransaction2.add((Fragment) onCreateControllerDialogFragment, "android.support.v7.mediarouter:MediaRouteControllerDialogFragment");
    ...
    private void loadRemoteIndicatorIfNeeded() {
        if (this.mRemoteIndicatorResIdToLoad > 0) {
            ...
            this.mRemoteIndicatorLoader = new RemoteIndicatorLoader(this.mRemoteIndicatorResIdToLoad, getContext());
            this.mRemoteIndicatorResIdToLoad = 0;
            this.mRemoteIndicatorLoader.executeOnExecutor(AsyncTask.SERIAL_EXECUTOR, new Void[0]);
        }
    }
