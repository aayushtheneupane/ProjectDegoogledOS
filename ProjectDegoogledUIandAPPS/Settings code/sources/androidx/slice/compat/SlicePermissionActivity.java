...
public class SlicePermissionActivity extends Activity implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            builder.setTitle((CharSequence) getString(R$string.abc_slice_permission_title, new Object[]{unicodeWrap, unicodeWrap2}));
            ...
            ((TextView) this.mDialog.getWindow().getDecorView().findViewById(R$id.text1)).setText(getString(R$string.abc_slice_permission_text_1, new Object[]{unicodeWrap2}));
