...
public class SliceProviderCompat {
    ...
    public static java.util.Collection<android.net.Uri> getSliceDescendants(android.content.Context r3, android.net.Uri r4) {
        /*
            ...
            androidx.slice.compat.SliceProviderCompat$ProviderHolder r3 = acquireClient(r3, r4)     // Catch:{ RemoteException -> 0x003e }
            ...
            r3.close()     // Catch:{ RemoteException -> 0x003e }
        L_0x0029:
            return r4
        L_0x002a:
        ...
        L_0x0039:
            r3 = move-exception
            r4.addSuppressed(r3)     // Catch:{ RemoteException -> 0x003e }
        L_0x003d:
            throw r0     // Catch:{ RemoteException -> 0x003e }
        L_0x003e:
            r3 = move-exception
