...
public class SliceContent {
    ...
    public SliceAction getShortcut(Context context) {
        ...
        if (sliceItem2 != null) {
            i = sliceItem2.hasHint("no_tint") ? sliceItem2.hasHint("large") ? 2 : 1 : 0;
        } else {
            i = 3;
        }
        if (context != null) {
        ...
        if (context != null) {
            ...
            if (applicationInfo != null) {
                ...
                if (sliceItem3 == null && (launchIntentForPackage = packageManager.getLaunchIntentForPackage(applicationInfo.packageName)) != null) {
                    sliceItem3 = new SliceItem(PendingIntent.getActivity(context, 0, launchIntentForPackage, 0), new Slice.Builder(uri).build(), "action", (String) null, new String[0]);
                }
            }
        }
        SliceItem sliceItem4 = sliceItem3 == null ? new SliceItem(PendingIntent.getActivity(context, 0, new Intent(), 0), (Slice) null, "action", (String) null, (String[]) null) : sliceItem3;
