...
public class IconPackPreference extends Preference {
    ...
    /* renamed from: pm */
    private final PackageManager f111pm;
    ...
    public IconPackPreference(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f111pm = context.getPackageManager();
        init();
    }
    ...
    public void init() {
        ...
        try {
            ApplicationInfo applicationInfo = this.f111pm.getApplicationInfo(persistedString, 0);
            setIcon(applicationInfo.loadIcon(this.f111pm));
            setSummary(applicationInfo.loadLabel(this.f111pm));
    ...
    private Map<String, IconPackInfo> loadAvailableIconPacks() {
        ...
        List<ResolveInfo> queryIntentActivities = this.f111pm.queryIntentActivities(new Intent("com.novalauncher.THEME"), 0);
        queryIntentActivities.addAll(this.f111pm.queryIntentActivities(new Intent("org.adw.launcher.icons.ACTION_PICK_ICON"), 0));
        queryIntentActivities.addAll(this.f111pm.queryIntentActivities(new Intent("com.dlto.atom.launcher.THEME"), 0));
        queryIntentActivities.addAll(this.f111pm.queryIntentActivities(new Intent("android.intent.action.MAIN").addCategory("com.anddoes.launcher.THEME"), 0));
        for (ResolveInfo next : queryIntentActivities) {
            hashMap.put(next.activityInfo.packageName, new IconPackInfo(next, this.f111pm));
        }
        return hashMap;
    }
