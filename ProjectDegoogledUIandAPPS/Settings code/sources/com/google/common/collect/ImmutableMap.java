...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m67of() {
        return ImmutableBiMap.m63of();
    }

    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m68of(K k, V v) {
        return ImmutableBiMap.m64of(k, v);
    }
    ...
    public static class Builder<K, V> {
        ...
        public ImmutableMap<K, V> build() {
            int i = this.size;
            if (i == 0) {
                return ImmutableMap.m67of();
            }
            if (i != 1) {
                return new RegularImmutableMap(i, this.entries);
            }
            return ImmutableMap.m68of(this.entries[0].getKey(), this.entries[0].getValue());
        }
    }
    ...
    public static <K, V> ImmutableMap<K, V> copyOf(Map<? extends K, ? extends V> map) {
        ...
        return m68of(entry.getKey(), entry.getValue());
    }
