...
public class GlifLayout extends PartnerCustomizationLayout {
    ...
    public void onFinishInflate() {
        ...
        if (textView != null && this.applyPartnerHeavyThemeResource) {
            DescriptionStyler.applyPartnerCustomizationStyle(textView);
        }
        ((IconMixin) getMixin(IconMixin.class)).applyPartnerCustomizationStyle();
        ((HeaderMixin) getMixin(HeaderMixin.class)).applyPartnerCustomizationStyle();
    }
