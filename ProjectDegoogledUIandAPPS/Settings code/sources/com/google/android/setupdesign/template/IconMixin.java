...
public class IconMixin implements Mixin {
    ...
    public void applyPartnerCustomizationStyle() {
        applyPartnerCustomizationStyle(this.templateLayout.getContext(), (ImageView) this.templateLayout.findManagedViewById(R$id.sud_layout_icon));
    }

    private void applyPartnerCustomizationStyle(Context context, ImageView imageView) {
        int layoutGravity;
        if (imageView != null) {
            TemplateLayout templateLayout2 = this.templateLayout;
            if ((templateLayout2 instanceof GlifLayout) && ((GlifLayout) templateLayout2).shouldApplyPartnerHeavyThemeResource() && (layoutGravity = PartnerStyleHelper.getLayoutGravity(context)) != 0) {
    ...
    private void setGravity(ImageView imageView, int i) {
