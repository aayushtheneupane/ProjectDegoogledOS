...
public class RecyclerMixin implements Mixin {
    ...
    private DividerItemDecoration dividerDecoration = new DividerItemDecoration(this.templateLayout.getContext());
    ...
    private void updateDivider() {
        if (Build.VERSION.SDK_INT >= 19 ? this.templateLayout.isLayoutDirectionResolved() : true) {
            ...
            this.divider = DrawableLayoutDirectionHelper.createRelativeInsetDrawable(this.defaultDivider, this.dividerInsetStart, 0, this.dividerInsetEnd, 0, (View) this.templateLayout);
