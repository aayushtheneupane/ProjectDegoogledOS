...
public class PartnerCustomizationLayout extends TemplateLayout {
    ...
    public void onDetachedFromWindow() {
        ...
        if (i >= 21 && i >= 29 && WizardManagerHelper.isAnySetupWizard(this.activity.getIntent())) {
            ...
            SetupMetricsLogger.logCustomEvent(getContext(), CustomEvent.create(MetricKey.get("SetupCompatMetrics", this.activity.getClass().getSimpleName()), PersistableBundles.mergeBundles(footerBarMixin.getLoggingMetrics(), persistableBundle, persistableBundle2)));
        }
    }
