...
public class SystemNavBarMixin implements Mixin {
    ...
    public void applyPartnerCustomizations(AttributeSet attributeSet, int i) {
        if (Build.VERSION.SDK_INT >= 27) {
            ...
            this.sucSystemNavBarBackgroundColor = obtainStyledAttributes.getColor(R$styleable.SucSystemNavBarMixin_sucSystemNavBarBackgroundColor, 0);
            setSystemNavBarBackground(this.sucSystemNavBarBackgroundColor);
