...
public class ApplicationFeatureProviderGoogleImpl extends ApplicationFeatureProviderImpl {
    ...
    public CharSequence getTimeSpentInApp(String str) {
        try {
            ...
            String readableDuration = getReadableDuration(Long.valueOf(bundle2.getLong("total_time_millis")), MeasureFormat.FormatWidth.NARROW, C1715R.string.duration_less_than_one_minute, false);
            return this.mContext.getString(C1715R.string.screen_time_summary_usage_today, new Object[]{readableDuration});
        } catch (Exception e) {
