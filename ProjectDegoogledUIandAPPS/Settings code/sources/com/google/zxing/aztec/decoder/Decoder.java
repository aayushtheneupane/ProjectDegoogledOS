    ...
    static /* synthetic */ class C17061 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.aztec.decoder.Decoder.C17061.<clinit>():void");
        }
    }

    private static String getCharacter(Table table, int i) {
        int i2 = C17061.$SwitchMap$com$google$zxing$aztec$decoder$Decoder$Table[table.ordinal()];
        if (i2 == 1) {
