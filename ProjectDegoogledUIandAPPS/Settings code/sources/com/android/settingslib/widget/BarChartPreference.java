...
public class BarChartPreference extends Preference {
    ...
    public void initializeBarChart(BarChartInfo barChartInfo) {
        this.mBarChartInfo = barChartInfo;
        notifyChanged();
    }

    public void setBarViewInfos(BarViewInfo[] barViewInfoArr) {
        if (barViewInfoArr == null || barViewInfoArr.length <= 4) {
            this.mBarChartInfo.setBarViewInfos(barViewInfoArr);
            notifyChanged();
            return;
        }
