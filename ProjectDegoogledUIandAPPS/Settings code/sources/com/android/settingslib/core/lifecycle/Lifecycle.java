...
public class Lifecycle extends LifecycleRegistry {
    ...
    private final LifecycleProxy mProxy = new LifecycleProxy(this, (C14381) null);
    ...
    private class LifecycleProxy implements LifecycleObserver {
        ...
        /* synthetic */ LifecycleProxy(Lifecycle lifecycle, C14381 r2) {
            this();
        }

        @OnLifecycleEvent(Lifecycle.Event.ON_ANY)
        public void onLifecycleEvent(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
            switch (C14381.$SwitchMap$androidx$lifecycle$Lifecycle$Event[event.ordinal()]) {
                case 2:
    ...
    static /* synthetic */ class C14381 {
        ...
        static {
            ...
            L_0x0056:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.settingslib.core.lifecycle.Lifecycle.C14381.<clinit>():void");
        }
    }
}
