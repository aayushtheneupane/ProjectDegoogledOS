...
public class InputMethodAndSubtypeEnablerManagerCompat implements Preference.OnPreferenceChangeListener {
    ...
    public InputMethodAndSubtypeEnablerManagerCompat(PreferenceFragmentCompat preferenceFragmentCompat) {
        ...
        this.mImm = (InputMethodManager) preferenceFragmentCompat.getContext().getSystemService(InputMethodManager.class);
        ...
        if (subtypeCount > 1) {
            ...
            arrayList.sort(new Comparator() {
                public final int compare(Object obj, Object obj2) {
                    return InputMethodAndSubtypeEnablerManagerCompat.this.mo13441x1684631b((Preference) obj, (Preference) obj2);
                }
            });
    ...
    /* renamed from: lambda$addInputMethodSubtypePreferences$0$InputMethodAndSubtypeEnablerManagerCompat */
    public /* synthetic */ int mo13441x1684631b(Preference preference, Preference preference2) {
        if (preference instanceof InputMethodSubtypePreference) {
