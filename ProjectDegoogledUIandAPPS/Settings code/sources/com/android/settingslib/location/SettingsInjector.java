...
public class SettingsInjector {
    ...
    /* access modifiers changed from: private */
    public final Handler mHandler = new StatusLoadingHandler(this.mSettings);
    ...
    private static com.android.settingslib.location.InjectedSetting parseServiceInfo(android.content.pm.ResolveInfo r5, android.os.UserHandle r6, android.content.pm.PackageManager r7) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L_0x0029:
            ...
            android.content.res.XmlResourceParser r3 = r0.loadXmlMetaData(r7, r1)     // Catch:{ NameNotFoundException -> 0x008c }
            if (r3 == 0) goto L_0x006b
            android.util.AttributeSet r5 = android.util.Xml.asAttributeSet(r3)     // Catch:{ NameNotFoundException -> 0x008c }
        L_0x0035:
            int r1 = r3.next()     // Catch:{ NameNotFoundException -> 0x008c }
            if (r1 == r2) goto L_0x003f
            r4 = 2
            if (r1 == r4) goto L_0x003f
            goto L_0x0035
        L_0x003f:
            java.lang.String r1 = r3.getName()     // Catch:{ NameNotFoundException -> 0x008c }
            java.lang.String r2 = "injected-location-setting"
            boolean r1 = r2.equals(r1)     // Catch:{ NameNotFoundException -> 0x008c }
            if (r1 == 0) goto L_0x0063
            java.lang.String r1 = r0.packageName     // Catch:{ NameNotFoundException -> 0x008c }
            int r2 = r6.getIdentifier()     // Catch:{ NameNotFoundException -> 0x008c }
            android.content.res.Resources r7 = r7.getResourcesForApplicationAsUser(r1, r2)     // Catch:{ NameNotFoundException -> 0x008c }
            java.lang.String r1 = r0.packageName     // Catch:{ NameNotFoundException -> 0x008c }
            java.lang.String r2 = r0.name     // Catch:{ NameNotFoundException -> 0x008c }
            com.android.settingslib.location.InjectedSetting r5 = parseAttributes(r1, r2, r6, r7, r5)     // Catch:{ NameNotFoundException -> 0x008c }
            if (r3 == 0) goto L_0x0062
            r3.close()
        L_0x0062:
            return r5
        L_0x0063:
            org.xmlpull.v1.XmlPullParserException r5 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ NameNotFoundException -> 0x008c }
            java.lang.String r6 = "Meta-data does not start with injected-location-setting tag"
            r5.<init>(r6)     // Catch:{ NameNotFoundException -> 0x008c }
            throw r5     // Catch:{ NameNotFoundException -> 0x008c }
        L_0x006b:
            org.xmlpull.v1.XmlPullParserException r6 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ NameNotFoundException -> 0x008c }
            java.lang.StringBuilder r7 = new java.lang.StringBuilder     // Catch:{ NameNotFoundException -> 0x008c }
            r7.<init>()     // Catch:{ NameNotFoundException -> 0x008c }
            java.lang.String r1 = "No android.location.SettingInjectorService meta-data for "
            r7.append(r1)     // Catch:{ NameNotFoundException -> 0x008c }
            r7.append(r5)     // Catch:{ NameNotFoundException -> 0x008c }
            java.lang.String r5 = ": "
            r7.append(r5)     // Catch:{ NameNotFoundException -> 0x008c }
            r7.append(r0)     // Catch:{ NameNotFoundException -> 0x008c }
            java.lang.String r5 = r7.toString()     // Catch:{ NameNotFoundException -> 0x008c }
            r6.<init>(r5)     // Catch:{ NameNotFoundException -> 0x008c }
            throw r6     // Catch:{ NameNotFoundException -> 0x008c }
        L_0x008a:
            r5 = move-exception
            goto L_0x00a5
        L_0x008c:
            org.xmlpull.v1.XmlPullParserException r5 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ all -> 0x008a }
            ...
            java.lang.String r7 = r0.packageName     // Catch:{ all -> 0x008a }
            r6.append(r7)     // Catch:{ all -> 0x008a }
