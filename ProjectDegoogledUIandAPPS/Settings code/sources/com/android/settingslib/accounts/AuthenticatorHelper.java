...
public final class AuthenticatorHelper extends BroadcastReceiver {
    ...
    public android.graphics.drawable.Drawable getDrawableForType(android.content.Context r6, java.lang.String r7) {
        /*
            ...
            monitor-enter(r0)
            java.util.Map<java.lang.String, android.graphics.drawable.Drawable> r1 = r5.mAccTypeIconCache     // Catch:{ all -> 0x005a }
            boolean r1 = r1.containsKey(r7)     // Catch:{ all -> 0x005a }
            if (r1 == 0) goto L_0x0015
            java.util.Map<java.lang.String, android.graphics.drawable.Drawable> r5 = r5.mAccTypeIconCache     // Catch:{ all -> 0x005a }
            java.lang.Object r5 = r5.get(r7)     // Catch:{ all -> 0x005a }
            android.graphics.drawable.Drawable r5 = (android.graphics.drawable.Drawable) r5     // Catch:{ all -> 0x005a }
        ...
        L_0x0015:
            ...
            java.util.Map<java.lang.String, android.graphics.drawable.Drawable> r5 = r5.mAccTypeIconCache     // Catch:{ all -> 0x004c }
            r5.put(r7, r1)     // Catch:{ all -> 0x004c }
            monitor-exit(r0)     // Catch:{ all -> 0x004c }
            goto L_0x004f
        L_0x004c:
            r5 = move-exception
            monitor-exit(r0)     // Catch:{ all -> 0x004c }
            throw r5     // Catch:{ NameNotFoundException | NotFoundException -> 0x004f }
        L_0x004f:
            if (r1 != 0) goto L_0x0059
            android.content.pm.PackageManager r5 = r6.getPackageManager()
            android.graphics.drawable.Drawable r1 = r5.getDefaultActivityIcon()
        L_0x0059:
            return r1
        L_0x005a:
            r5 = move-exception
