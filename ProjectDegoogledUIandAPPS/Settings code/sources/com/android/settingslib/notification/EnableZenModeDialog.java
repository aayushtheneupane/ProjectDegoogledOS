...
public class EnableZenModeDialog {
    ...
    public void bind(Condition condition, View view, int i) {
        ...
        if (condition != null) {
            ...
            if (conditionTag2.f65rb != null) {
                z = false;
            }
            if (conditionTag2.f65rb == null) {
                conditionTag2.f65rb = (RadioButton) this.mZenRadioGroup.getChildAt(i);
            }
            ...
            conditionTag2.f65rb.setEnabled(z2);
            conditionTag2.f65rb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    if (z) {
                        conditionTag2.f65rb.setChecked(true);
    ...
    private void updateUi(final ConditionTag conditionTag, final View view, Condition condition, boolean z, final int i, Uri uri) {
        ...
        conditionTag.lines.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                conditionTag.f65rb.setChecked(true);
            }
        });
