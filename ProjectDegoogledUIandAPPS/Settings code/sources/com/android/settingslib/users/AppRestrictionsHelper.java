...
public class AppRestrictionsHelper {
    ...
    public void fetchAndMergeApps() {
        ...
        L_0x007f:
            ...
            java.lang.Boolean r5 = java.lang.Boolean.valueOf(r5)     // Catch:{ NameNotFoundException -> 0x0044 }
            r4.put(r3, r5)     // Catch:{ NameNotFoundException -> 0x0044 }
            goto L_0x0044
        L_0x009e:
            r2 = 8192(0x2000, float:1.14794E-41)
            r3 = 0
            android.os.UserHandle r5 = r7.mUser     // Catch:{ RemoteException -> 0x00b2 }
            int r5 = r5.getIdentifier()     // Catch:{ RemoteException -> 0x00b2 }
            android.content.pm.ParceledListSlice r1 = r1.getInstalledApplications(r2, r5)     // Catch:{ RemoteException -> 0x00b2 }
            if (r1 == 0) goto L_0x00b2
            java.util.List r1 = r1.getList()     // Catch:{ RemoteException -> 0x00b2 }
            goto L_0x00b3
        L_0x00b2:
            r1 = r3
        L_0x00b3:
