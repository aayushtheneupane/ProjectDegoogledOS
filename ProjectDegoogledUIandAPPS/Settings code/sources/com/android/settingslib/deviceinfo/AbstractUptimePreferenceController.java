...
public abstract class AbstractUptimePreferenceController extends AbstractPreferenceController implements LifecycleObserver, OnStart, OnStop {
    ...
    public void updateTimes() {
        Math.max(SystemClock.elapsedRealtime() / 1000, 1);
        ...
        this.mUptime.setSummary((CharSequence) DateUtils.formatElapsedTime(SystemClock.elapsedRealtime() / 1000) + " " + this.mContext.getString(R$string.status_deep_sleep, new Object[]{Integer.valueOf(round), "%"}));
    }
