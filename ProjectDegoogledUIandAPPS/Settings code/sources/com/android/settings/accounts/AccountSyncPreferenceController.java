...
public class AccountSyncPreferenceController extends AbstractPreferenceController implements PreferenceControllerMixin, AuthenticatorHelper.OnAccountsUpdateListener {
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        ...
        new SubSettingLauncher(this.mContext).setDestination(AccountSyncSettings.class.getName()).setArguments(bundle).setSourceMetricsCategory(8).setTitleRes(C1715R.string.account_sync_title).launch();
        return true;
    }
    ...
    public void updateSummary(Preference preference) {
        ...
        if (this.mAccount != null) {
            ...
            if (i == 0) {
                preference.setSummary((int) C1715R.string.account_sync_summary_all_off);
            } else if (i == i2) {
                preference.setSummary((int) C1715R.string.account_sync_summary_all_on);
            } else {
                preference.setSummary((CharSequence) this.mContext.getString(C1715R.string.account_sync_summary_some_on, new Object[]{Integer.valueOf(i), Integer.valueOf(i2)}));
            }
        }
    }
}
