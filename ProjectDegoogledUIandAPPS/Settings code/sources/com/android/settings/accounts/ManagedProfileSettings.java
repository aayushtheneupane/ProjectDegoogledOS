...
public class ManagedProfileSettings extends DashboardFragment {
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider() {
        ...
        public List<SearchIndexableResource> getXmlResourcesToIndex(Context context, boolean z) {
            ...
            searchIndexableResource.xmlResId = C1715R.xml.managed_profile_settings;
    ...
    public int getPreferenceScreenResId() {
        return C1715R.xml.managed_profile_settings;
    }
    ...
    public void onAttach(Context context) {
        ...
        ((CrossProfileCalendarDisabledPreferenceController) use(CrossProfileCalendarDisabledPreferenceController.class)).setManagedUser(this.mManagedUser);
    }
