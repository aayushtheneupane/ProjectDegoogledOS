...
class LocaleDragCell extends RelativeLayout {
    ...
    public void onFinishInflate() {
        ...
        this.mLabel = (TextView) findViewById(C1715R.C1718id.label);
        this.mLocalized = (TextView) findViewById(C1715R.C1718id.l10nWarn);
        this.mMiniLabel = (TextView) findViewById(C1715R.C1718id.miniLabel);
        this.mCheckbox = (CheckBox) findViewById(C1715R.C1718id.checkbox);
        this.mDragHandle = (ImageView) findViewById(C1715R.C1718id.dragHandle);
    }
