...
public class ActionDisabledByAdminDialogHelper {
    ...
    public AlertDialog.Builder prepareDialogBuilder(String str, RestrictedLockUtils.EnforcedAdmin enforcedAdmin) {
        ...
        this.mDialogView = (ViewGroup) LayoutInflater.from(builder.getContext()).inflate(C1715R.layout.admin_support_details_dialog, (ViewGroup) null);
        initializeDialogViews(this.mDialogView, this.mEnforcedAdmin.component, getEnforcementAdminUserId(), this.mRestriction);
        builder.setPositiveButton((int) C1715R.string.okay, (DialogInterface.OnClickListener) null);
        builder.setView((View) this.mDialogView);
    ...
    public void maybeSetLearnMoreButton(AlertDialog.Builder builder) {
        ...
        if (userManager.isSameProfileGroup(getEnforcementAdminUserId(this.mEnforcedAdmin), userManager.getUserHandle())) {
            builder.setNeutralButton(C1715R.string.learn_more, new DialogInterface.OnClickListener() {
                public final void onClick(DialogInterface dialogInterface, int i) {
                    ActionDisabledByAdminDialogHelper.this.mo9742x24a8038(dialogInterface, i);
                }
            });
        }
    }

    /* renamed from: lambda$maybeSetLearnMoreButton$0$ActionDisabledByAdminDialogHelper */
    public /* synthetic */ void mo9742x24a8038(DialogInterface dialogInterface, int i) {
    ...
    private void initializeDialogViews(View view, ComponentName componentName, int i, String str) {
        if (componentName != null) {
            ImageView imageView = (ImageView) view.requireViewById(C1715R.C1718id.admin_support_icon);
    ...
    public void setAdminSupportTitle(View view, String str) {
        TextView textView = (TextView) view.findViewById(C1715R.C1718id.admin_support_dialog_title);
        if (textView != null) {
            if (str == null) {
                textView.setText(C1715R.string.disabled_by_policy_title);
                return;
            }
            char c = 65535;
            switch (str.hashCode()) {
            ...
            if (c == 0) {
                textView.setText(C1715R.string.disabled_by_policy_title_adjust_volume);
            } else if (c == 1) {
                textView.setText(C1715R.string.disabled_by_policy_title_outgoing_calls);
            } else if (c == 2) {
                textView.setText(C1715R.string.disabled_by_policy_title_sms);
            } else if (c == 3) {
                textView.setText(C1715R.string.disabled_by_policy_title_camera);
            } else if (c == 4) {
                textView.setText(C1715R.string.disabled_by_policy_title_screen_capture);
            } else if (c != 5) {
                textView.setText(C1715R.string.disabled_by_policy_title);
            } else {
                textView.setText(C1715R.string.disabled_by_policy_title_suspend_packages);
            }
        }
    }
    ...
    public void setAdminSupportDetails(Activity activity, View view, RestrictedLockUtils.EnforcedAdmin enforcedAdmin) {
        if (enforcedAdmin != null && enforcedAdmin.component != null) {
            ...
            if (charSequence != null) {
                ((TextView) view.findViewById(C1715R.C1718id.admin_support_msg)).setText(charSequence);
            }
        }
    }
