...
public class WifiDppUtils {
    ...
    public static Intent getHotspotConfiguratorIntentOrNull(Context context, WifiManager wifiManager, WifiConfiguration wifiConfiguration) {
        Intent intent = new Intent(context, WifiDppConfiguratorActivity.class);
    ...
    public static void showLockScreen(Context context, final Runnable runnable) {
        ...
        if (keyguardManager.isKeyguardSecure()) {
            C13571 r1 = new BiometricPrompt.AuthenticationCallback() {
            ...
            BiometricPrompt.Builder title = new BiometricPrompt.Builder(context).setTitle(context.getText(C1715R.string.wifi_dpp_lockscreen_title));
    ...
    private static boolean isSupportHotspotConfiguratorQrCodeGenerator(WifiConfiguration wifiConfiguration) {
        if (wifiConfiguration.allowedKeyManagement.get(4) || wifiConfiguration.allowedKeyManagement.get(0)) {
            return true;
        }
        return false;
    }
