...
public class WifiNetworkConfig {
    ...
    public List<WifiConfiguration> getWifiConfigurations() {
        ...
        if (TextUtils.isEmpty(this.mSecurity) || "nopass".equals(this.mSecurity)) {
            ...
            basicWifiConfiguration2.allowedKeyManagement.set(9);
            basicWifiConfiguration2.requirePMF = true;
        ...
        if (this.mSecurity.startsWith("WEP")) {
            basicWifiConfiguration3.allowedKeyManagement.set(0);
            basicWifiConfiguration3.allowedAuthAlgorithms.set(0);
            basicWifiConfiguration3.allowedAuthAlgorithms.set(1);
            ...
            basicWifiConfiguration3.allowedKeyManagement.set(1);
            ...
            basicWifiConfiguration3.allowedKeyManagement.set(8);
            basicWifiConfiguration3.requirePMF = true;
