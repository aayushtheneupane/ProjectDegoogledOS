...
public class BackupSettingsHelper {
    ...
    public String getSummary() {
        ...
        try {
            return this.mContext.getText(this.mBackupManager.isBackupEnabled() ? C1715R.string.backup_summary_state_on : C1715R.string.backup_summary_state_off).toString();
    ...
    public CharSequence getLabelForBackupSettings() {
        ...
        return TextUtils.isEmpty(labelFromBackupTransport) ? this.mContext.getString(C1715R.string.privacy_settings_title) : labelFromBackupTransport;
    }

    public String getSummaryForBackupSettings() {
        String summaryFromBackupTransport = getSummaryFromBackupTransport();
        return summaryFromBackupTransport == null ? this.mContext.getString(C1715R.string.backup_configure_account_default_summary) : summaryFromBackupTransport;
    }
    ...
    public boolean isBackupProvidedByManufacturer() {
        ...
        String string = this.mContext.getResources().getString(C1715R.string.config_backup_settings_intent);
        return string != null && !string.isEmpty();
    }

    public String getLabelProvidedByManufacturer() {
        return this.mContext.getResources().getString(C1715R.string.config_backup_settings_label);
    }
