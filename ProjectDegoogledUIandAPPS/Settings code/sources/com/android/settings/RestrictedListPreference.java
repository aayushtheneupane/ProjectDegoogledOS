...
public class RestrictedListPreference extends CustomListPreference {
    ...
    public class RestrictedArrayAdapter extends ArrayAdapter<CharSequence> {
        ...
        public RestrictedArrayAdapter(Context context, CharSequence[] charSequenceArr, int i) {
            super(context, C1715R.layout.restricted_dialog_singlechoice, C1715R.C1718id.text1, charSequenceArr);
            this.mSelectedIndex = i;
        }

        public View getView(int i, View view, ViewGroup viewGroup) {
            View view2 = super.getView(i, view, viewGroup);
            CheckedTextView checkedTextView = (CheckedTextView) view2.findViewById(C1715R.C1718id.text1);
            ImageView imageView = (ImageView) view2.findViewById(C1715R.C1718id.restricted_lock_icon);
            boolean z = false;
