...
public final class BluetoothPairingService extends Service {
    ...
    public void onCreate() {
        ((NotificationManager) getSystemService("notification")).createNotificationChannel(new NotificationChannel("bluetooth_notification_channel", getString(C1715R.string.bluetooth), 4));
    }
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        Notification.Builder localOnly = new Notification.Builder(this, "bluetooth_notification_channel").setSmallIcon(17301632).setTicker(resources.getString(C1715R.string.bluetooth_notif_ticker)).setLocalOnly(true);
        ...
        if (bluetoothDevice == null || bluetoothDevice.getBondState() == 11) {
            ...
            if (TextUtils.isEmpty(stringExtra)) {
                ...
                stringExtra = bluetoothDevice2 != null ? bluetoothDevice2.getAliasName() : resources.getString(17039374);
            }
            Log.d("BluetoothPairingService", "Show pairing notification for " + this.mDevice.getAddress() + " (" + stringExtra + ")");
            localOnly.setContentTitle(resources.getString(C1715R.string.bluetooth_notif_title)).setContentText(resources.getString(C1715R.string.bluetooth_notif_message, new Object[]{stringExtra})).setContentIntent(activity).setDefaults(1).setColor(getColor(17170460)).addAction(new Notification.Action.Builder(0, resources.getString(C1715R.string.bluetooth_device_context_pair_connect), activity).build()).addAction(new Notification.Action.Builder(0, resources.getString(17039360), broadcast).build());
