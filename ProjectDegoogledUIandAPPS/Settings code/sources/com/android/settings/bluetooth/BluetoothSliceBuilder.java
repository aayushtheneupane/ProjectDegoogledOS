...
public class BluetoothSliceBuilder {
    ...
    public static Slice getSlice(Context context) {
        ...
        CharSequence text = context.getText(C1715R.string.bluetooth_settings);
        IconCompat createWithResource = IconCompat.createWithResource(context, 17302809);
        ...
        SliceAction createToggle = SliceAction.createToggle(broadcastIntent, (CharSequence) null, isBluetoothEnabled);
    ...
    public static Intent getIntent(Context context) {
        String charSequence = context.getText(C1715R.string.bluetooth_settings_title).toString();
