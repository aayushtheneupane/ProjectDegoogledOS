...
public class BluetoothPairingDetail extends DeviceListPreferenceFragment implements Indexable {
    ...
    public int getHelpResource() {
        return C1715R.string.help_url_bluetooth;
    }
    ...
    public int getPreferenceScreenResId() {
        return C1715R.xml.bluetooth_pairing_detail;
    }
    ...
    public void updateContent(int i) {
        if (i == 10) {
            ...
            this.mBluetoothAdapter.enable();
            addDeviceCategory(this.mAvailableDevicesCategory, C1715R.string.bluetooth_preference_found_media_devices, BluetoothDeviceFilter.ALL_FILTER, this.mInitialScanStarted);
    ...
    public void showBluetoothTurnedOnToast() {
        Toast.makeText(getContext(), C1715R.string.connected_device_bluetooth_turned_on_toast, 0).show();
    }
}
