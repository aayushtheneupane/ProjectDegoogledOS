            ...
            if (!((UserManager) context.getSystemService("user")).isManagedProfile()) {
                ...
                if (!checkUserChoice()) {
                    ...
                    if (!((PowerManager) context.getSystemService("power")).isScreenOn() || !LocalBluetoothPreferences.shouldShowDialogInForeground(context, address, str3)) {
                        ...
                        if (i == 2) {
                            str = context.getString(C1715R.string.bluetooth_phonebook_request);
                            str2 = context.getString(C1715R.string.bluetooth_pb_acceptance_dialog_text, new Object[]{createRemoteName, createRemoteName});
                        } else if (i == 3) {
                            str = context.getString(C1715R.string.bluetooth_map_request);
                            str2 = context.getString(C1715R.string.bluetooth_map_acceptance_dialog_text, new Object[]{createRemoteName, createRemoteName});
                        } else if (i != 4) {
                            str = context.getString(C1715R.string.bluetooth_connection_permission_request);
                            str2 = context.getString(C1715R.string.bluetooth_connection_dialog_text, new Object[]{createRemoteName, createRemoteName});
                        } else {
                            str = context.getString(C1715R.string.bluetooth_sap_request);
                            str2 = context.getString(C1715R.string.bluetooth_sap_acceptance_dialog_text, new Object[]{createRemoteName, createRemoteName});
                        }
                        NotificationManager notificationManager = (NotificationManager) context.getSystemService("notification");
                        if (this.mNotificationChannel == null) {
                            this.mNotificationChannel = new NotificationChannel("bluetooth_notification_channel", context.getString(C1715R.string.bluetooth), 4);
