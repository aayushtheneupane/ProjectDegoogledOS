...
public class AccessibilityTimeoutController extends AbstractPreferenceController implements LifecycleObserver, RadioButtonPreference.OnClickListener, PreferenceControllerMixin {
    ...
    private Map<String, Integer> getTimeoutValueToKeyMap() {
        if (this.mAccessibilityTimeoutKeyToValueMap.size() == 0) {
            String[] stringArray = this.mResources.getStringArray(C1715R.array.accessibility_timeout_control_selector_keys);
            int[] intArray = this.mResources.getIntArray(C1715R.array.accessibility_timeout_selector_values);
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        this.mPreference = (RadioButtonPreference) preferenceScreen.findPreference(getPreferenceKey());
