...
public class LockScreenNotificationPreferenceController extends AbstractPreferenceController implements PreferenceControllerMixin, Preference.OnPreferenceChangeListener, LifecycleObserver, OnResume, OnPause {
    ...
    public LockScreenNotificationPreferenceController(Context context, String str, String str2, String str3) {
        ...
        this.mSecureProfile = i != -10000 && lockPatternUtils.isSecure(i);
    }
    ...
    private void initLockScreenNotificationPrefDisplay() {
        ...
        String string = this.mContext.getString(C1715R.string.lock_screen_notifications_summary_show);
        String num = Integer.toString(C1715R.string.lock_screen_notifications_summary_show);
        arrayList.add(string);
        arrayList2.add(num);
        setRestrictedIfNotificationFeaturesDisabled(string, num, 12);
        if (this.mSecure) {
            String string2 = this.mContext.getString(C1715R.string.lock_screen_notifications_summary_hide);
            String num2 = Integer.toString(C1715R.string.lock_screen_notifications_summary_hide);
            arrayList.add(string2);
            arrayList2.add(num2);
            setRestrictedIfNotificationFeaturesDisabled(string2, num2, 4);
        }
        arrayList.add(this.mContext.getString(C1715R.string.lock_screen_notifications_summary_disable));
        arrayList2.add(Integer.toString(C1715R.string.lock_screen_notifications_summary_disable));
    ...
    private void initLockscreenNotificationPrefForProfile() {
        ...
        ArrayList arrayList = new ArrayList();
        ArrayList arrayList2 = new ArrayList();
        String string = this.mContext.getString(C1715R.string.lock_screen_notifications_summary_show_profile);
        String num = Integer.toString(C1715R.string.lock_screen_notifications_summary_show_profile);
        arrayList.add(string);
        arrayList2.add(num);
        setRestrictedIfNotificationFeaturesDisabled(string, num, 12);
        if (this.mSecureProfile) {
            String string2 = this.mContext.getString(C1715R.string.lock_screen_notifications_summary_hide_profile);
            String num2 = Integer.toString(C1715R.string.lock_screen_notifications_summary_hide_profile);
            arrayList.add(string2);
            arrayList2.add(num2);
            setRestrictedIfNotificationFeaturesDisabled(string2, num2, 4);
        }
    ...
    public boolean onPreferenceChange(Preference preference, Object obj) {
        ...
        if (TextUtils.equals(this.mWorkSettingKey, key)) {
            ...
            if (parseInt2 == C1715R.string.lock_screen_notifications_summary_show_profile) {
                i = 1;
            }
            ...
            int i2 = parseInt != C1715R.string.lock_screen_notifications_summary_disable ? 1 : 0;
            if (parseInt == C1715R.string.lock_screen_notifications_summary_show) {
                i = 1;
            }
    ...
    public static int getSummaryResource(Context context) {
        ...
        if (!lockscreenNotificationsEnabled) {
            return C1715R.string.lock_screen_notifications_summary_disable;
        }
        return z ? C1715R.string.lock_screen_notifications_summary_show : C1715R.string.lock_screen_notifications_summary_hide;
    }
    ...
    public void updateLockscreenNotificationsForProfile() {
        ...
        if (i != -10000 && this.mLockscreenProfile != null) {
            ...
            this.mLockscreenSelectedValueProfile = z ? C1715R.string.lock_screen_notifications_summary_show_profile : C1715R.string.lock_screen_notifications_summary_hide_profile;
