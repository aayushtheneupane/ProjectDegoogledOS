...
public class ZenModeEventRuleSettings extends ZenModeRuleSettingsBase {
    ...
    public int getPreferenceScreenResId() {
        return C1715R.xml.zen_mode_event_rule_settings;
    }
    ...
    private void reloadCalendar() {
        ...
        arrayList.add(getString(C1715R.string.zen_mode_event_rule_calendar_any));
        String str = null;
    ...
    public void onCreateInternal() {
        ...
        this.mReply.setEntries(new CharSequence[]{getString(C1715R.string.zen_mode_event_rule_reply_any_except_no), getString(C1715R.string.zen_mode_event_rule_reply_yes_or_maybe), getString(C1715R.string.zen_mode_event_rule_reply_yes)});
