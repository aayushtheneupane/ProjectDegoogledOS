...
public class ZenRuleVisEffectPreferenceController extends AbstractZenCustomRulePreferenceController implements Preference.OnPreferenceChangeListener {
    ...
    public boolean isAvailable() {
        ...
        if (this.mEffect == 1) {
            return this.mContext.getResources().getBoolean(17891494);
        }
        return true;
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object obj) {
        ...
        AutomaticZenRule automaticZenRule = this.mRule;
        automaticZenRule.setZenPolicy(new ZenPolicy.Builder(automaticZenRule.getZenPolicy()).showVisualEffect(this.mEffect, !booleanValue).build());
