...
public class VolumeSeekBarPreference extends SeekBarPreference {
    ...
    public VolumeSeekBarPreference(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        setLayoutResource(C1715R.layout.preference_volume_slider);
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        this.mSuppressionTextView = (TextView) preferenceViewHolder.findViewById(C1715R.C1718id.suppression_text);
        init();
    }
    ...
    public void init() {
        if (this.mSeekBar != null) {
            C10511 r0 = new SeekBarVolumizer.Callback() {
    ...
    private Uri getMediaVolumeUri() {
        return Uri.parse("android.resource://" + getContext().getPackageName() + "/" + C1715R.raw.media_volume);
    }
