...
public class ZenRuleButtonsPreferenceController extends AbstractZenModePreferenceController implements PreferenceControllerMixin {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        if (isAvailable()) {
            this.mButtonsPref = ((ActionButtonsPreference) preferenceScreen.findPreference("zen_action_buttons")).setButton1Text(C1715R.string.zen_mode_rule_name_edit).setButton1Icon(17302742).setButton1OnClickListener(new EditRuleNameClickListener()).setButton2Text(C1715R.string.zen_mode_delete_rule_button).setButton2Icon(C1715R.C1717drawable.ic_settings_delete).setButton2OnClickListener(new DeleteRuleClickListener());
        }
    }
