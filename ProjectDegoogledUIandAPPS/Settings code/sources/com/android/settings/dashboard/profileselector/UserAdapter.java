...
public class UserAdapter implements SpinnerAdapter, ListAdapter {
    ...
    public static class UserDetails {
        ...
        public UserDetails(UserHandle userHandle, UserManager userManager, Context context) {
            ...
            if (userInfo.isManagedProfile()) {
                this.mName = context.getString(C1715R.string.managed_user_title);
                drawable = context.getDrawable(17302363);
            } else {
    ...
    private int getTitle(UserDetails userDetails) {
        ...
        return (identifier == -2 || identifier == ActivityManager.getCurrentUser()) ? C1715R.string.category_personal : C1715R.string.category_work;
    }

    private View createUser(ViewGroup viewGroup) {
        return this.mInflater.inflate(C1715R.layout.user_preference, viewGroup, false);
    }
