...
public class DashboardFragmentRegistry {
    ...
    static {
        PARENT_TO_CATEGORY_KEY_MAP.put(TopLevelSettings.class.getName(), "com.android.settings.category.ia.homepage");
        ...
        for (Map.Entry next : PARENT_TO_CATEGORY_KEY_MAP.entrySet()) {
            CATEGORY_KEY_TO_PARENT_MAP.put((String) next.getValue(), (String) next.getKey());
        }
    }
}
