...
public class KeyboardLayoutDialogFragment extends InstrumentedDialogFragment implements InputManager.InputDeviceListener, LoaderManager.LoaderCallbacks<Keyboards> {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        builder.setTitle((int) C1715R.string.keyboard_layout_dialog_title);
        builder.setPositiveButton((int) C1715R.string.keyboard_layout_dialog_setup_button, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
                KeyboardLayoutDialogFragment.this.onSetupLayoutsButtonClicked();
            }
        });
        builder.setSingleChoiceItems((ListAdapter) this.mAdapter, -1, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
                KeyboardLayoutDialogFragment.this.onKeyboardLayoutClicked(i);
            }
        });
        builder.setView(from.inflate(C1715R.layout.keyboard_layout_dialog_switch_hint, (ViewGroup) null));
    ...
    private void updateSwitchHintVisibility() {
        AlertDialog alertDialog = (AlertDialog) getDialog();
        if (alertDialog != null) {
            alertDialog.findViewById(C1715R.C1718id.customPanel).setVisibility(this.mAdapter.getCount() > 1 ? 0 : 8);
        }
    }
    ...
    private static final class KeyboardLayoutAdapter extends ArrayAdapter<KeyboardLayout> {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (keyboardLayout != null) {
                ...
                str = getContext().getString(C1715R.string.keyboard_layout_default_label);
                str2 = "";
            }
            String str3 = str2;
            String str4 = str;
