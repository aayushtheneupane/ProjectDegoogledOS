...
public class UserDictionaryAddWordContents {
    ...
    UserDictionaryAddWordContents(View view, Bundle bundle) {
        EditText editText;
        this.mWordEditText = (EditText) view.findViewById(C1715R.C1718id.user_dictionary_add_word_text);
        this.mShortcutEditText = (EditText) view.findViewById(C1715R.C1718id.user_dictionary_add_shortcut);
    ...
    public static class LocaleRenderer {
        ...
        public LocaleRenderer(Context context, String str) {
            ...
            if (str == null) {
                this.mDescription = context.getString(C1715R.string.user_dict_settings_more_languages);
            } else if ("".equals(str)) {
                this.mDescription = context.getString(C1715R.string.user_dict_settings_all_languages);
            } else {
