...
public class SpellCheckerPreferenceController extends AbstractPreferenceController implements PreferenceControllerMixin {
    ...
    public boolean isAvailable() {
        return this.mContext.getResources().getBoolean(C1715R.bool.config_show_spellcheckers_settings);
    }
    ...
    public void updateState(Preference preference) {
        if (preference != null) {
            ...
            if (currentSpellChecker != null) {
                ...
                preference.setSummary((int) C1715R.string.spell_checker_not_selected);
            }
        }
    }
}
