...
final class SetNewPasswordController {
    ...
    public static SetNewPasswordController create(Context context, C1135Ui ui, Intent intent, IBinder iBinder) {
        int i;
    ...
    SetNewPasswordController(int i, PackageManager packageManager, FingerprintManager fingerprintManager, FaceManager faceManager, DevicePolicyManager devicePolicyManager, C1135Ui ui) {
        ...
        this.mUi = (C1135Ui) Preconditions.checkNotNull(ui);
    }
