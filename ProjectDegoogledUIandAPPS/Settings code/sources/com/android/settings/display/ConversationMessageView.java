...
public class ConversationMessageView extends FrameLayout {
    ...
    public ConversationMessageView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        LayoutInflater.from(context).inflate(C1715R.layout.conversation_message_icon, this);
        LayoutInflater.from(context).inflate(C1715R.layout.conversation_message_content, this);
    }

    /* access modifiers changed from: protected */
    public void onFinishInflate() {
        this.mMessageBubble = (LinearLayout) findViewById(C1715R.C1718id.message_content);
        this.mMessageTextAndInfoView = (ViewGroup) findViewById(C1715R.C1718id.message_text_and_info);
        this.mMessageTextView = (TextView) findViewById(C1715R.C1718id.message_text);
        this.mStatusTextView = (TextView) findViewById(C1715R.C1718id.message_status);
        this.mContactIconView = (TextView) findViewById(C1715R.C1718id.conversation_icon);
        updateViewContent();
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        this.mMessageBubble.measure(View.MeasureSpec.makeMeasureSpec((((size - (this.mContactIconView.getMeasuredWidth() * 2)) - getResources().getDimensionPixelSize(C1715R.dimen.message_bubble_arrow_width)) - getPaddingLeft()) - getPaddingRight(), Integer.MIN_VALUE), makeMeasureSpec);
    ...
    private void updateViewContent() {
        ...
        this.mContactIconView.setBackground(getTintedDrawable(getContext(), getContext().getDrawable(C1715R.C1717drawable.conversation_message_icon), this.mIconBackgroundColor));
    }

    private void updateViewAppearance() {
        int i;
        Resources resources = getResources();
        int dimensionPixelOffset = resources.getDimensionPixelOffset(C1715R.dimen.message_bubble_arrow_width);
        int dimensionPixelOffset2 = resources.getDimensionPixelOffset(C1715R.dimen.message_text_left_right_padding);
        int dimensionPixelOffset3 = resources.getDimensionPixelOffset(C1715R.dimen.message_text_top_padding);
        int dimensionPixelOffset4 = resources.getDimensionPixelOffset(C1715R.dimen.message_text_bottom_padding);
        if (this.mIncoming) {
        ...
        int dimensionPixelSize = resources.getDimensionPixelSize(C1715R.dimen.message_padding_default);
        int dimensionPixelOffset5 = resources.getDimensionPixelOffset(C1715R.dimen.message_metadata_top_padding);
        int i4 = this.mIncoming ? C1715R.C1717drawable.msg_bubble_incoming : C1715R.C1717drawable.msg_bubble_outgoing;
        int i5 = this.mIncoming ? C1715R.C1716color.message_bubble_incoming : C1715R.C1716color.message_bubble_outgoing;
    ...
    private void updateTextAppearance() {
        int i = this.mIncoming ? C1715R.C1716color.message_text_incoming : C1715R.C1716color.message_text_outgoing;
        int i2 = this.mIncoming ? C1715R.C1716color.timestamp_text_incoming : C1715R.C1716color.timestamp_text_outgoing;
