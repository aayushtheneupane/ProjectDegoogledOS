...
public class ImeiInfoPreferenceController extends BasePreferenceController {
    ...
    public ImeiInfoPreferenceController(Context context, String str) {
        ...
        this.mIsMultiSim = this.mTelephonyManager.getPhoneCount() <= 1 ? false : true;
    }
    ...
    private CharSequence getTitleForGsmPhone(int i) {
        if (!this.mIsMultiSim) {
            return this.mContext.getString(C1715R.string.status_imei);
        }
        return this.mContext.getString(C1715R.string.imei_multi_sim, new Object[]{Integer.valueOf(i + 1)});
    }

    private CharSequence getTitleForCdmaPhone(int i) {
        if (!this.mIsMultiSim) {
            return this.mContext.getString(C1715R.string.status_meid_number);
        }
        return this.mContext.getString(C1715R.string.meid_multi_sim, new Object[]{Integer.valueOf(i + 1)});
    }
