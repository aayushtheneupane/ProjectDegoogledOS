...
public class StorageWizardInit extends StorageWizardBase {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C1715R.layout.storage_wizard_init);
        this.mIsPermittedToAdopt = UserManager.get(this).isAdminUser() && !ActivityManager.isUserAMonkey();
        setHeaderText(C1715R.string.storage_wizard_init_v2_title, getDiskShortDescription());
        this.mInternal = (Button) requireViewById(C1715R.C1718id.storage_wizard_init_internal);
        setBackButtonText(C1715R.string.storage_wizard_init_v2_later, new CharSequence[0]);
