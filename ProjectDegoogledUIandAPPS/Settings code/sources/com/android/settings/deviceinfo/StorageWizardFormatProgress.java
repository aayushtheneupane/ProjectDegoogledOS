...
public class StorageWizardFormatProgress extends StorageWizardBase {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setHeaderText(C1715R.string.storage_wizard_format_progress_title, getDiskShortDescription());
        setBodyText(C1715R.string.storage_wizard_format_progress_body, getDiskDescription());
        setBackButtonVisibility(4);
        setNextButtonVisibility(4);
        this.mTask = (PartitionTask) getLastCustomNonConfigurationInstance();
