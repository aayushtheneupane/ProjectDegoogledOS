...
public class UsbDetailsDataRoleController extends UsbDetailsController implements RadioButtonPreference.OnClickListener {
    ...
    private final Runnable mFailureCallback = new Runnable() {
        public final void run() {
            UsbDetailsDataRoleController.this.lambda$new$0$UsbDetailsDataRoleController();
        }
    };
    ...
    public /* synthetic */ void lambda$new$0$UsbDetailsDataRoleController() {
        RadioButtonPreference radioButtonPreference = this.mNextRolePref;
        if (radioButtonPreference != null) {
            radioButtonPreference.setSummary((int) C1715R.string.usb_switching_failed);
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        this.mHostPref = makeRadioPreference(UsbBackend.dataRoleToString(1), C1715R.string.usb_control_host);
        this.mDevicePref = makeRadioPreference(UsbBackend.dataRoleToString(2), C1715R.string.usb_control_device);
    }
    ...
    public void refresh(boolean z, long j, int i, int i2) {
        ...
        if (radioButtonPreference != null && i2 != 0) {
            if (UsbBackend.dataRoleFromString(radioButtonPreference.getKey()) == i2) {
                ...
                this.mNextRolePref.setSummary((int) C1715R.string.usb_switching_failed);
            }
            this.mNextRolePref = null;
    ...
    public void onRadioButtonClicked(RadioButtonPreference radioButtonPreference) {
        ...
        if (dataRoleFromString != this.mUsbBackend.getDataRole() && this.mNextRolePref == null && !Utils.isMonkeyRunning()) {
            ...
            radioButtonPreference.setSummary((int) C1715R.string.usb_switching);
            this.mHandler.postDelayed(this.mFailureCallback, this.mUsbBackend.areAllRolesSupported() ? 3000 : 15000);
        }
    }

    public boolean isAvailable() {
        return !Utils.isMonkeyRunning() && !this.mUsbBackend.isSingleDataRoleSupported();
    }
