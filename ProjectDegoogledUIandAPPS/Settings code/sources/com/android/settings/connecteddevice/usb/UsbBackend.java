...
public class UsbBackend {
    ...
    public boolean isSingleDataRoleSupported() {
        UsbPortStatus usbPortStatus;
        if (!(this.mPort == null || (usbPortStatus = this.mPortStatus) == null)) {
            if (!usbPortStatus.isRoleCombinationSupported(2, 1) && !this.mPortStatus.isRoleCombinationSupported(1, 1)) {
                return true;
            }
            if (this.mPortStatus.isRoleCombinationSupported(2, 2) || this.mPortStatus.isRoleCombinationSupported(1, 2)) {
                return false;
            }
            return true;
        }
    ...
    public boolean isSinglePowerRoleSupported() {
        UsbPortStatus usbPortStatus;
        if (!(this.mPort == null || (usbPortStatus = this.mPortStatus) == null)) {
            if (!usbPortStatus.isRoleCombinationSupported(2, 2) && !this.mPortStatus.isRoleCombinationSupported(2, 1)) {
                return true;
            }
            if (this.mPortStatus.isRoleCombinationSupported(1, 2) || this.mPortStatus.isRoleCombinationSupported(1, 1)) {
                return false;
            }
            return true;
        }
