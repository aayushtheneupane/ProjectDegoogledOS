    ...
    private boolean buildDialog(ComponentName componentName, String str) {
        if (componentName == null || str == null) {
            ...
            if (defaultPaymentApp == null || !defaultPaymentApp.equals(componentName)) {
                ...
                alertParams.mTitle = getString(C1715R.string.nfc_payment_set_default_label);
                if (paymentAppInfo2 == null) {
                    alertParams.mMessage = String.format(getString(C1715R.string.nfc_payment_set_default), new Object[]{sanitizePaymentAppCaption(paymentAppInfo.label.toString())});
                } else {
                    alertParams.mMessage = String.format(getString(C1715R.string.nfc_payment_set_default_instead_of), new Object[]{sanitizePaymentAppCaption(paymentAppInfo.label.toString()), sanitizePaymentAppCaption(paymentAppInfo2.label.toString())});
                }
