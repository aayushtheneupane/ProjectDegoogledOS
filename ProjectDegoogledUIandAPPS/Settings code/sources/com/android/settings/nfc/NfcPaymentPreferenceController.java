...
public class NfcPaymentPreferenceController extends BasePreferenceController implements PaymentBackend.Callback, View.OnClickListener, NfcPaymentPreference.Listener, LifecycleObserver, OnStart, OnStop {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        this.mPreference = (NfcPaymentPreference) preferenceScreen.findPreference(getPreferenceKey());
        NfcPaymentPreference nfcPaymentPreference = this.mPreference;
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        this.mSettingsButtonView = (ImageView) preferenceViewHolder.findViewById(C1715R.C1718id.settings_button);
    ...
    public CharSequence getSummary() {
        ...
        return this.mContext.getText(C1715R.string.nfc_payment_default_not_set);
    }
    ...
    private class NfcPaymentAdapter extends BaseAdapter implements CompoundButton.OnCheckedChangeListener, View.OnClickListener {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
                view = this.mLayoutInflater.inflate(C1715R.layout.nfc_payment_option, viewGroup, false);
                viewHolder = new ViewHolder();
                viewHolder.radioButton = (RadioButton) view.findViewById(C1715R.C1718id.button);
