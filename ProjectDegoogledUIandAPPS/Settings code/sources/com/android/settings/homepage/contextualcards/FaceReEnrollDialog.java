...
public class FaceReEnrollDialog extends AlertActivity implements DialogInterface.OnClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        alertParams.mTitle = getText(C1715R.string.security_settings_face_enroll_improve_face_alert_title);
        alertParams.mMessage = getText(C1715R.string.security_settings_face_enroll_improve_face_alert_body);
        alertParams.mPositiveButtonText = getText(C1715R.string.storage_menu_set_up);
        alertParams.mNegativeButtonText = getText(C1715R.string.cancel);
