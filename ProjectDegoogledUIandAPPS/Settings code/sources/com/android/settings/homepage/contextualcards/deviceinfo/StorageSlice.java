...
public class StorageSlice implements CustomSliceable {
    ...
    public Slice getSlice() {
        IconCompat createWithResource = IconCompat.createWithResource(this.mContext, C1715R.C1717drawable.ic_homepage_storage);
        String string = this.mContext.getString(C1715R.string.storage_label);
    ...
    public Intent getIntent() {
        return SliceBuilderUtils.buildSearchResultPageIntent(this.mContext, StorageDashboardFragment.class.getName(), "", this.mContext.getText(C1715R.string.storage_label).toString(), 1401).setClassName(this.mContext.getPackageName(), SubSettings.class.getName()).setData(CustomSliceRegistry.STORAGE_SLICE_URI);
    }
    ...
    public CharSequence getStorageSummaryText(PrivateStorageInfo privateStorageInfo) {
        ...
        return context.getString(C1715R.string.storage_volume_total, new Object[]{Formatter.formatShortFileSize(context, privateStorageInfo.totalBytes)});
    }
}
