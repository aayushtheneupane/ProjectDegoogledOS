...
public class BatteryFixSlice implements CustomSliceable {
    ...
    private static final Map<Integer, List<Integer>> UNIMPORTANT_BATTERY_TIPS = new ArrayMap();
    ...
    static {
        UNIMPORTANT_BATTERY_TIPS.put(6, Arrays.asList(new Integer[]{0, 1}));
        UNIMPORTANT_BATTERY_TIPS.put(3, Arrays.asList(new Integer[]{1}));
    }
    ...
    public Intent getIntent() {
        String charSequence = this.mContext.getText(C1715R.string.power_usage_summary_title).toString();
    ...
    private Slice buildBatteryGoodSlice(ListBuilder listBuilder, boolean z) {
        IconCompat createWithResource = IconCompat.createWithResource(this.mContext, C1715R.C1717drawable.ic_battery_status_good_24dp);
        String string = this.mContext.getString(C1715R.string.power_usage_summary_title);
    ...
    public static void updateBatteryTipAvailabilityCache(Context context) {
        ThreadUtils.postOnBackgroundThread((Callable) new Callable(context) {
