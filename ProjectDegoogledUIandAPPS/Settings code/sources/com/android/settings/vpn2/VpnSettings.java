...
public class VpnSettings extends RestrictedSettingsFragment implements Handler.Callback, Preference.OnPreferenceClickListener {
    ...
    public int getHelpResource() {
        return C1715R.string.help_url_vpn;
    }
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        addPreferencesFromResource(C1715R.xml.vpn_settings2);
    }

    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        super.onCreateOptionsMenu(menu, menuInflater);
        menuInflater.inflate(C1715R.C1720menu.vpn, menu);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        if (menuItem.getItemId() != C1715R.C1718id.vpn_create) {
    ...
    public void onResume() {
        ...
        if (this.mUnavailable) {
            if (!isUiRestrictedByOnlyAdmin()) {
                getEmptyTextView().setText(C1715R.string.vpn_settings_not_available);
            }
            getPreferenceScreen().removeAll();
            return;
        }
        setEmptyView(getEmptyTextView());
        getEmptyTextView().setText(C1715R.string.vpn_no_vpns_added);
    ...
    private Set<AppVpnInfo> getConnectedAppVpns() {
        ...
        try {
            for (UserHandle next : this.mUserManager.getUserProfiles()) {
                VpnConfig vpnConfig = this.mConnectivityService.getVpnConfig(next.getIdentifier());
    ...
    private Set<AppVpnInfo> getAlwaysOnAppVpnInfos() {
        ...
        for (UserHandle identifier : this.mUserManager.getUserProfiles()) {
            ...
            String alwaysOnVpnPackageForUser = this.mConnectivityManager.getAlwaysOnVpnPackageForUser(identifier2);
