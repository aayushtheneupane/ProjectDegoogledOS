...
public class FaceEnrollPreviewFragment extends InstrumentedPreferenceFragment implements BiometricEnrollSidecar.Listener {
    ...
    private final CameraDevice.StateCallback mCameraStateCallback = new CameraDevice.StateCallback() {
        public void onOpened(CameraDevice cameraDevice) {
            ...
            try {
                ...
                CaptureRequest.Builder unused2 = FaceEnrollPreviewFragment.this.mPreviewRequestBuilder = FaceEnrollPreviewFragment.this.mCameraDevice.createCaptureRequest(1);
                    ...
                    public void onConfigured(CameraCaptureSession cameraCaptureSession) {
                        if (FaceEnrollPreviewFragment.this.mCameraDevice != null) {
                            ...
                            try {
                                ...
                                CaptureRequest unused2 = FaceEnrollPreviewFragment.this.mPreviewRequest = FaceEnrollPreviewFragment.this.mPreviewRequestBuilder.build();
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.mTextureView = (FaceSquareTextureView) getActivity().findViewById(C1715R.C1718id.texture_view);
        this.mCircleView = (ImageView) getActivity().findViewById(C1715R.C1718id.circle_view);
        this.mCircleView.setLayerType(1, (Paint) null);
    ...
    public void configureTransform(int i, int i2) {
        if (this.mTextureView != null) {
            ...
            float f = width / min;
            float f2 = height / min;
            this.mTextureView.setTranslationX(getResources().getDimension(C1715R.dimen.face_preview_translate_x));
            this.mTextureView.setTranslationY(getResources().getDimension(C1715R.dimen.face_preview_translate_y));
            TypedValue typedValue = new TypedValue();
            getResources().getValue(C1715R.dimen.face_preview_scale, typedValue, true);
            this.mTextureView.setScaleX(f * typedValue.getFloat());
            this.mTextureView.setScaleY(f2 * typedValue.getFloat());
        }
    }
