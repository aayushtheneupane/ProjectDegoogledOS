...
public class FaceSettingsSwipePreferenceController extends FaceSettingsPreferenceController {
    @VisibleForTesting
    protected FaceManager mFaceManager;
    private UserManager mUserManager;

    public FaceSettingsSwipePreferenceController(Context context, String str) {
        super(context, str);
    ...
    public boolean isChecked() {
        return Settings.Secure.getIntForUser(this.mContext.getContentResolver(), "face_unlock_always_require_swipe", this.mContext.getResources().getBoolean(17891467) ? 1 : 0, getUserId()) != 0;
    }

    public boolean setChecked(boolean z) {
        Settings.Secure.putInt(this.mContext.getContentResolver(), "face_unlock_always_require_swipe", z ? 1 : 0);
        return true;
    }
