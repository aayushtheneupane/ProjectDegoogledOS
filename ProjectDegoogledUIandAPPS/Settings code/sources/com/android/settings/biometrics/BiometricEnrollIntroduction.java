...
public abstract class BiometricEnrollIntroduction extends BiometricEnrollBase implements LinkSpan.OnClickListener {
    ...
    public void onResume() {
        ...
        getNextButton().setText(getResources().getString(C1715R.string.done));
        getNextButton().setVisibility(0);
    }
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        if (i == 2) {
            ...
            overridePendingTransition(C1715R.anim.sud_slide_back_in, C1715R.anim.sud_slide_back_out);
        }
    ...
    public void initViews() {
        super.initViews();
        TextView textView = (TextView) findViewById(C1715R.C1718id.sud_layout_description);
        if (this.mBiometricUnlockDisabledByAdmin) {
