...
public class CryptKeeperConfirm extends InstrumentedFragment {
    ...
    public static class Blank extends Activity {
        ...
        public void onCreate(Bundle bundle) {
            ...
            setContentView(C1715R.layout.crypt_keeper_blank);
            if (Utils.isMonkeyRunning()) {
                finish();
            }
    ...
    private void establishFinalConfirmationState() {
        this.mFinalButton = (Button) this.mContentView.findViewById(C1715R.C1718id.execute_encrypt);
        this.mFinalButton.setOnClickListener(this.mFinalClickListener);
    }

    public void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        getActivity().setTitle(C1715R.string.crypt_keeper_confirm_title);
    }

    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        this.mContentView = layoutInflater.inflate(C1715R.layout.crypt_keeper_confirm, (ViewGroup) null);
