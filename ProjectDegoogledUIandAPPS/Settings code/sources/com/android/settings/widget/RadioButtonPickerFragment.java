...
public abstract class RadioButtonPickerFragment extends InstrumentedPreferenceFragment implements RadioButtonPreference.OnClickListener {
    ...
    public void updateCandidates() {
        ...
        if (shouldShowItemNone()) {
            ...
            radioButtonPreference.setIcon((int) C1715R.C1717drawable.ic_remove_circle);
            radioButtonPreference.setTitle((int) C1715R.string.app_list_preference_none);
    ...
    private void addIllustration(PreferenceScreen preferenceScreen) {
        this.mVideoPreference = new VideoPreference(getContext());
        this.mVideoPreference.setVideo(this.mIllustrationId, this.mIllustrationPreviewId);
