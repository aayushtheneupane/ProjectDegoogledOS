...
public class SeekBarPreference extends RestrictedPreference implements SeekBar.OnSeekBarChangeListener, View.OnKeyListener {
    ...
    public SeekBarPreference(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        int resourceId = obtainStyledAttributes2.getResourceId(0, 17367252);
    ...
    public SeekBarPreference(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, TypedArrayUtils.getAttr(context, C1715R.attr.seekBarPreferenceStyle, 17957066));
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        this.mSeekBar = (SeekBar) preferenceViewHolder.findViewById(16909332);
        ...
        if (seekBar instanceof DefaultIndicatorSeekBar) {
            ((DefaultIndicatorSeekBar) seekBar).setDefaultProgress(this.mDefaultProgress);
        }
    ...
    public boolean onKey(View view, int i, KeyEvent keyEvent) {
        SeekBar seekBar;
        if (keyEvent.getAction() == 0 && (seekBar = (SeekBar) view.findViewById(16909332)) != null) {
