...
public class UpdatableListPreferenceDialogFragment extends PreferenceDialogFragmentCompat implements Instrumentable {
    ...
    public void onPrepareDialogBuilder(AlertDialog.Builder builder) {
        ...
        builder.setSingleChoiceItems((ListAdapter) this.mAdapter, this.mClickedDialogEntryIndex, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
            public final void onClick(DialogInterface dialogInterface, int i) {
                UpdatableListPreferenceDialogFragment.this.mo12305x3c3a9cf7(dialogInterface, i);
            }
        });
    ...
    /* renamed from: lambda$onPrepareDialogBuilder$0$UpdatableListPreferenceDialogFragment */
    public /* synthetic */ void mo12305x3c3a9cf7(DialogInterface dialogInterface, int i) {
