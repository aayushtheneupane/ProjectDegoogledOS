...
public class UsageGraph extends View {
    ...
    public UsageGraph(Context context, AttributeSet attributeSet) {
        ...
        this.mCornerRadius = resources.getDimensionPixelSize(C1715R.dimen.usage_graph_line_corner_radius);
        this.mLinePaint.setPathEffect(new CornerPathEffect((float) this.mCornerRadius));
        this.mLinePaint.setStrokeWidth((float) resources.getDimensionPixelSize(C1715R.dimen.usage_graph_line_width));
        ...
        float dimensionPixelSize = (float) resources.getDimensionPixelSize(C1715R.dimen.usage_graph_dot_size);
        this.mDottedPaint.setStrokeWidth(3.0f * dimensionPixelSize);
        this.mDottedPaint.setPathEffect(new DashPathEffect(new float[]{dimensionPixelSize, (float) resources.getDimensionPixelSize(C1715R.dimen.usage_graph_dot_interval)}, 0.0f));
        this.mDottedPaint.setColor(context.getColor(C1715R.C1716color.usage_graph_dots));
        ...
        this.mDividerSize = resources.getDimensionPixelSize(C1715R.dimen.usage_graph_divider_size);
    }
    ...
    public void calculateLocalPaths(SparseIntArray sparseIntArray, SparseIntArray sparseIntArray2) {
        ...
        if (getWidth() != 0) {
            ...
            for (int i3 = 0; i3 < sparseIntArray.size(); i3++) {
                ...
                if (valueAt != -1) {
                    int x = getX((float) keyAt);
                    int y = getY((float) valueAt);
