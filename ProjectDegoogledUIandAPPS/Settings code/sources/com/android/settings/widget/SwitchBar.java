...
public class SwitchBar extends LinearLayout implements CompoundButton.OnCheckedChangeListener {
    private static final int[] XML_ATTRIBUTES = {C1715R.attr.switchBarMarginStart, C1715R.attr.switchBarMarginEnd, C1715R.attr.switchBarBackgroundColor, C1715R.attr.switchBarBackgroundActivatedColor, C1715R.attr.switchBarRestrictionIcon};
    ...
    public SwitchBar(final Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        LayoutInflater.from(context).inflate(C1715R.layout.switch_bar, this);
        setFocusable(true);
        setClickable(true);
        ...
        this.mTextView = (TextView) findViewById(C1715R.C1718id.switch_text);
        this.mSummarySpan = new TextAppearanceSpan(this.mContext, 2131952204);
        ...
        this.mSwitch = (ToggleSwitch) findViewById(C1715R.C1718id.switch_widget);
        ...
        setSwitchBarText(C1715R.string.switch_on_text, C1715R.string.switch_off_text);
        addOnSwitchChangeListener(new OnSwitchChangeListener() {
            public final void onSwitchChanged(Switch switchR, boolean z) {
                SwitchBar.this.lambda$new$0$SwitchBar(switchR, z);
            }
        });
        this.mRestrictedIcon = (ImageView) findViewById(C1715R.C1718id.restricted_icon);
        this.mRestrictedIcon.setImageDrawable(drawable);
    ...
    public /* synthetic */ void lambda$new$0$SwitchBar(Switch switchR, boolean z) {
    ...
    public void setDisabledByAdmin(RestrictedLockUtils.EnforcedAdmin enforcedAdmin) {
        ...
        if (enforcedAdmin != null) {
            ...
            this.mRestrictedIcon.setFocusable(false);
            this.mRestrictedIcon.setClickable(false);
            return;
        }
