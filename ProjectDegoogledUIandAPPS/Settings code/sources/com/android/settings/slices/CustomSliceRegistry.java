...
public class CustomSliceRegistry {
    public static final Uri AIRPLANE_URI = new Uri.Builder().scheme("content").authority("android.settings.slices").appendPath("action").appendPath("airplane_mode").build();
    ...
    public static final Uri CONTEXTUAL_NOTIFICATION_CHANNEL_SLICE_URI = new Uri.Builder().scheme("content").authority("com.android.settings.slices").appendPath("action").appendPath("contextual_notification_channel").build();
    ...
    public static final Uri DATA_USAGE_SLICE_URI = new Uri.Builder().scheme("content").authority("com.android.settings.slices").appendPath("action").appendPath("data_usage_card").build();
    public static final Uri DEVICE_INFO_SLICE_URI = new Uri.Builder().scheme("content").authority("com.android.settings.slices").appendPath("intent").appendPath("device_info_card").build();
    public static final Uri EMERGENCY_INFO_SLICE_URI = new Uri.Builder().scheme("content").authority("com.android.settings.slices").appendPath("intent").appendPath("emergency_info_card").build();
    ...
    public static final Uri NOTIFICATION_CHANNEL_SLICE_URI = new Uri.Builder().scheme("content").authority("com.android.settings.slices").appendPath("action").appendPath("notification_channel").build();
    ...
    public static final Uri VOLUME_REMOTE_MEDIA_URI = new Uri.Builder().scheme("content").authority("com.android.settings.slices").appendPath("action").appendPath("remote_volume").build();
    ...
    static {
        ...
        sUriToSlice.put(CONTEXTUAL_NOTIFICATION_CHANNEL_SLICE_URI, ContextualNotificationChannelSlice.class);
