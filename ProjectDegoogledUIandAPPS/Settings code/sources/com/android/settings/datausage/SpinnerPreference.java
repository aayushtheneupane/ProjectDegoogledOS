...
public class SpinnerPreference extends Preference implements CycleAdapter.SpinnerInterface {
    ...
    public SpinnerPreference(Context context, AttributeSet attributeSet) {
        ...
        setLayoutResource(C1715R.layout.data_usage_cycles);
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        SettingsSpinner settingsSpinner = (SettingsSpinner) preferenceViewHolder.findViewById(C1715R.C1718id.cycles_spinner);
    ...
    public void performClick(View view) {
        view.findViewById(C1715R.C1718id.cycles_spinner).performClick();
    }
}
