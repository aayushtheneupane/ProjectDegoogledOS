...
public class PreferenceControllerListHelper {
    public static List<BasePreferenceController> getPreferenceControllersFromXml(Context context, int i) {
        ...
        try {
            for (Bundle next : PreferenceXmlParserUtils.extractMetadata(context, i, 11)) {
                ...
                if (!TextUtils.isEmpty(string)) {
                    try {
                        ...
                        if (TextUtils.isEmpty(string2)) {
                            ...
                            try {
                                basePreferenceController = BasePreferenceController.createInstance(context, string, string2);
