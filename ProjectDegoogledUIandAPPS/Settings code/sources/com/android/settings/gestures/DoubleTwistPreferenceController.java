...
public class DoubleTwistPreferenceController extends GesturePreferenceController {
    ...
    public static boolean isGestureAvailable(Context context) {
        ...
        String string = resources.getString(C1715R.string.gesture_double_twist_sensor_name);
        String string2 = resources.getString(C1715R.string.gesture_double_twist_sensor_vendor);
