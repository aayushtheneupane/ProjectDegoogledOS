...
public final class Utils extends com.android.settingslib.Utils {
    ...
    public static void prepareCustomPreferencesList(ViewGroup viewGroup, View view, View view2, boolean z) {
        if (view2.getScrollBarStyle() == 33554432) {
            int dimensionPixelSize = view2.getResources().getDimensionPixelSize(17105369);
    ...
    public static void forceCustomPadding(View view, boolean z) {
        view.setPaddingRelative(z ? view.getPaddingStart() : 0, 0, z ? view.getPaddingEnd() : 0, view.getResources().getDimensionPixelSize(17105369));
    }
    ...
    public static int getPINPasswordLength(LockPatternUtils lockPatternUtils, int i) {
        int i2;
        try {
            i2 = (int) lockPatternUtils.getLockSettings().getLong("lockscreen.pin_password_length", 0, i);
        } catch (Exception e) {
    ...
    public static String normalizeTitleCaseIfRequired(Context context, String str) {
        return !context.getResources().getBoolean(C1715R.bool.language_capitalizes_nouns) ? str.toLowerCase() : str;
    }
}
