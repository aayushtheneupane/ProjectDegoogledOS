...
public class AppStateNotificationBridge extends AppStateBaseBridge {
    ...
    public static CharSequence getSummary(Context context, NotificationsSentState notificationsSentState, int i) {
        if (i == C1715R.C1718id.sort_order_recent_notification) {
        ...
        } else if (i != C1715R.C1718id.sort_order_frequent_notification) {
            return "";
        } else {
            if (notificationsSentState.avgSentDaily > 0) {
                Resources resources = context.getResources();
                int i2 = notificationsSentState.avgSentDaily;
                return resources.getQuantityString(C1715R.plurals.notifications_sent_daily, i2, new Object[]{Integer.valueOf(i2)});
            }
            Resources resources2 = context.getResources();
            int i3 = notificationsSentState.avgSentWeekly;
            return resources2.getQuantityString(C1715R.plurals.notifications_sent_weekly, i3, new Object[]{Integer.valueOf(i3)});
        }
    }
    ...
    private void addBlockStatus(ApplicationsState.AppEntry appEntry, NotificationsSentState notificationsSentState) {
        if (notificationsSentState != null) {
            ...
            boolean z = notificationsSentState.systemApp;
            notificationsSentState.blockable = !z || (z && notificationsSentState.blocked);
        }
    }
    ...
    public /* synthetic */ void lambda$getSwitchOnClickListener$0$AppStateNotificationBridge(ApplicationsState.AppEntry appEntry, View view) {
        Switch switchR = (Switch) ((ViewGroup) view).findViewById(C1715R.C1718id.switchWidget);
        if (switchR != null && switchR.isEnabled()) {
            switchR.toggle();
            this.mBackend.setNotificationsEnabledForPackage(appEntry.info.packageName, appEntry.info.uid, switchR.isChecked());
