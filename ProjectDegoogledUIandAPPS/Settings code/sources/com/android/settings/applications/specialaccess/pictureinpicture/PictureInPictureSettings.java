...
public class PictureInPictureSettings extends EmptyTextSettings {
    ...
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider() {
        public List<SearchIndexableResource> getXmlResourcesToIndex(Context context, boolean z) {
            ...
            searchIndexableResource.xmlResId = C1715R.xml.picture_in_picture_settings;
    ...
    public int getPreferenceScreenResId() {
        return C1715R.xml.picture_in_picture_settings;
    }
        ...
        while (it.hasNext()) {
            ...
            appPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                public boolean onPreferenceClick(Preference preference) {
                    ...
                    AppInfoBase.startAppInfoFragment(PictureInPictureDetails.class, C1715R.string.picture_in_picture_app_detail_title, str, i, pictureInPictureSettings, -1, pictureInPictureSettings.getMetricsCategory());
                    return true;
                }
            });
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        setEmptyText(C1715R.string.picture_in_picture_empty_text);
    }
