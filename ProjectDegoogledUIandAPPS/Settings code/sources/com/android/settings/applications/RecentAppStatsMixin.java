...
public class RecentAppStatsMixin implements Comparator<UsageStats>, LifecycleObserver, OnStart {
    ...
    static {
        SKIP_SYSTEM_PACKAGES.addAll(Arrays.asList(new String[]{"android", "com.android.phone", "com.android.settings", "com.android.systemui", "com.android.providers.calendar", "com.android.providers.media"}));
    }
    ...
    public /* synthetic */ void lambda$onStart$1$RecentAppStatsMixin() {
        ...
        for (RecentAppStatsListener r1 : this.mAppStatsListeners) {
            ThreadUtils.postOnMainThread(new Runnable(r1) {
                private final /* synthetic */ RecentAppStatsMixin.RecentAppStatsListener f$1;
