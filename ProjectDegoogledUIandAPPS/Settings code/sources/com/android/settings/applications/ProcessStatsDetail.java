...
public class ProcessStatsDetail extends SettingsPreferenceFragment {
    ...
    private void createDetails() {
        addPreferencesFromResource(C1715R.xml.app_memory_settings);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        this.mForceStop = menu.add(0, 1, 0, C1715R.string.force_stop);
        checkForceStop();
    }
    ...
    private void fillProcessesSection() {
        ...
        for (int i2 = 0; i2 < arrayList.size(); i2++) {
            ...
            preference.setSummary((CharSequence) getString(C1715R.string.memory_use_running_format, Formatter.formatShortFileSize(getActivity(), Math.max((long) (d * d2), (long) (procStatsEntry2.mBgWeight * d2))), ProcStatsPackageEntry.getFrequency(((float) max) / ((float) this.mTotalTime), getActivity())));
    ...
    private void showStopServiceDialog(final String str, final String str2) {
        ...
        builder.setTitle((int) C1715R.string.runningservicedetails_stop_dlg_title);
        builder.setMessage((int) C1715R.string.runningservicedetails_stop_dlg_text);
