...
public class AppOpsState {
    ...
    public AppOpsState(Context context) {
        ...
        this.mOpSummaries = context.getResources().getTextArray(C1715R.array.app_ops_summaries);
        this.mOpLabels = context.getResources().getTextArray(C1715R.array.app_ops_labels);
    }
    ...
    public static class AppOpEntry {
        ...
        public CharSequence getTimeText(Resources resources, boolean z) {
            if (isRunning()) {
                return resources.getText(C1715R.string.app_ops_running);
            }
            if (getTime() > 0) {
                return DateUtils.getRelativeTimeSpanString(getTime(), System.currentTimeMillis(), 60000, 262144);
            }
            return z ? resources.getText(C1715R.string.app_ops_never_used) : "";
        }
    ...
    public java.util.List<com.android.settings.applications.appops.AppOpsState.AppOpEntry> buildState(com.android.settings.applications.appops.AppOpsState.OpsTemplate r28, int r29, java.lang.String r30, java.util.Comparator<com.android.settings.applications.appops.AppOpsState.AppOpEntry> r31) {
        /*
            r27 = this;
            r7 = r27
            r0 = r28
