...
public final class ProcStatsEntry implements Parcelable {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:123:0x03f2  */
    /* JADX WARNING: Removed duplicated region for block: B:144:0x0413 A[SYNTHETIC] */
    ...
    public void evaluateTargetPackage(android.content.pm.PackageManager r24, com.android.internal.app.procstats.ProcessStats r25, com.android.internal.app.procstats.ProcessStats.ProcessDataCollection r26, com.android.internal.app.procstats.ProcessStats.ProcessDataCollection r27, java.util.Comparator<com.android.settings.applications.ProcStatsEntry> r28, boolean r29) {
        ...
        L_0x0224:
            ...
            goto L_0x02ca
        L_0x0228:
            java.lang.String r1 = r14.mPackage     // Catch:{ NameNotFoundException -> 0x03e6 }
            r15 = r24
            android.content.pm.ApplicationInfo r1 = r15.getApplicationInfo(r1, r6)     // Catch:{ NameNotFoundException -> 0x03e8 }
            int r4 = r1.icon     // Catch:{ NameNotFoundException -> 0x03e8 }
            if (r4 != 0) goto L_0x025a
            boolean r1 = DEBUG     // Catch:{ NameNotFoundException -> 0x03e8 }
            if (r1 == 0) goto L_0x0222
            java.lang.StringBuilder r1 = new java.lang.StringBuilder     // Catch:{ NameNotFoundException -> 0x03e8 }
            r1.<init>()     // Catch:{ NameNotFoundException -> 0x03e8 }
            r1.append(r3)     // Catch:{ NameNotFoundException -> 0x03e8 }
            java.lang.String r4 = r0.mName     // Catch:{ NameNotFoundException -> 0x03e8 }
            r1.append(r4)     // Catch:{ NameNotFoundException -> 0x03e8 }
            r1.append(r2)     // Catch:{ NameNotFoundException -> 0x03e8 }
            java.lang.String r4 = r14.mPackage     // Catch:{ NameNotFoundException -> 0x03e8 }
            r1.append(r4)     // Catch:{ NameNotFoundException -> 0x03e8 }
            java.lang.String r4 = " has no icon"
            r1.append(r4)     // Catch:{ NameNotFoundException -> 0x03e8 }
            java.lang.String r1 = r1.toString()     // Catch:{ NameNotFoundException -> 0x03e8 }
            android.util.Log.d(r5, r1)     // Catch:{ NameNotFoundException -> 0x03e8 }
            goto L_0x0222
        L_0x025a:
            int r1 = r1.flags     // Catch:{ NameNotFoundException -> 0x03e8 }
            r1 = r1 & 8
            java.lang.String r4 = " not as good as last "
            if (r1 == 0) goto L_0x02ce
            r18 = r7
            long r6 = r14.mRunDuration     // Catch:{ NameNotFoundException -> 0x03ea }
            if (r11 == 0) goto L_0x029e
            int r19 = (r6 > r12 ? 1 : (r6 == r12 ? 0 : -1))
            if (r19 <= 0) goto L_0x026d
            goto L_0x029e
        L_0x026d:
            boolean r19 = DEBUG     // Catch:{ NameNotFoundException -> 0x03ea }
            if (r19 == 0) goto L_0x0224
            java.lang.StringBuilder r1 = new java.lang.StringBuilder     // Catch:{ NameNotFoundException -> 0x03ea }
            r1.<init>()     // Catch:{ NameNotFoundException -> 0x03ea }
            r1.append(r3)     // Catch:{ NameNotFoundException -> 0x03ea }
            r27 = r8
            java.lang.String r8 = r0.mName     // Catch:{ NameNotFoundException -> 0x03ec }
            r1.append(r8)     // Catch:{ NameNotFoundException -> 0x03ec }
            r1.append(r2)     // Catch:{ NameNotFoundException -> 0x03ec }
            java.lang.String r8 = r14.mPackage     // Catch:{ NameNotFoundException -> 0x03ec }
            r1.append(r8)     // Catch:{ NameNotFoundException -> 0x03ec }
            java.lang.String r8 = " pers run time "
            r1.append(r8)     // Catch:{ NameNotFoundException -> 0x03ec }
            r1.append(r6)     // Catch:{ NameNotFoundException -> 0x03ec }
            r1.append(r4)     // Catch:{ NameNotFoundException -> 0x03ec }
            r1.append(r12)     // Catch:{ NameNotFoundException -> 0x03ec }
            java.lang.String r1 = r1.toString()     // Catch:{ NameNotFoundException -> 0x03ec }
            android.util.Log.d(r5, r1)     // Catch:{ NameNotFoundException -> 0x03ec }
            goto L_0x02ca
        L_0x029e:
            r27 = r8
            boolean r1 = DEBUG     // Catch:{ NameNotFoundException -> 0x03ec }
            if (r1 == 0) goto L_0x02c8
            java.lang.StringBuilder r1 = new java.lang.StringBuilder     // Catch:{ NameNotFoundException -> 0x03ec }
            r1.<init>()     // Catch:{ NameNotFoundException -> 0x03ec }
            r1.append(r3)     // Catch:{ NameNotFoundException -> 0x03ec }
            java.lang.String r4 = r0.mName     // Catch:{ NameNotFoundException -> 0x03ec }
            r1.append(r4)     // Catch:{ NameNotFoundException -> 0x03ec }
            r1.append(r2)     // Catch:{ NameNotFoundException -> 0x03ec }
            java.lang.String r4 = r14.mPackage     // Catch:{ NameNotFoundException -> 0x03ec }
            r1.append(r4)     // Catch:{ NameNotFoundException -> 0x03ec }
