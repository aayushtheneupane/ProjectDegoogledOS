...
public class ResetAppsHelper implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
    ...
    public void buildResetDialog() {
        if (this.mResetDialog == null) {
            ...
            builder.setTitle((int) C1715R.string.reset_app_preferences_title);
            builder.setMessage((int) C1715R.string.reset_app_preferences_desc);
            builder.setPositiveButton((int) C1715R.string.reset_app_preferences_button, (DialogInterface.OnClickListener) this);
        ...
        if (this.mResetDialog == dialogInterface) {
            AsyncTask.execute(new Runnable() {
                public void run() {
                    ...
                    List asList = Arrays.asList(ResetAppsHelper.this.mContext.getResources().getStringArray(C1715R.array.config_skip_reset_apps_package_name));
