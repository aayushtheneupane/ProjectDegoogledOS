...
public abstract class AppStateBaseBridge implements ApplicationsState.Callbacks {
    ...
    public AppStateBaseBridge(ApplicationsState applicationsState, Callback callback) {
        ...
        this.mAppSession = applicationsState2 != null ? applicationsState2.newSession(this) : null;
        this.mCallback = callback;
        ApplicationsState applicationsState3 = this.mAppState;
        if (applicationsState3 != null) {
            looper = applicationsState3.getBackgroundLooper();
        } else {
