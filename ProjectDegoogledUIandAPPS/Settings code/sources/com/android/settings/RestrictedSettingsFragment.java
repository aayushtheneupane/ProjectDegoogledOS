...
public abstract class RestrictedSettingsFragment extends SettingsPreferenceFragment {
    ...
    private void ensurePin() {
        ...
        if (!this.mChallengeSucceeded && !this.mChallengeRequested && this.mRestrictionsManager.hasRestrictionsProvider() && (createLocalApprovalIntent = this.mRestrictionsManager.createLocalApprovalIntent()) != null) {
            ...
            persistableBundle.putString("android.request.mesg", getResources().getString(C1715R.string.restr_pin_enter_admin_pin));
    ...
    public RestrictedLockUtils.EnforcedAdmin getRestrictionEnforcedAdmin() {
        this.mEnforcedAdmin = RestrictedLockUtilsInternal.checkIfRestrictionEnforced(getActivity(), this.mRestrictionKey, UserHandle.myUserId());
        RestrictedLockUtils.EnforcedAdmin enforcedAdmin = this.mEnforcedAdmin;
        if (enforcedAdmin != null && enforcedAdmin.user == null) {
