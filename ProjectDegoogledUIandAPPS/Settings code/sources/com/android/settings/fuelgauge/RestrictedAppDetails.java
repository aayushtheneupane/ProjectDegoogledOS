...
public class RestrictedAppDetails extends DashboardFragment implements BatteryTipPreferenceController.BatteryTipListener {
    ...
    private final FooterPreferenceMixinCompat mFooterPreferenceMixin = new FooterPreferenceMixinCompat(this, getSettingsLifecycle());
    ...
    public int getHelpResource() {
        return C1715R.string.help_uri_restricted_apps;
    }
    ...
    public int getPreferenceScreenResId() {
        return C1715R.xml.restricted_apps_detail;
    }
    ...
    public static void startRestrictedAppDetails(InstrumentedPreferenceFragment instrumentedPreferenceFragment, List<AppInfo> list) {
        ...
        new SubSettingLauncher(instrumentedPreferenceFragment.getContext()).setDestination(RestrictedAppDetails.class.getName()).setArguments(bundle).setTitleRes(C1715R.string.restricted_app_title).setSourceMetricsCategory(instrumentedPreferenceFragment.getMetricsCategory()).launch();
    }

    public void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        Context context = getContext();
        this.mFooterPreferenceMixin.createFooterPreference().setTitle((int) C1715R.string.restricted_app_detail_footer);
    ...
    public void refreshUi() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            try {
                ...
                if (j != -1) {
                    appCheckBoxPreference.setSummary((CharSequence) getString(C1715R.string.restricted_app_time_summary, StringUtil.formatRelativeTime(prefContext, (double) (currentTimeMillis - j), false)));
                }
