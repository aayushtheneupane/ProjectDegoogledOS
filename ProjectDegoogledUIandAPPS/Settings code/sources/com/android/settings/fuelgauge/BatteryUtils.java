...
public class BatteryUtils {
    ...
    public void smearScreenBatterySipper(List<BatterySipper> list, BatterySipper batterySipper) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            BatteryStats.Uid uid = list2.get(i2).uidObj;
            if (uid != null) {
        ...
        double d = batterySipper2.totalPowerMah;
        int size2 = list.size();
        while (i < size2) {
            BatterySipper batterySipper3 = list2.get(i);
            batterySipper3.totalPowerMah += (((double) sparseLongArray.get(batterySipper3.getUid(), j)) * d) / ((double) j2);
            i++;
            j = 0;
        }
    }
    ...
    public void setForceAppStandby(int i, String str, int i2) {
        ...
        ThreadUtils.postOnBackgroundThread((Runnable) new Runnable(i2, i, str) {
