    ...
    public void onCreate(Bundle bundle) {
        ...
        if (this.mPackageName == null) {
            ...
            try {
                ...
                alertParams.mTitle = getText(C1715R.string.high_power_prompt_title);
                alertParams.mMessage = getString(C1715R.string.high_power_prompt_body, new Object[]{applicationInfo.loadLabel(getPackageManager())});
                alertParams.mPositiveButtonText = getText(C1715R.string.allow);
                alertParams.mNegativeButtonText = getText(C1715R.string.deny);
