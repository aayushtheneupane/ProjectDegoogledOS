...
class AppCompatTextViewAutoSizeHelper {
    ...
    private int findLargestTextSizeWhichFits(RectF rectF) {
        ...
        if (length != 0) {
            ...
            while (i2 <= i) {
                ...
                StaticLayout build = StaticLayout.Builder.obtain(text, 0, text.length(), this.mTempTextPaint, Math.round(rectF.right)).setAlignment((Layout.Alignment) invokeAndReturnWithDefault(this.mTextView, "getLayoutAlignment", Layout.Alignment.ALIGN_NORMAL)).setLineSpacing(this.mTextView.getLineSpacingExtra(), this.mTextView.getLineSpacingMultiplier()).setIncludePad(this.mTextView.getIncludeFontPadding()).setBreakStrategy(this.mTextView.getBreakStrategy()).setHyphenationFrequency(this.mTextView.getHyphenationFrequency()).setMaxLines(maxLines == -1 ? Integer.MAX_VALUE : maxLines).setTextDirection((TextDirectionHeuristic) invokeAndReturnWithDefault(this.mTextView, "getTextDirectionHeuristic", TextDirectionHeuristics.FIRSTSTRONG_LTR)).build();
    ...
    public void setAutoSizeTextTypeWithDefaults(int i) {
        ...
        if (i == 0) {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline5("Unknown auto-size text type: ", i));
        }
    }
