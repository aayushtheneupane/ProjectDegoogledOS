...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    public boolean canShowOverflowMenu() {
        pullChildren();
        return ((ToolbarWidgetWrapper) this.mDecorToolbar).mToolbar.canShowOverflowMenu();
    }
    ...
    public void dismissPopups() {
        pullChildren();
        ((ToolbarWidgetWrapper) this.mDecorToolbar).dismissPopupMenus();
    }
    ...
    public void initFeature(int i) {
        pullChildren();
        if (i == 2) {
            ((ToolbarWidgetWrapper) this.mDecorToolbar).initProgress();
        } else if (i == 5) {
            ((ToolbarWidgetWrapper) this.mDecorToolbar).initIndeterminateProgress();
        } else if (i == 109) {
            setOverlayMode(true);
        }
    }
    ...
    public boolean isOverflowMenuShowPending() {
        pullChildren();
        return ((ToolbarWidgetWrapper) this.mDecorToolbar).mToolbar.isOverflowMenuShowPending();
    }

    public boolean isOverflowMenuShowing() {
        pullChildren();
        return ((ToolbarWidgetWrapper) this.mDecorToolbar).isOverflowMenuShowing();
    }
    ...
    public void onStopNestedScroll(View view) {
        ...
        ActionBarVisibilityCallback actionBarVisibilityCallback = this.mActionBarVisibilityCallback;
        if (actionBarVisibilityCallback != null) {
            ((WindowDecorActionBar) actionBarVisibilityCallback).onContentScrollStopped();
        }
    }
    ...
    public void onWindowSystemUiVisibilityChanged(int i) {
        ...
        ActionBarVisibilityCallback actionBarVisibilityCallback = this.mActionBarVisibilityCallback;
        if (actionBarVisibilityCallback != null) {
            ((WindowDecorActionBar) actionBarVisibilityCallback).enableContentAnimations(!z);
            if (z2 || !z) {
    ...
    public void setMenu(Menu menu, MenuPresenter.Callback callback) {
        pullChildren();
        ((ToolbarWidgetWrapper) this.mDecorToolbar).setMenu(menu, callback);
    }

    public void setMenuPrepared() {
        pullChildren();
        ((ToolbarWidgetWrapper) this.mDecorToolbar).setMenuPrepared();
    }
    ...
    public void setWindowCallback(Window.Callback callback) {
        pullChildren();
        ((ToolbarWidgetWrapper) this.mDecorToolbar).setWindowCallback(callback);
    }
