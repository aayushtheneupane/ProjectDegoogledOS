...
abstract class MapCollections<K, V> {
    ...
    final class EntrySet implements Set<Map.Entry<K, V>> {
        ...
        public boolean containsAll(java.util.Collection<?> r6) {
            ...
            L_0x0016:
                ...
                android.support.v4.util.MapCollections r2 = android.support.p000v4.util.MapCollections.this
                java.lang.Object r4 = r0.getKey()
                int r2 = r2.colIndexOfKey(r4)
                if (r2 >= 0) goto L_0x0025
                goto L_0x0014
            L_0x0025:
                android.support.v4.util.MapCollections r4 = android.support.p000v4.util.MapCollections.this
                java.lang.Object r1 = r4.colGetEntry(r2, r1)
                java.lang.Object r0 = r0.getValue()
                boolean r0 = android.support.p000v4.util.ContainerHelpers.equal(r1, r0)
            L_0x0033:
            ...
            L_0x0036:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p000v4.util.MapCollections.EntrySet.containsAll(java.util.Collection):boolean");
        }
    ...
    final class MapIterator implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
        ...
        public String toString() {
            ...
            if (this.mEntryValid) {
                sb.append(MapCollections.this.colGetEntry(this.mIndex, 0));
                sb.append("=");
                if (this.mEntryValid) {
                    sb.append(MapCollections.this.colGetEntry(this.mIndex, 1));
                    return sb.toString();
                }
                throw new IllegalStateException("This container does not support retaining Map.Entry objects");
            }
    ...
    final class ValuesCollection implements Collection<V> {
        ...
        public boolean containsAll(Collection<?> collection) {
            ...
            do {
                ...
                if (MapCollections.this.colIndexOfValue(it.next()) < 0) {
                    z = false;
                    continue;
                }
            } while (z);
