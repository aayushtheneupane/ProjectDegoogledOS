...
final class BackStackState implements Parcelable {
    ...
    public BackStackState(BackStackRecord backStackRecord) {
        ...
        if (backStackRecord.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                BackStackRecord.C0080Op op = backStackRecord.mOps.get(i2);
                int[] iArr = this.mOps;
                int i3 = i + 1;
                iArr[i] = op.cmd;
                int i4 = i3 + 1;
    ...
    public BackStackRecord instantiate(FragmentManagerImpl fragmentManagerImpl) {
        ...
        while (i < this.mOps.length) {
            BackStackRecord.C0080Op op = new BackStackRecord.C0080Op();
            int[] iArr = this.mOps;
            int i2 = i + 1;
            op.cmd = iArr[i];
            int i3 = i2 + 1;
            ...
            int[] iArr2 = this.mOps;
            int i5 = i3 + 1;
            op.enterAnim = iArr2[i3];
            int i6 = i5 + 1;
            op.exitAnim = iArr2[i5];
            int i7 = i6 + 1;
            op.popEnterAnim = iArr2[i6];
            i = i7 + 1;
            op.popExitAnim = iArr2[i7];
