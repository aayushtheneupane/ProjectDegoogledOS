...
public class ViewDragHelper {
    ...
    private void saveInitialMotion(float f, float f2, int i) {
        ...
        fArr10[i] = f;
        float[] fArr11 = this.mInitialMotionY;
    ...
    public void captureChildView(View view, int i) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport.outline11(GeneratedOutlineSupport.outline13("captureChildView: parameter must be a descendant of the ViewDragHelper's tracked parent view ("), this.mParentView, ")"));
    }
    ...
    public void processTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            int i13 = top;
            if (!(i10 == 0 && i11 == 0)) {
                this.mCallback.onViewPositionChanged(this.mCapturedView, i12, i13, i12 - left2, i13 - top2);
            }
            saveLastMotion(motionEvent);
        }
    }
