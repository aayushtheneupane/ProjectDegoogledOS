...
public final class EAN8Writer extends UPCEANWriter {
    public BitMatrix encode(String str, BarcodeFormat barcodeFormat, int i, int i2, Map<EncodeHintType, ?> map) throws WriterException {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport.outline6("Can only encode EAN_8, but got ", barcodeFormat));
    }
    ...
    public boolean[] encode(String str) {
        ...
        StringBuilder outline13 = GeneratedOutlineSupport.outline13("Requested contents should be 8 digits long, but got ");
