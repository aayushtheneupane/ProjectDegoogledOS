...
public final class Code39Writer extends OneDimensionalCodeWriter {
    ...
    public BitMatrix encode(String str, BarcodeFormat barcodeFormat, int i, int i2, Map<EncodeHintType, ?> map) throws WriterException {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport.outline6("Can only encode CODE_39, but got ", barcodeFormat));
    }
    ...
    public boolean[] encode(String str) {
        ...
        if (length <= 80) {
            ...
            while (i2 < length) {
                ...
                if (indexOf >= 0) {
                    ...
                    throw new IllegalArgumentException(GeneratedOutlineSupport.outline8("Bad contents: ", str));
                }
            }
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport.outline5("Requested contents should be less than 80 digits long, but got ", length));
    }
}
