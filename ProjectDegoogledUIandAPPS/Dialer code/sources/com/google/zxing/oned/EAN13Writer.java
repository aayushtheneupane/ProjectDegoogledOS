...
public final class EAN13Writer extends UPCEANWriter {
    public BitMatrix encode(String str, BarcodeFormat barcodeFormat, int i, int i2, Map<EncodeHintType, ?> map) throws WriterException {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport.outline6("Can only encode EAN_13, but got ", barcodeFormat));
    }
    ...
    public boolean[] encode(String str) {
        if (str.length() == 13) {
            ...
            StringBuilder outline13 = GeneratedOutlineSupport.outline13("Requested contents should be 13 digits long, but got ");
            outline13.append(str.length());
