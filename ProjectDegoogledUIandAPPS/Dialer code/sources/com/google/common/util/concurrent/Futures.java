...
public final class Futures extends GwtFuturesCatchingSpecialization {
    ...
    final class C08951 implements Runnable {
    }
    ...
    public static final class FutureCombiner<V> {
        ...
        /* synthetic */ FutureCombiner(boolean z, ImmutableList immutableList, C08951 r3) {
    ...
    private static final class NonCancellationPropagatingFuture<V> extends AbstractFuture.TrustedFuture<V> implements Runnable {
        ...
        public String pendingToString() {
            ...
            if (listenableFuture != null) {
                return GeneratedOutlineSupport.outline7("delegate=[", listenableFuture, "]");
            }
            return null;
        }
    ...
    public static <V> V getDone(Future<V> future) throws ExecutionException {
        V v;
        MoreObjects.checkState(future.isDone(), "Future was expected to be done: %s", (Object) future);
        boolean z = false;
        while (true) {
            try {
                v = future.get();
    ...
    public static <V> FutureCombiner<V> whenAllComplete(ListenableFuture<? extends V>... listenableFutureArr) {
        return new FutureCombiner<>(false, ImmutableList.copyOf((E[]) listenableFutureArr), (C08951) null);
    }

    @SafeVarargs
    public static <V> FutureCombiner<V> whenAllSucceed(ListenableFuture<? extends V>... listenableFutureArr) {
        return new FutureCombiner<>(true, ImmutableList.copyOf((E[]) listenableFutureArr), (C08951) null);
    }
