...
final class RegularImmutableSortedSet<E> extends ImmutableSortedSet<E> {
    static final RegularImmutableSortedSet<Comparable> NATURAL_EMPTY_SET = new RegularImmutableSortedSet<>(ImmutableList.m74of(), Ordering.natural());
    ...
    public boolean containsAll(Collection<?> collection) {
        ...
        if (!Collections2.hasSameComparator(comparator(), collection) || collection.size() <= 1) {
    ...
    public boolean equals(java.lang.Object r6) {
        ...
        L_0x001e:
            ...
            boolean r1 = com.google.common.collect.Collections2.hasSameComparator(r1, r6)
