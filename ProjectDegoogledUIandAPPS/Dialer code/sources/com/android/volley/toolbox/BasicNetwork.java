...
public class BasicNetwork implements Network {
        ...
        if (inputStream != null) {
            try {
                ...
                try {
                    ...
                    VolleyLog.m61v("Error occurred when closing InputStream", new Object[0]);
                }
    ...
    private void logSlowRequests(long j, Request<?> request, byte[] bArr, int i) {
        if (DEBUG || j > 3000) {
            ...
            VolleyLog.m58d("HTTP response for request=<%s> [lifetime=%d], [size=%s], [rc=%d], [retryCount=%s]", objArr);
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:48:0x00c1, code lost:
        ...
        com.android.volley.VolleyLog.m59e("Unexpected response code %d for %s", java.lang.Integer.valueOf(r0), r29.getUrl());
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:76:0x0148, code lost:
        r2 = com.android.tools.p006r8.GeneratedOutlineSupport.outline13("Bad URL ");
    ...
    public com.android.volley.NetworkResponse performRequest(com.android.volley.Request<?> r29) throws com.android.volley.VolleyError {
        ...
        L_0x0008:
            ...
            r11 = 0
            r2 = 0
            com.android.volley.Cache$Entry r0 = r29.getCacheEntry()     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x00ba }
            java.util.Map r0 = r7.getCacheHeaders(r0)     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x00ba }
            com.android.volley.toolbox.BaseHttpStack r3 = r7.mBaseHttpStack     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x00ba }
            com.android.volley.toolbox.HttpResponse r12 = r3.executeRequest(r8, r0)     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x00ba }
            int r14 = r12.getStatusCode()     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x00b5 }
            java.util.List r13 = r12.getHeaders()     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x00b5 }
            r0 = 304(0x130, float:4.26E-43)
            if (r14 != r0) goto L_0x005f
            com.android.volley.Cache$Entry r0 = r29.getCacheEntry()     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x005d }
            if (r0 != 0) goto L_0x0043
            com.android.volley.NetworkResponse r0 = new com.android.volley.NetworkResponse     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x005d }
            r16 = 304(0x130, float:4.26E-43)
            r17 = 0
            r18 = 1
            long r3 = android.os.SystemClock.elapsedRealtime()     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x005d }
            long r19 = r3 - r9
            r15 = r0
            r21 = r13
            r15.<init>(r16, r17, r18, r19, r21)     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x005d }
            return r0
        L_0x0043:
            java.util.List r27 = combineHeaders(r13, r0)     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x005d }
            com.android.volley.NetworkResponse r1 = new com.android.volley.NetworkResponse     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x005d }
            r22 = 304(0x130, float:4.26E-43)
            byte[] r0 = r0.data     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x005d }
            r24 = 1
            long r3 = android.os.SystemClock.elapsedRealtime()     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x005d }
            long r25 = r3 - r9
            r21 = r1
            r23 = r0
            r21.<init>(r22, r23, r24, r25, r27)     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x005d }
            return r1
        L_0x005d:
            r0 = move-exception
            goto L_0x006e
        L_0x005f:
            java.io.InputStream r0 = r12.getContent()     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x00b2 }
            if (r0 == 0) goto L_0x0072
            int r1 = r12.getContentLength()     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x005d }
            byte[] r0 = r7.inputStreamToBytes(r0, r1)     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x005d }
            goto L_0x0074
        L_0x006e:
            r15 = r2
            r19 = r13
            goto L_0x00bf
        L_0x0072:
            byte[] r0 = new byte[r11]     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x00b2 }
        L_0x0074:
            r20 = r0
            long r0 = android.os.SystemClock.elapsedRealtime()     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x00ab }
            long r2 = r0 - r9
            r1 = r28
            r4 = r29
            r5 = r20
            r6 = r14
            r1.logSlowRequests(r2, r4, r5, r6)     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x00ab }
            r0 = 200(0xc8, float:2.8E-43)
            if (r14 < r0) goto L_0x00a2
            r0 = 299(0x12b, float:4.19E-43)
            if (r14 > r0) goto L_0x00a2
            com.android.volley.NetworkResponse r0 = new com.android.volley.NetworkResponse     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x00ab }
            r16 = 0
            long r1 = android.os.SystemClock.elapsedRealtime()     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x00ab }
            long r17 = r1 - r9
            r1 = r13
            r13 = r0
            r15 = r20
            r19 = r1
            r13.<init>(r14, r15, r16, r17, r19)     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x00a9 }
            return r0
        L_0x00a2:
            r1 = r13
            java.io.IOException r0 = new java.io.IOException     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x00a9 }
            r0.<init>()     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x00a9 }
            throw r0     // Catch:{ SocketTimeoutException -> 0x015f, MalformedURLException -> 0x0147, IOException -> 0x00a9 }
        L_0x00a9:
            r0 = move-exception
            goto L_0x00ad
        L_0x00ab:
        ...
        L_0x00bf:
            ...
            com.android.volley.VolleyLog.m59e(r2, r1)
