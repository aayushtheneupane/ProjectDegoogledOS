...
public final class ShareCompat {
    ...
    public class IntentReader {
        ...
        public Uri getStream(int i) {
            ...
            StringBuilder Pa = C0632a.m1011Pa("Stream items available: ");
            Pa.append(getStreamCount());
            Pa.append(" index requested: ");
            Pa.append(i);
            throw new IndexOutOfBoundsException(Pa.toString());
        }
    }
    ...
    public static void configureMenuItem(MenuItem menuItem, IntentBuilder intentBuilder) {
        ...
        StringBuilder Pa = C0632a.m1011Pa(HISTORY_FILENAME_PREFIX);
        Pa.append(intentBuilder.getActivity().getClass().getName());
        shareActionProvider.setShareHistoryFileName(Pa.toString());
