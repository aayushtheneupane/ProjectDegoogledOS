...
public abstract class AutoScrollHelper implements View.OnTouchListener {
    ...
    class ClampedScroller {
        ...
        private float getValueAt(long j) {
            ...
            return (f * AutoScrollHelper.constrain(((float) j3) / ((float) this.mEffectiveRampDown), 0.0f, (float) AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY)) + (AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY - f);
        }
