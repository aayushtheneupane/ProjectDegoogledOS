...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            StringBuilder Pa = C0632a.m1011Pa("HorizontalScrollView.SavedState{");
            Pa.append(Integer.toHexString(System.identityHashCode(this)));
            Pa.append(" scrollPosition=");
            Pa.append(this.scrollPosition);
            Pa.append("}");
            return Pa.toString();
        }
    ...
    public void fling(int i) {
        if (getChildCount() > 0) {
            this.mScroller.fling(getScrollX(), getScrollY(), 0, i, 0, 0, RtlSpacingHelper.UNDEFINED, Integer.MAX_VALUE, 0, 0);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked == 1) {
                ...
                if (findPointerIndex == -1) {
                    StringBuilder Pa = C0632a.m1011Pa("Invalid pointerId=");
                    Pa.append(this.mActivePointerId);
                    Pa.append(" in onTouchEvent");
                    Log.e(TAG, Pa.toString());
                } else {
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        if (z) {
                            ...
                            if (i7 < 0) {
                                ...
                                edgeEffect2.onPull(height2, x2);
                                if (!this.mEdgeGlowTop.isFinished()) {
                                    this.mEdgeGlowTop.onRelease();
                                }
                            }
                            EdgeEffect edgeEffect3 = this.mEdgeGlowTop;
                            if (edgeEffect3 != null && (!edgeEffect3.isFinished() || !this.mEdgeGlowBottom.isFinished())) {
                                ViewCompat.postInvalidateOnAnimation(this);
                            }
                        }
                    }
