...
class TypefaceCompatApi24Impl extends TypefaceCompatBaseImpl {
    ...
    public Typeface createFromFontFamilyFilesResourceEntry(Context context, C0311d dVar, Resources resources, int i) {
        ...
        for (C0312e eVar : dVar.getEntries()) {
            ByteBuffer copyToDirectBuffer = TypefaceCompatUtil.copyToDirectBuffer(context, resources, eVar.getResourceId());
            if (copyToDirectBuffer == null || !addFontWeightStyle(newFamily, copyToDirectBuffer, eVar.getTtcIndex(), eVar.getWeight(), eVar.isItalic())) {
                return null;
            }
        }
