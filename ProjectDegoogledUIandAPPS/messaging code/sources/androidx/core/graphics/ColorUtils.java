...
public final class ColorUtils {
    ...
    public static void RGBToXYZ(int i, int i2, int i3, double[] dArr) {
        ...
        if (dArr2.length == 3) {
            ...
            dArr2[0] = ((0.1805d * d3) + (0.3576d * d7) + (0.4124d * d5)) * XYZ_WHITE_REFERENCE_Y;
            dArr2[1] = ((0.0722d * d3) + (0.7152d * d7) + (0.2126d * d5)) * XYZ_WHITE_REFERENCE_Y;
            double d9 = d3 * 0.9505d;
            dArr2[2] = (d9 + (d7 * 0.1192d) + (d5 * 0.0193d)) * XYZ_WHITE_REFERENCE_Y;
            return;
        }
    ...
    public static double calculateContrast(int i, int i2) {
        ...
        StringBuilder Pa = C0632a.m1011Pa("background can not be translucent: #");
        Pa.append(Integer.toHexString(i2));
    ...
    public static Color compositeColors(Color color, Color color2) {
        ...
        StringBuilder Pa = C0632a.m1011Pa("Color models must match (");
        Pa.append(color.getModel());
        Pa.append(" vs. ");
        Pa.append(color2.getModel());
        Pa.append(")");
        throw new IllegalArgumentException(Pa.toString());
    }
}
