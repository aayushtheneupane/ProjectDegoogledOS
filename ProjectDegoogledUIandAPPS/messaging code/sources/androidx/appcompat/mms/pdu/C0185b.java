...
/* renamed from: androidx.appcompat.mms.pdu.b */
public class C0185b {

    /* renamed from: Tl */
    private static byte[] f169Tl = new byte[255];
    ...
    static {
        ...
        for (int i2 = 90; i2 >= 65; i2--) {
            f169Tl[i2] = (byte) (i2 - 65);
        }
        for (int i3 = 122; i3 >= 97; i3--) {
            f169Tl[i3] = (byte) ((i3 - 97) + 26);
        }
        for (int i4 = 57; i4 >= 48; i4--) {
            f169Tl[i4] = (byte) ((i4 - 48) + 52);
        }
        byte[] bArr = f169Tl;
        bArr[43] = 62;
        bArr[47] = 63;
    ...
    /* renamed from: a */
    public static byte[] m151a(byte[] bArr) {
