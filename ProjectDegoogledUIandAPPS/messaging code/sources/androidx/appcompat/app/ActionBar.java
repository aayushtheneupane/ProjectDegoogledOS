...
public abstract class ActionBar {
    ...
    public interface TabListener {
        void onTabReselected(Tab tab, C0396O o);

        void onTabSelected(Tab tab, C0396O o);

        void onTabUnselected(Tab tab, C0396O o);
    }
    ...
    public class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.gravity = 0;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0126R.styleable.ActionBarLayout);
            this.gravity = obtainStyledAttributes.getInt(C0126R.styleable.ActionBarLayout_android_layout_gravity, 0);
