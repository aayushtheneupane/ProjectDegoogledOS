...
public class AppCompatViewInflater {
    ...
    private static final Map sConstructorMap = new C0015b();
    ...
    class DeclaredOnClickListener implements View.OnClickListener {
        ...
        private void resolveMethod(Context context, String str) {
            ...
            if (id == -1) {
                ...
                StringBuilder Pa = C0632a.m1011Pa(" with id '");
                Pa.append(this.mHostView.getContext().getResources().getResourceEntryName(id));
                Pa.append("'");
                str2 = Pa.toString();
            }
            StringBuilder Pa2 = C0632a.m1011Pa("Could not find method ");
            Pa2.append(this.mMethodName);
            Pa2.append("(View) in a parent or ancestor Context for android:onClick attribute defined on view ");
            Pa2.append(this.mHostView.getClass());
            Pa2.append(str2);
            throw new IllegalStateException(Pa2.toString());
        }
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0126R.styleable.View, 0, 0);
        int resourceId = z ? obtainStyledAttributes.getResourceId(C0126R.styleable.View_android_theme, 0) : 0;
        if (z2 && resourceId == 0 && (resourceId = obtainStyledAttributes.getResourceId(C0126R.styleable.View_theme, 0)) != 0) {
    ...
    public AppCompatAutoCompleteTextView createAutoCompleteTextView(Context context, AttributeSet attributeSet) {
        return new AppCompatAutoCompleteTextView(context, attributeSet, C0126R.attr.autoCompleteTextViewStyle);
    }

    /* access modifiers changed from: protected */
    public AppCompatButton createButton(Context context, AttributeSet attributeSet) {
        return new AppCompatButton(context, attributeSet, C0126R.attr.buttonStyle);
    }

    /* access modifiers changed from: protected */
    public AppCompatCheckBox createCheckBox(Context context, AttributeSet attributeSet) {
        return new AppCompatCheckBox(context, attributeSet, C0126R.attr.checkboxStyle);
    }
    ...
    public AppCompatEditText createEditText(Context context, AttributeSet attributeSet) {
        return new AppCompatEditText(context, attributeSet, C0126R.attr.editTextStyle);
    }

    /* access modifiers changed from: protected */
    public AppCompatImageButton createImageButton(Context context, AttributeSet attributeSet) {
        return new AppCompatImageButton(context, attributeSet, C0126R.attr.imageButtonStyle);
    }
    ...
    public AppCompatMultiAutoCompleteTextView createMultiAutoCompleteTextView(Context context, AttributeSet attributeSet) {
        return new AppCompatMultiAutoCompleteTextView(context, attributeSet, C0126R.attr.autoCompleteTextViewStyle);
    }

    /* access modifiers changed from: protected */
    public AppCompatRadioButton createRadioButton(Context context, AttributeSet attributeSet) {
        return new AppCompatRadioButton(context, attributeSet, C0126R.attr.radioButtonStyle);
    }
