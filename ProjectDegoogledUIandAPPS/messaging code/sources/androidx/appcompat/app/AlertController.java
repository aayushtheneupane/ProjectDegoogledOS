...
class AlertController {
    ...
    private final View.OnClickListener mButtonHandler = new View.OnClickListener() {
        ...
        public void onClick(android.view.View r3) {
            ...
            L_0x0033:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.app.AlertController.C01321.onClick(android.view.View):void");
        }
    };
    ...
    public class AlertParams {
        ...
        private void createListView(final androidx.appcompat.app.AlertController r12) {
            ...
            L_0x0094:
                ...
                goto L_0x00a4
            L_0x009c:
                boolean r11 = r11.mIsMultiChoice
    ...
    public class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0126R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = obtainStyledAttributes.getDimensionPixelOffset(C0126R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = obtainStyledAttributes.getDimensionPixelOffset(C0126R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    }
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes((AttributeSet) null, C0126R.styleable.AlertDialog, C0126R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = obtainStyledAttributes.getResourceId(C0126R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = obtainStyledAttributes.getResourceId(C0126R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = obtainStyledAttributes.getResourceId(C0126R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = obtainStyledAttributes.getResourceId(C0126R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = obtainStyledAttributes.getResourceId(C0126R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = obtainStyledAttributes.getResourceId(C0126R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = obtainStyledAttributes.getBoolean(C0126R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = obtainStyledAttributes.getDimensionPixelSize(C0126R.styleable.AlertDialog_buttonIconDimen, 0);
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        View findViewById = this.mWindow.findViewById(C0126R.C0128id.scrollIndicatorUp);
        View findViewById2 = this.mWindow.findViewById(C0126R.C0128id.scrollIndicatorDown);
    ...
    private void setupContent(ViewGroup viewGroup) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0126R.C0128id.scrollView);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0126R.C0128id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0126R.C0128id.title_template).setVisibility(8);
            return;
        }
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C0126R.C0128id.alertTitle);
    ...
    private void setupView() {
        ...
        View findViewById;
        View findViewById2 = this.mWindow.findViewById(C0126R.C0128id.parentPanel);
        View findViewById3 = findViewById2.findViewById(C0126R.C0128id.topPanel);
        View findViewById4 = findViewById2.findViewById(C0126R.C0128id.contentPanel);
        View findViewById5 = findViewById2.findViewById(C0126R.C0128id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById2.findViewById(C0126R.C0128id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById6 = viewGroup.findViewById(C0126R.C0128id.topPanel);
        View findViewById7 = viewGroup.findViewById(C0126R.C0128id.contentPanel);
        View findViewById8 = viewGroup.findViewById(C0126R.C0128id.buttonPanel);
        ...
        if (!z3 && (findViewById = resolvePanel2.findViewById(C0126R.C0128id.textSpacerNoButtons)) != null) {
        ...
        if (z2) {
            ...
            if (!(this.mMessage == null && this.mListView == null)) {
                view = resolvePanel.findViewById(C0126R.C0128id.titleDividerNoCustom);
            }
            if (view != null) {
                view.setVisibility(0);
            }
        } else {
            View findViewById9 = resolvePanel2.findViewById(C0126R.C0128id.textSpacerNoTitle);
