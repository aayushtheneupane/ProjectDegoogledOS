...
class ToolbarActionBar extends ActionBar {
    ...
    final class ActionMenuPresenterCallback implements C0211D {
    ...
    final class MenuBuilderCallback implements C0236o {
        MenuBuilderCallback() {
        }
        ...
        public void onMenuModeChange(C0238q qVar) {
            ...
            if (toolbarActionBar.mDecorToolbar.isOverflowMenuShowing()) {
                ToolbarActionBar.this.mWindowCallback.onPanelClosed(108, qVar);
            } else if (ToolbarActionBar.this.mWindowCallback.onPreparePanel(0, (View) null, qVar)) {
                ToolbarActionBar.this.mWindowCallback.onMenuOpened(108, qVar);
            }
        }
    }
    ...
    public void populateOptionsMenu() {
        Menu menu = getMenu();
        C0238q qVar = menu instanceof C0238q ? (C0238q) menu : null;
        if (qVar != null) {
