...
public class ActionBarContainer extends FrameLayout {
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0126R.C0128id.action_bar);
        this.mContextView = findViewById(C0126R.C0128id.action_context_bar);
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.mActionBarView == null && View.MeasureSpec.getMode(i2) == Integer.MIN_VALUE && (i4 = this.mHeight) >= 0) {
            i2 = View.MeasureSpec.makeMeasureSpec(Math.min(i4, View.MeasureSpec.getSize(i2)), RtlSpacingHelper.UNDEFINED);
        }
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0126R.styleable.ActionBar);
        this.mBackground = obtainStyledAttributes.getDrawable(C0126R.styleable.ActionBar_background);
        this.mStackedBackground = obtainStyledAttributes.getDrawable(C0126R.styleable.ActionBar_backgroundStacked);
        this.mHeight = obtainStyledAttributes.getDimensionPixelSize(C0126R.styleable.ActionBar_height, -1);
        if (getId() == C0126R.C0128id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = obtainStyledAttributes.getDrawable(C0126R.styleable.ActionBar_backgroundSplit);
        }
