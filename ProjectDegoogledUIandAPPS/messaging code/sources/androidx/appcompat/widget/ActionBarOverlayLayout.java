...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    static final int[] ATTRS = {C0126R.attr.actionBarSize, 16842841};
    ...
    private DecorToolbar getDecorToolbar(View view) {
        ...
        Pa.append(view.getClass().getSimpleName());
    ...
    private boolean shouldHideActionBarOnFling(float f, float f2) {
        this.mFlingEstimator.fling(0, 0, 0, (int) f2, 0, 0, RtlSpacingHelper.UNDEFINED, Integer.MAX_VALUE);
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0126R.C0128id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0126R.C0128id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0126R.C0128id.action_bar));
        }
    }
    ...
    public void setMenu(Menu menu, C0211D d) {
        pullChildren();
        this.mDecorToolbar.setMenu(menu, d);
    }
