...
public class Toolbar extends ViewGroup {
    ...
    private C0236o mMenuBuilderCallback;
    ...
    class ExpandedActionViewMenuPresenter implements C0212E {
        C0241t mCurrentExpandedItem;
        C0238q mMenu;
        ...
        public boolean expandItemActionView(C0238q qVar, C0241t tVar) {
            ...
            Toolbar.this.mExpandedActionView = tVar.getActionView();
    ...
    public Toolbar(Context context) {
        this(context, (AttributeSet) null, C0126R.attr.toolbarStyle);
    }
    ...
    private void ensureMenu() {
        ...
        if (this.mMenuView.peekMenu() == null) {
            C0238q qVar = (C0238q) this.mMenuView.getMenu();
            if (this.mExpandedMenuPresenter == null) {
                this.mExpandedMenuPresenter = new ExpandedActionViewMenuPresenter();
            }
            this.mMenuView.setExpandedActionViewsExclusive(true);
            qVar.mo1582a((C0212E) this.mExpandedMenuPresenter, this.mPopupContext);
        }
    }
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new AppCompatImageButton(getContext(), (AttributeSet) null, C0126R.attr.toolbarNavigationButtonStyle);
            LayoutParams generateDefaultLayoutParams = generateDefaultLayoutParams();
    ...
    public void collapseActionView() {
        ...
        C0241t tVar = expandedActionViewMenuPresenter == null ? null : expandedActionViewMenuPresenter.mCurrentExpandedItem;
        if (tVar != null) {
    ...
    public void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new AppCompatImageButton(getContext(), (AttributeSet) null, C0126R.attr.toolbarNavigationButtonStyle);
    ...
    public int getCurrentContentInsetEnd() {
        /*
            ...
            androidx.appcompat.view.menu.q r0 = r0.peekMenu()
            if (r0 == 0) goto L_0x0013
    ...
    public void onLayout(boolean r20, int r21, int r22, int r23, int r24) {
        ...
        L_0x02b8:
            r12 = r22
            java.util.ArrayList r2 = r0.mTempViews
            r3 = 5
        ...
        L_0x0300:
            ...
            goto L_0x0300
        L_0x0311:
            java.util.ArrayList r0 = r0.mTempViews
            r0.clear()
            return
        */
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        ActionMenuView actionMenuView = this.mMenuView;
        C0238q peekMenu = actionMenuView != null ? actionMenuView.peekMenu() : null;
    ...
    public Parcelable onSaveInstanceState() {
        ...
        ExpandedActionViewMenuPresenter expandedActionViewMenuPresenter = this.mExpandedMenuPresenter;
        if (!(expandedActionViewMenuPresenter == null || (tVar = expandedActionViewMenuPresenter.mCurrentExpandedItem) == null)) {
    ...
    public void setCollapseIcon(int i) {
        setCollapseIcon(C0130a.getDrawable(getContext(), i));
    }
    ...
    public void setLogo(int i) {
        setLogo(C0130a.getDrawable(getContext(), i));
    }
    ...
    public void setMenu(C0238q qVar, ActionMenuPresenter actionMenuPresenter) {
        if (qVar != null || this.mMenuView != null) {
            ensureMenuView();
            C0238q peekMenu = this.mMenuView.peekMenu();
            if (peekMenu != qVar) {
                if (peekMenu != null) {
                    peekMenu.mo1593b((C0212E) this.mOuterActionMenuPresenter);
                    peekMenu.mo1593b((C0212E) this.mExpandedMenuPresenter);
                }
                if (this.mExpandedMenuPresenter == null) {
                    this.mExpandedMenuPresenter = new ExpandedActionViewMenuPresenter();
                }
                ...
                if (qVar != null) {
                    qVar.mo1582a((C0212E) actionMenuPresenter, this.mPopupContext);
                    qVar.mo1582a((C0212E) this.mExpandedMenuPresenter, this.mPopupContext);
                } else {
                    actionMenuPresenter.initForMenu(this.mPopupContext, (C0238q) null);
                    this.mExpandedMenuPresenter.initForMenu(this.mPopupContext, (C0238q) null);
    ...
    public void setMenuCallbacks(C0211D d, C0236o oVar) {
        ...
        ActionMenuView actionMenuView = this.mMenuView;
        if (actionMenuView != null) {
            actionMenuView.setMenuCallbacks(d, oVar);
        }
    }
    ...
    public void setNavigationIcon(int i) {
        setNavigationIcon(C0130a.getDrawable(getContext(), i));
    }
    ...
    public Toolbar(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getContext(), attributeSet, C0126R.styleable.Toolbar, i, 0);
        this.mTitleTextAppearance = obtainStyledAttributes.getResourceId(C0126R.styleable.Toolbar_titleTextAppearance, 0);
        this.mSubtitleTextAppearance = obtainStyledAttributes.getResourceId(C0126R.styleable.Toolbar_subtitleTextAppearance, 0);
        this.mGravity = obtainStyledAttributes.getInteger(C0126R.styleable.Toolbar_android_gravity, this.mGravity);
        this.mButtonGravity = obtainStyledAttributes.getInteger(C0126R.styleable.Toolbar_buttonGravity, 48);
        int dimensionPixelOffset = obtainStyledAttributes.getDimensionPixelOffset(C0126R.styleable.Toolbar_titleMargin, 0);
        dimensionPixelOffset = obtainStyledAttributes.hasValue(C0126R.styleable.Toolbar_titleMargins) ? obtainStyledAttributes.getDimensionPixelOffset(C0126R.styleable.Toolbar_titleMargins, dimensionPixelOffset) : dimensionPixelOffset;
        this.mTitleMarginBottom = dimensionPixelOffset;
        this.mTitleMarginTop = dimensionPixelOffset;
        this.mTitleMarginEnd = dimensionPixelOffset;
        this.mTitleMarginStart = dimensionPixelOffset;
        int dimensionPixelOffset2 = obtainStyledAttributes.getDimensionPixelOffset(C0126R.styleable.Toolbar_titleMarginStart, -1);
        if (dimensionPixelOffset2 >= 0) {
            this.mTitleMarginStart = dimensionPixelOffset2;
        }
        int dimensionPixelOffset3 = obtainStyledAttributes.getDimensionPixelOffset(C0126R.styleable.Toolbar_titleMarginEnd, -1);
        if (dimensionPixelOffset3 >= 0) {
            this.mTitleMarginEnd = dimensionPixelOffset3;
        }
        int dimensionPixelOffset4 = obtainStyledAttributes.getDimensionPixelOffset(C0126R.styleable.Toolbar_titleMarginTop, -1);
        if (dimensionPixelOffset4 >= 0) {
            this.mTitleMarginTop = dimensionPixelOffset4;
        }
        int dimensionPixelOffset5 = obtainStyledAttributes.getDimensionPixelOffset(C0126R.styleable.Toolbar_titleMarginBottom, -1);
        if (dimensionPixelOffset5 >= 0) {
            this.mTitleMarginBottom = dimensionPixelOffset5;
        }
        this.mMaxButtonHeight = obtainStyledAttributes.getDimensionPixelSize(C0126R.styleable.Toolbar_maxButtonHeight, -1);
        int dimensionPixelOffset6 = obtainStyledAttributes.getDimensionPixelOffset(C0126R.styleable.Toolbar_contentInsetStart, RtlSpacingHelper.UNDEFINED);
        int dimensionPixelOffset7 = obtainStyledAttributes.getDimensionPixelOffset(C0126R.styleable.Toolbar_contentInsetEnd, RtlSpacingHelper.UNDEFINED);
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0126R.styleable.Toolbar_contentInsetLeft, 0);
        int dimensionPixelSize2 = obtainStyledAttributes.getDimensionPixelSize(C0126R.styleable.Toolbar_contentInsetRight, 0);
        ensureContentInsets();
        this.mContentInsets.setAbsolute(dimensionPixelSize, dimensionPixelSize2);
        if (!(dimensionPixelOffset6 == Integer.MIN_VALUE && dimensionPixelOffset7 == Integer.MIN_VALUE)) {
            this.mContentInsets.setRelative(dimensionPixelOffset6, dimensionPixelOffset7);
        }
        this.mContentInsetStartWithNavigation = obtainStyledAttributes.getDimensionPixelOffset(C0126R.styleable.Toolbar_contentInsetStartWithNavigation, RtlSpacingHelper.UNDEFINED);
        this.mContentInsetEndWithActions = obtainStyledAttributes.getDimensionPixelOffset(C0126R.styleable.Toolbar_contentInsetEndWithActions, RtlSpacingHelper.UNDEFINED);
        this.mCollapseIcon = obtainStyledAttributes.getDrawable(C0126R.styleable.Toolbar_collapseIcon);
        this.mCollapseDescription = obtainStyledAttributes.getText(C0126R.styleable.Toolbar_collapseContentDescription);
        CharSequence text = obtainStyledAttributes.getText(C0126R.styleable.Toolbar_title);
        if (!TextUtils.isEmpty(text)) {
            setTitle(text);
        }
        CharSequence text2 = obtainStyledAttributes.getText(C0126R.styleable.Toolbar_subtitle);
        if (!TextUtils.isEmpty(text2)) {
            setSubtitle(text2);
        }
        this.mPopupContext = getContext();
        setPopupTheme(obtainStyledAttributes.getResourceId(C0126R.styleable.Toolbar_popupTheme, 0));
        Drawable drawable = obtainStyledAttributes.getDrawable(C0126R.styleable.Toolbar_navigationIcon);
        if (drawable != null) {
            setNavigationIcon(drawable);
        }
        CharSequence text3 = obtainStyledAttributes.getText(C0126R.styleable.Toolbar_navigationContentDescription);
        if (!TextUtils.isEmpty(text3)) {
            setNavigationContentDescription(text3);
        }
        Drawable drawable2 = obtainStyledAttributes.getDrawable(C0126R.styleable.Toolbar_logo);
        if (drawable2 != null) {
            setLogo(drawable2);
        }
        CharSequence text4 = obtainStyledAttributes.getText(C0126R.styleable.Toolbar_logoDescription);
        if (!TextUtils.isEmpty(text4)) {
            setLogoDescription(text4);
        }
        if (obtainStyledAttributes.hasValue(C0126R.styleable.Toolbar_titleTextColor)) {
            setTitleTextColor(obtainStyledAttributes.getColorStateList(C0126R.styleable.Toolbar_titleTextColor));
        }
        if (obtainStyledAttributes.hasValue(C0126R.styleable.Toolbar_subtitleTextColor)) {
            setSubtitleTextColor(obtainStyledAttributes.getColorStateList(C0126R.styleable.Toolbar_subtitleTextColor));
        }
        if (obtainStyledAttributes.hasValue(C0126R.styleable.Toolbar_menu)) {
            inflateMenu(obtainStyledAttributes.getResourceId(C0126R.styleable.Toolbar_menu, 0));
        }
