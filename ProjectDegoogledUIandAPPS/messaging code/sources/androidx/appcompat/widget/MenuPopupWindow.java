...
import androidx.appcompat.view.menu.C0235n;
...
public class MenuPopupWindow extends ListPopupWindow implements MenuItemHoverListener {
    ...
    public class MenuDropDownListView extends DropDownListView {
        ...
        public boolean onHoverEvent(MotionEvent motionEvent) {
            ...
            if (this.mHoverListener != null) {
                ...
                if (adapter instanceof HeaderViewListAdapter) {
                    ...
                    nVar = (C0235n) headerViewListAdapter.getWrappedAdapter();
                } else {
                    i = 0;
                    nVar = (C0235n) adapter;
                }
                ...
                if (motionEvent.getAction() != 10 && (pointToPosition = pointToPosition((int) motionEvent.getX(), (int) motionEvent.getY())) != -1 && (i2 = pointToPosition - i) >= 0 && i2 < nVar.getCount()) {
                    tVar = nVar.getItem(i2);
                }
                MenuItem menuItem = this.mHoveredMenuItem;
                if (menuItem != tVar) {
                    C0238q adapterMenu = nVar.getAdapterMenu();
                    if (menuItem != null) {
                        this.mHoverListener.onItemHoverExit(adapterMenu, menuItem);
                    }
                    this.mHoveredMenuItem = tVar;
                    if (tVar != null) {
                        this.mHoverListener.onItemHoverEnter(adapterMenu, tVar);
                    }
                }
            }
        ...
        public boolean onKeyDown(int i, KeyEvent keyEvent) {
            ...
            if (listMenuItemView != null && i == this.mAdvanceKey) {
                ...
                setSelection(-1);
                ((C0235n) getAdapter()).getAdapterMenu().close(false);
                return true;
            }
        }
    ...
    public void onItemHoverEnter(C0238q qVar, MenuItem menuItem) {
        MenuItemHoverListener menuItemHoverListener = this.mHoverListener;
        if (menuItemHoverListener != null) {
            menuItemHoverListener.onItemHoverEnter(qVar, menuItem);
        }
    }
    ...
    public void onItemHoverExit(C0238q qVar, MenuItem menuItem) {
        MenuItemHoverListener menuItemHoverListener = this.mHoverListener;
        if (menuItemHoverListener != null) {
            menuItemHoverListener.onItemHoverExit(qVar, menuItem);
        }
    }
