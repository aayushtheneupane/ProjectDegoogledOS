...
import p000a.p006c.p007a.C0034f;
import p026b.p027a.p030b.p031a.C0632a;

@SuppressLint({"RestrictedAPI"})
class SuggestionsAdapter extends C0034f implements View.OnClickListener {
    ...
    final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0126R.C0128id.edit_query);
        }
    }
                ...
                if (pathSegments != null) {
                    ...
                    if (size == 1) {
                        try {
                            ...
                            throw new FileNotFoundException(C0632a.m1014a("Single path segment is not a resource ID: ", uri));
                        }
                    } else if (size == 2) {
                        i = resourcesForApplication.getIdentifier(pathSegments.get(1), pathSegments.get(0), authority);
                    } else {
                        throw new FileNotFoundException(C0632a.m1014a("More than two path segments: ", uri));
                    }
                    if (i != 0) {
                        return resourcesForApplication.getDrawable(i);
                    }
                    throw new FileNotFoundException(C0632a.m1014a("No resource found for: ", uri));
                }
                throw new FileNotFoundException(C0632a.m1014a("No path: ", uri));
            } catch (PackageManager.NameNotFoundException unused2) {
                throw new FileNotFoundException(C0632a.m1014a("No package found for authority: ", uri));
            }
        } else {
            throw new FileNotFoundException(C0632a.m1014a("No authority: ", uri));
        }
    }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) newView.findViewById(C0126R.C0128id.edit_query)).setImageResource(this.mCommitIconResId);
        return newView;
    }
