...
public class AppCompatRadioButton extends RadioButton implements TintableCompoundButton, TintableBackgroundView {
    ...
    public AppCompatRadioButton(Context context) {
        this(context, (AttributeSet) null, C0126R.attr.radioButtonStyle);
    }
    ...
    public AppCompatRadioButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0126R.attr.radioButtonStyle);
    }
    ...
    public void setButtonDrawable(int i) {
        setButtonDrawable(C0130a.getDrawable(getContext(), i));
    }
}
