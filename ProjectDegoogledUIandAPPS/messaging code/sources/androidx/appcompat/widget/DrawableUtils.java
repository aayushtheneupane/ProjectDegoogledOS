...
import androidx.appcompat.p020b.p021a.C0170m;
...
public class DrawableUtils {
    ...
    public static boolean canSafelyMutateDrawable(Drawable drawable) {
        ...
        if (drawable instanceof DrawableContainer) {
            ...
            return true;
        } else if (drawable instanceof C0324c) {
            return canSafelyMutateDrawable(((C0324c) drawable).getWrappedDrawable());
        } else {
            if (drawable instanceof C0170m) {
                return canSafelyMutateDrawable(((C0170m) drawable).getWrappedDrawable());
            }
    ...
    public static Rect getOpticalBounds(Drawable drawable) {
        ...
        if (sInsetsClazz != null) {
            try {
                Drawable d = C0322a.m264d(drawable);
