...
class DropDownListView extends ListView {
    ...
    class GateKeeperDrawable extends C0170m {
    ...
    DropDownListView(Context context, boolean z) {
        super(context, (AttributeSet) null, C0126R.attr.dropDownListViewStyle);
        this.mHijackFocus = z;
        setCacheColorHint(0);
        try {
    ...
    public boolean onForwardedEvent(android.view.MotionEvent r9, int r10) {
        ...
        L_0x005e:
            ...
            goto L_0x0070
        L_0x0069:
            androidx.core.widget.ListViewAutoScrollHelper r8 = r8.mScrollHelper
