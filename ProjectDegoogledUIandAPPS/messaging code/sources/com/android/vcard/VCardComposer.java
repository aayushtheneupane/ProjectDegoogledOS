...
public class VCardComposer {
    ...
    public class RawContactEntitlesInfo {
    ...
    public VCardComposer(Context context) {
        this(context, VCardConfig.VCARD_TYPE_DEFAULT, (String) null, true);
    }
    ...
    private void closeCursorIfAppropriate() {
        ...
        if (!this.mCursorSuppliedFromOutside && (cursor = this.mCursor) != null) {
            try {
                ...
                StringBuilder Pa = C0632a.m1011Pa("SQLiteException on Cursor#close(): ");
                Pa.append(e.getMessage());
    ...
    /* JADX WARNING: Removed duplicated region for block: B:39:0x00c4 A[Catch:{ IllegalArgumentException -> 0x0069, IllegalAccessException -> 0x004f, InvocationTargetException -> 0x0041, all -> 0x0104 }] */
    ...
    private java.lang.String createOneEntryInternal(long r10, java.lang.reflect.Method r12) {
        /*
            ...
            r0.<init>()
            r1 = 0
            android.net.Uri r2 = r9.mContentUriForRawContactsEntity     // Catch:{ all -> 0x0104 }
            com.android.vcard.VCardComposer$RawContactEntitlesInfoCallback r3 = r9.mRawContactEntitlesInfoCallback     // Catch:{ all -> 0x0104 }
            if (r3 == 0) goto L_0x0016
            com.android.vcard.VCardComposer$RawContactEntitlesInfoCallback r2 = r9.mRawContactEntitlesInfoCallback     // Catch:{ all -> 0x0104 }
            com.android.vcard.VCardComposer$RawContactEntitlesInfo r10 = r2.getRawContactEntitlesInfo(r10)     // Catch:{ all -> 0x0104 }
            android.net.Uri r2 = r10.rawContactEntitlesUri     // Catch:{ all -> 0x0104 }
            long r10 = r10.contactId     // Catch:{ all -> 0x0104 }
        L_0x0016:
            r3 = r2
            r2 = 1
            java.lang.String[] r6 = new java.lang.String[r2]     // Catch:{ all -> 0x0104 }
            java.lang.String r4 = java.lang.String.valueOf(r10)     // Catch:{ all -> 0x0104 }
            r5 = 0
            r6[r5] = r4     // Catch:{ all -> 0x0104 }
        ...
        L_0x0041:
            r9 = move-exception
            java.lang.String r10 = "InvocationTargetException has been thrown: "
            android.util.Log.e(r8, r10, r9)     // Catch:{ all -> 0x0104 }
            java.lang.RuntimeException r9 = new java.lang.RuntimeException     // Catch:{ all -> 0x0104 }
            java.lang.String r10 = "InvocationTargetException has been thrown"
        ...
        L_0x004f:
            ...
            java.lang.String r12 = r12.getMessage()     // Catch:{ all -> 0x0104 }
            r2.append(r12)     // Catch:{ all -> 0x0104 }
            java.lang.String r12 = r2.toString()     // Catch:{ all -> 0x0104 }
            android.util.Log.e(r8, r12)     // Catch:{ all -> 0x0104 }
            goto L_0x0091
        L_0x0069:
            r12 = move-exception
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ all -> 0x0104 }
            ...
            goto L_0x0091
        L_0x0083:
            android.content.ContentResolver r2 = r9.mContentResolver     // Catch:{ all -> 0x0104 }
            r4 = 0
            java.lang.String r5 = "contact_id=?"
            r7 = 0
            android.database.Cursor r12 = r2.query(r3, r4, r5, r6, r7)     // Catch:{ all -> 0x0104 }
            android.content.EntityIterator r1 = android.provider.ContactsContract.RawContacts.newEntityIterator(r12)     // Catch:{ all -> 0x0104 }
        L_0x0091:
            java.lang.String r12 = ""
            if (r1 != 0) goto L_0x00a0
            java.lang.String r9 = "EntityIterator is null"
            android.util.Log.e(r8, r9)     // Catch:{ all -> 0x0104 }
            if (r1 == 0) goto L_0x009f
            r1.close()
        L_0x009f:
            return r12
        L_0x00a0:
            boolean r2 = r1.hasNext()     // Catch:{ all -> 0x0104 }
            if (r2 != 0) goto L_0x00be
            java.lang.StringBuilder r9 = new java.lang.StringBuilder     // Catch:{ all -> 0x0104 }
            r9.<init>()     // Catch:{ all -> 0x0104 }
            java.lang.String r0 = "Data does not exist. contactId: "
            r9.append(r0)     // Catch:{ all -> 0x0104 }
            r9.append(r10)     // Catch:{ all -> 0x0104 }
            java.lang.String r9 = r9.toString()     // Catch:{ all -> 0x0104 }
            android.util.Log.w(r8, r9)     // Catch:{ all -> 0x0104 }
            r1.close()
            return r12
        L_0x00be:
            boolean r10 = r1.hasNext()     // Catch:{ all -> 0x0104 }
            if (r10 == 0) goto L_0x00fc
            java.lang.Object r10 = r1.next()     // Catch:{ all -> 0x0104 }
            android.content.Entity r10 = (android.content.Entity) r10     // Catch:{ all -> 0x0104 }
            java.util.ArrayList r10 = r10.getSubValues()     // Catch:{ all -> 0x0104 }
            java.util.Iterator r10 = r10.iterator()     // Catch:{ all -> 0x0104 }
        L_0x00d2:
            boolean r11 = r10.hasNext()     // Catch:{ all -> 0x0104 }
            if (r11 == 0) goto L_0x00be
            java.lang.Object r11 = r10.next()     // Catch:{ all -> 0x0104 }
            android.content.Entity$NamedContentValues r11 = (android.content.Entity.NamedContentValues) r11     // Catch:{ all -> 0x0104 }
            android.content.ContentValues r11 = r11.values     // Catch:{ all -> 0x0104 }
            java.lang.String r12 = "mimetype"
            java.lang.String r12 = r11.getAsString(r12)     // Catch:{ all -> 0x0104 }
            if (r12 == 0) goto L_0x00d2
            java.lang.Object r2 = r0.get(r12)     // Catch:{ all -> 0x0104 }
            java.util.List r2 = (java.util.List) r2     // Catch:{ all -> 0x0104 }
            if (r2 != 0) goto L_0x00f8
            java.util.ArrayList r2 = new java.util.ArrayList     // Catch:{ all -> 0x0104 }
            r2.<init>()     // Catch:{ all -> 0x0104 }
            r0.put(r12, r2)     // Catch:{ all -> 0x0104 }
        L_0x00f8:
            r2.add(r11)     // Catch:{ all -> 0x0104 }
            goto L_0x00d2
        L_0x00fc:
            r1.close()
            java.lang.String r9 = r9.buildVCard(r0)
            return r9
        L_0x0104:
            r9 = move-exception
    ...
    public boolean initWithCallback(Cursor cursor, RawContactEntitlesInfoCallback rawContactEntitlesInfoCallback) {
        if (!initInterFirstPart((Uri) null)) {
            return false;
        }
    ...
    public boolean initWithRawContactsEntityUri(Uri uri) {
        return init(ContactsContract.Contacts.CONTENT_URI, sContactsProjection, (String) null, (String[]) null, (String) null, uri);
    }
    ...
    public VCardComposer(Context context, int i) {
        this(context, i, (String) null, true);
    }
    ...
    public boolean init(String str, String[] strArr) {
        return init(ContactsContract.Contacts.CONTENT_URI, sContactsProjection, str, strArr, (String) null, (Uri) null);
    }
    ...
    public boolean init(Uri uri, String str, String[] strArr, String str2) {
        return init(uri, sContactsProjection, str, strArr, str2, (Uri) null);
    }
    ...
    public VCardComposer(Context context, ContentResolver contentResolver, int i, String str, boolean z) {
        ...
        StringBuilder Pa = C0632a.m1011Pa("Use the charset \"");
    ...
    public boolean init(Cursor cursor) {
        return initWithCallback(cursor, (RawContactEntitlesInfoCallback) null);
    }
}
