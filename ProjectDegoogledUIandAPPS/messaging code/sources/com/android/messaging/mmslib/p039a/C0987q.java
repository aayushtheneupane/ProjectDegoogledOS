...
/* renamed from: com.android.messaging.mmslib.a.q */
public class C0987q {

    /* renamed from: fm */
    private SparseArray f1417fm;

    public C0987q() {
        this.f1417fm = null;
        this.f1417fm = new SparseArray();
    }

    /* renamed from: Ba */
    public boolean mo6709Ba(int i) {
        return this.f1417fm.get(i, (Object) null) != null;
    }

    /* access modifiers changed from: protected */
    /* renamed from: C */
    public C0975e mo6710C(int i) {
        return (C0975e) this.f1417fm.get(i);
    }

    /* access modifiers changed from: protected */
    /* renamed from: D */
    public C0975e[] mo6711D(int i) {
        ArrayList arrayList = (ArrayList) this.f1417fm.get(i);
        if (arrayList == null) {
            return null;
        }
        return (C0975e[]) arrayList.toArray(new C0975e[arrayList.size()]);
    }

    /* access modifiers changed from: protected */
    /* renamed from: E */
    public long mo6712E(int i) {
        Long l = (Long) this.f1417fm.get(i);
        if (l == null) {
            return -1;
        }
        return l.longValue();
    ...
    /* access modifiers changed from: protected */
    /* renamed from: F */
    public int mo6713F(int i) {
        Integer num = (Integer) this.f1417fm.get(i);
        if (num == null) {
            return 0;
        }
        return num.intValue();
    ...
    /* access modifiers changed from: protected */
    /* renamed from: G */
    public byte[] mo6714G(int i) {
        return (byte[]) this.f1417fm.get(i);
    }

    /* access modifiers changed from: protected */
    /* renamed from: a */
    public void mo6717a(C0975e[] eVarArr, int i) {
        if (eVarArr == null) {
            throw new NullPointerException();
        } else if (i == 129 || i == 130 || i == 151) {
            ArrayList arrayList = new ArrayList();
            for (C0975e add : eVarArr) {
                arrayList.add(add);
            }
            this.f1417fm.put(i, arrayList);
        } else {
    ...
    /* access modifiers changed from: protected */
    /* renamed from: b */
    public void mo6719b(byte[] bArr, int i) {
        if (bArr != null) {
    ...
    public void mo6720e(int r9, int r10) {
        /*
            r8 = this;
        ...
        L_0x0060:
            ...
            goto L_0x0131
        L_0x0066:
            com.android.messaging.mmslib.InvalidHeaderValueException r8 = new com.android.messaging.mmslib.InvalidHeaderValueException
            r8.<init>(r4)
            throw r8
        L_0x006c:
        ...
        L_0x0131:
            r3 = r9
        L_0x0132:
            android.util.SparseArray r8 = r8.f1417fm
            java.lang.Integer r9 = java.lang.Integer.valueOf(r3)
            r8.put(r10, r9)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.messaging.mmslib.p039a.C0987q.mo6720e(int, int):void");
    }

    /* access modifiers changed from: protected */
    /* renamed from: b */
    public void mo6718b(C0975e eVar, int i) {
        if (eVar == null) {
            throw new NullPointerException();
        } else if (i == 137 || i == 147 || i == 150 || i == 154 || i == 160 || i == 164 || i == 166 || i == 181 || i == 182) {
            this.f1417fm.put(i, eVar);
        } else {
            throw new RuntimeException("Invalid header field!");
        }
    }
    ...
    /* access modifiers changed from: protected */
    /* renamed from: a */
    public void mo6716a(C0975e eVar, int i) {
        if (eVar == null) {
            throw new NullPointerException();
        } else if (i == 129 || i == 130 || i == 151) {
            ArrayList arrayList = (ArrayList) this.f1417fm.get(i);
    ...
    /* access modifiers changed from: protected */
    /* renamed from: a */
    public void mo6715a(long j, int i) {
        if (i == 133 || i == 142 || i == 157 || i == 159 || i == 161 || i == 173 || i == 175 || i == 179 || i == 135 || i == 136) {
            this.f1417fm.put(i, Long.valueOf(j));
            return;
        }
        throw new RuntimeException("Invalid header field!");
    }
