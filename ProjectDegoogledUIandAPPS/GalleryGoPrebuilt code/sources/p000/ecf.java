...
/* renamed from: ecf */
/* compiled from: PG */
public final class ecf extends ece implements hbf, ioe, hbd {

    /* renamed from: aa */
    private ecj f7919aa;

    /* renamed from: ab */
    private Context f7920ab;

    /* renamed from: ac */
    private final hkx f7921ac = new hkx(this);

    /* renamed from: ad */
    private final C0002ab f7922ad = new C0002ab(this);

    /* renamed from: ae */
    private boolean f7923ae;
    ...
    public final Context mo2628P() {
        if (this.f7920ab == null) {
            this.f7920ab = new hcf((Context) this.f7916Z);
        }
        return this.f7920ab;
    }
    ...
    /* renamed from: Q */
    public final /* bridge */ /* synthetic */ ftr mo4673Q() {
    ...
    public final void mo1832a(Context context) {
        ...
        try {
            if (!this.f7923ae) {
                ...
                if (this.f7919aa == null) {
                    this.f7919aa = ((eck) mo2453b()).mo2389K();
                    this.f9583V.mo64a(new hbu(this.f7922ad));
                }
                if (c != null) {
                    c.close();
                    return;
    ...
    public final void mo165a(Bundle bundle) {
        ...
        try {
            super.mo165a(bundle);
            ecj R = mo2635n();
            R.f7931e = R.f7929c.mo5581a(R.f7927a);
            if (c != null) {
                c.close();
                return;
            }
    ...
    public final Dialog mo193c(Bundle bundle) {
        super.mo193c(bundle);
        ecj R = mo2635n();
        gfi gfi = new gfi(R.f7927a.mo2634k(), 2131951907);
        gfi.mo6555c((int) R.string.turn_off_face_grouping);
        gfi.mo6551b((int) R.string.turn_off_face_grouping_description);
        gfi.mo6552b(R.string.keep_on, R.f7928b.mo7574a((DialogInterface.OnClickListener) new ecg(R), "Keep on clicked"));
        gfi.mo6556c(R.string.turn_off, R.f7928b.mo7574a((DialogInterface.OnClickListener) new ech(R), "Turn off clicked"));
        C0394oj b = gfi.mo6550b();
        b.setOnShowListener(fhg.m8899a((DialogInterface.OnShowListener) new eci(R), (C0140fa) R.f7927a));
        return b;
    }
    ...
    /* renamed from: R */
    public final ecj mo2635n() {
        ecj ecj = this.f7919aa;
        if (ecj == null) {
            throw new IllegalStateException("peer() called before initialized.");
        } else if (!this.f7923ae) {
            return ecj;
        } else {
