    ...
    static /* synthetic */ class C01621 {
        ...
        static {
            ...
            L_0x0091:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.lifecycle.LifecycleRegistry.C01621.<clinit>():void");
        }
    }

    private static Lifecycle.Event downEvent(Lifecycle.State state) {
        int i = C01621.$SwitchMap$androidx$lifecycle$Lifecycle$State[state.ordinal()];
        if (i == 1) {
