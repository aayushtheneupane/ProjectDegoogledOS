...
class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    final ValueAnimator mShowHideAnimator = ValueAnimator.ofFloat(new float[]{ContactPhotoManager.OFFSET_DEFAULT, 1.0f});
    ...
    private void drawVerticalScrollbar(Canvas canvas) {
        ...
        canvas.translate((float) i3, ContactPhotoManager.OFFSET_DEFAULT);
        this.mVerticalTrackDrawable.draw(canvas);
        canvas.translate(ContactPhotoManager.OFFSET_DEFAULT, (float) i6);
        this.mVerticalThumbDrawable.draw(canvas);
    ...
    private void drawHorizontalScrollbar(Canvas canvas) {
        ...
        canvas.translate(ContactPhotoManager.OFFSET_DEFAULT, (float) i3);
        this.mHorizontalTrackDrawable.draw(canvas);
        canvas.translate((float) i6, ContactPhotoManager.OFFSET_DEFAULT);
    ...
    public void onTouchEvent(RecyclerView recyclerView, MotionEvent motionEvent) {
        if (this.mState != 0) {
            if (motionEvent.getAction() == 0) {
                ...
                this.mVerticalDragY = ContactPhotoManager.OFFSET_DEFAULT;
                this.mHorizontalDragX = ContactPhotoManager.OFFSET_DEFAULT;
                setState(1);
                this.mDragState = 0;
    ...
    private class AnimatorListener extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            } else if (((Float) FastScroller.this.mShowHideAnimator.getAnimatedValue()).floatValue() == ContactPhotoManager.OFFSET_DEFAULT) {
