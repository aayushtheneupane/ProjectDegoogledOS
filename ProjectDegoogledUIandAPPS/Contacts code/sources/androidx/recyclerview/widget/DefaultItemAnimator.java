...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    private void animateRemoveImpl(final RecyclerView.ViewHolder viewHolder) {
        ...
        animate.setDuration(getRemoveDuration()).alpha(ContactPhotoManager.OFFSET_DEFAULT).setListener(new AnimatorListenerAdapter() {
    ...
    public boolean animateAdd(RecyclerView.ViewHolder viewHolder) {
        resetAnimation(viewHolder);
        viewHolder.itemView.setAlpha(ContactPhotoManager.OFFSET_DEFAULT);
    ...
    public void animateMoveImpl(RecyclerView.ViewHolder viewHolder, int i, int i2, int i3, int i4) {
        ...
        final int i6 = i4 - i2;
        if (i5 != 0) {
            view.animate().translationX(ContactPhotoManager.OFFSET_DEFAULT);
        }
        if (i6 != 0) {
            view.animate().translationY(ContactPhotoManager.OFFSET_DEFAULT);
        }
        final ViewPropertyAnimator animate = view.animate();
        ...
        animate.setDuration(getMoveDuration()).setListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationCancel(Animator animator) {
                if (i5 != 0) {
                    view.setTranslationX(ContactPhotoManager.OFFSET_DEFAULT);
                }
                if (i6 != 0) {
    ...
    public boolean animateChange(RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2, int i, int i2, int i3, int i4) {
        ...
        if (viewHolder2 != null) {
            ...
            viewHolder2.itemView.setAlpha(ContactPhotoManager.OFFSET_DEFAULT);
        }
    ...
    public void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            duration.alpha(ContactPhotoManager.OFFSET_DEFAULT).setListener(new AnimatorListenerAdapter() {
                public void onAnimationStart(Animator animator) {
        ...
        if (view2 != null) {
            ...
            animate.translationX(ContactPhotoManager.OFFSET_DEFAULT).translationY(ContactPhotoManager.OFFSET_DEFAULT).setDuration(getChangeDuration()).alpha(1.0f).setListener(new AnimatorListenerAdapter() {
                public void onAnimationStart(Animator animator) {
                ...
                public void onAnimationEnd(Animator animator) {
                    animate.setListener((Animator.AnimatorListener) null);
                    view2.setAlpha(1.0f);
                    view2.setTranslationX(ContactPhotoManager.OFFSET_DEFAULT);
                    view2.setTranslationY(ContactPhotoManager.OFFSET_DEFAULT);
    ...
    private boolean endChangeAnimationIfNecessary(ChangeInfo changeInfo, RecyclerView.ViewHolder viewHolder) {
        ...
        viewHolder.itemView.setTranslationX(ContactPhotoManager.OFFSET_DEFAULT);
        viewHolder.itemView.setTranslationY(ContactPhotoManager.OFFSET_DEFAULT);
