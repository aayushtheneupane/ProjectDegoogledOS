...
public class ViewDragHelper {
    ...
    private float clampMag(float f, float f2, float f3) {
        ...
        if (abs > f3) {
            return f > ContactPhotoManager.OFFSET_DEFAULT ? f3 : -f3;
        }
        return f;
    }
    ...
    private void clearMotionHistory() {
        ...
        if (fArr != null) {
            Arrays.fill(fArr, ContactPhotoManager.OFFSET_DEFAULT);
            Arrays.fill(this.mInitialMotionY, ContactPhotoManager.OFFSET_DEFAULT);
            Arrays.fill(this.mLastMotionX, ContactPhotoManager.OFFSET_DEFAULT);
            Arrays.fill(this.mLastMotionY, ContactPhotoManager.OFFSET_DEFAULT);
    ...
    public void processTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (actionMasked == 3) {
                if (this.mDragState == 1) {
                    dispatchViewReleased(ContactPhotoManager.OFFSET_DEFAULT, ContactPhotoManager.OFFSET_DEFAULT);
                }
                cancel();
