...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    private boolean isPrimaryNavigation(Fragment fragment) {
        if (fragment == null) {
            return true;
        }
    ...
    public AnimationOrAnimator loadAnimation(Fragment fragment, int i, boolean z, int i2) {
        ...
        switch (transitToStyleIndex) {
            case 1:
                return makeOpenCloseAnimation(1.125f, 1.0f, ContactPhotoManager.OFFSET_DEFAULT, 1.0f);
            case 2:
                return makeOpenCloseAnimation(1.0f, 0.975f, 1.0f, ContactPhotoManager.OFFSET_DEFAULT);
            case 3:
                return makeOpenCloseAnimation(0.975f, 1.0f, ContactPhotoManager.OFFSET_DEFAULT, 1.0f);
            case 4:
                return makeOpenCloseAnimation(1.0f, 1.075f, 1.0f, ContactPhotoManager.OFFSET_DEFAULT);
            case 5:
                return makeFadeAnimation(ContactPhotoManager.OFFSET_DEFAULT, 1.0f);
            case 6:
                return makeFadeAnimation(1.0f, ContactPhotoManager.OFFSET_DEFAULT);
            default:
    ...
    private void makeRemovedFragmentsInvisible(ArraySet<Fragment> arraySet) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (!valueAt.mAdded) {
                ...
                requireView.setAlpha(ContactPhotoManager.OFFSET_DEFAULT);
            }
        }
    }
    ...
    public void completeExecute(BackStackRecord backStackRecord, boolean z, boolean z2, boolean z3) {
        ...
        for (Fragment next : this.mActive.values()) {
            if (next != null && next.mView != null && next.mIsNewlyAdded && backStackRecord.interactsWith(next.mContainerId)) {
                ...
                if (z3) {
                    next.mPostponedAlpha = ContactPhotoManager.OFFSET_DEFAULT;
                } else {
    ...
    private void dispatchOnParentPrimaryNavigationFragmentChanged(Fragment fragment) {
