...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    public void stop() {
        this.mAnimator.cancel();
        setRotation(ContactPhotoManager.OFFSET_DEFAULT);
    ...
    private void setupAnimators() {
        ...
        ValueAnimator ofFloat = ValueAnimator.ofFloat(new float[]{ContactPhotoManager.OFFSET_DEFAULT, 1.0f});
        ...
        ofFloat.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationStart(Animator animator) {
                CircularProgressDrawable.this.mRotationCount = ContactPhotoManager.OFFSET_DEFAULT;
            }
    ...
    private static class Ring {
        ...
        int[] mColors;
        int mCurrentColor;
        float mEndTrim = ContactPhotoManager.OFFSET_DEFAULT;
        final Paint mPaint = new Paint();
        float mRingCenterRadius;
        float mRotation = ContactPhotoManager.OFFSET_DEFAULT;
        boolean mShowArrow;
        float mStartTrim = ContactPhotoManager.OFFSET_DEFAULT;
        ...
        public void drawTriangle(Canvas canvas, float f, float f2, RectF rectF) {
            if (this.mShowArrow) {
                ...
                this.mArrow.moveTo(ContactPhotoManager.OFFSET_DEFAULT, ContactPhotoManager.OFFSET_DEFAULT);
                this.mArrow.lineTo(((float) this.mArrowWidth) * this.mArrowScale, ContactPhotoManager.OFFSET_DEFAULT);
        ...
        public void resetOriginals() {
            this.mStartingStartTrim = ContactPhotoManager.OFFSET_DEFAULT;
            this.mStartingEndTrim = ContactPhotoManager.OFFSET_DEFAULT;
            this.mStartingRotation = ContactPhotoManager.OFFSET_DEFAULT;
            setStartTrim(ContactPhotoManager.OFFSET_DEFAULT);
            setEndTrim(ContactPhotoManager.OFFSET_DEFAULT);
            setRotation(ContactPhotoManager.OFFSET_DEFAULT);
        }
    }
}
