...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent3, NestedScrollingParent2, NestedScrollingChild3, NestedScrollingChild2, NestedScrollingParent, NestedScrollingChild {
    ...
    public void onNestedPreScroll(View view, int i, int i2, int[] iArr) {
        ...
        if (this.mUsingCustomStart && i2 > 0 && this.mTotalUnconsumed == ContactPhotoManager.OFFSET_DEFAULT && Math.abs(i2 - iArr[1]) > 0) {
            this.mCircleView.setVisibility(8);
        }
    ...
    private void moveSpinner(float f) {
        ...
        float f2 = (float) i;
        double max2 = (double) (Math.max(ContactPhotoManager.OFFSET_DEFAULT, Math.min(abs, f2 * 2.0f) / f2) / 4.0f);
        ...
        this.mProgress.setStartEndTrim(ContactPhotoManager.OFFSET_DEFAULT, Math.min(0.8f, max * 0.8f));
