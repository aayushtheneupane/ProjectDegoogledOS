...
public class ViewCompat {
    ...
    public static float getElevation(View view) {
        return Build.VERSION.SDK_INT >= 21 ? view.getElevation() : ContactPhotoManager.OFFSET_DEFAULT;
    }
    ...
    public static float getZ(View view) {
        return Build.VERSION.SDK_INT >= 21 ? view.getZ() : ContactPhotoManager.OFFSET_DEFAULT;
    }
