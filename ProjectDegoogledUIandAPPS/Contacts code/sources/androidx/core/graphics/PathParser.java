    ...
    public static class PathDataNode {
        ...
        private static void addCommand(Path path, float[] fArr, char c, char c2, float[] fArr2) {
            ...
            switch (c3) {
                ...
                case 'S':
                case 'q':
                case R$styleable.AppCompatTheme_windowActionBar:
                    i = 4;
                    break;
                case 'Z':
            ...
            while (i3 < fArr3.length) {
                if (c3 != 'A') {
                    if (c3 == 'C') {
                        ...
                        if (c3 == 'c') {
                            ...
                            if (c3 != 'q') {
                                if (c3 == 'v') {
                                    int i18 = i3 + 0;
                                    path2.rLineTo(ContactPhotoManager.OFFSET_DEFAULT, fArr3[i18]);
                                    f6 = fArr3[i18];
                                } else if (c3 != 'L') {
                                    if (c3 == 'M') {
                                        int i19 = i3 + 0;
                                        ...
                                        if (c4 == 'c' || c4 == 's' || c4 == 'C' || c4 == 'S') {
                                            ...
                                            f8 = ContactPhotoManager.OFFSET_DEFAULT;
                                            f7 = ContactPhotoManager.OFFSET_DEFAULT;
                                        }
                                        int i31 = i3 + 0;
                                        int i32 = i3 + 1;
                                        int i33 = i3 + 2;
                                        ...
                                        if (c4 == 'q' || c4 == 't' || c4 == 'Q' || c4 == 'T') {
                                            ...
                                            f10 = ContactPhotoManager.OFFSET_DEFAULT;
                                            f9 = 0;
                                        }
                                        int i35 = i3 + 0;
                                        int i36 = i3 + 1;
                            ...
                            int i43 = i3 + 0;
                            path2.rLineTo(fArr3[i43], ContactPhotoManager.OFFSET_DEFAULT);
                            f17 += fArr3[i43];
                        }
                        i2 = i3;
                    } else {
                        ...
                        float f36 = f18;
                        i2 = i3;
                        drawArc(path, f17, f18, f32, f33, f34, f35, fArr3[i3 + 2], fArr3[i3 + 3] != ContactPhotoManager.OFFSET_DEFAULT, fArr3[i3 + 4] != ContactPhotoManager.OFFSET_DEFAULT);
                        f = f17 + fArr3[i44];
                        f2 = f36 + fArr3[i45];
                    }
                    i3 = i2 + i;
                    ...
                    int i46 = i2 + 5;
                    int i47 = i2 + 6;
                    drawArc(path, f17, f18, fArr3[i46], fArr3[i47], fArr3[i2 + 0], fArr3[i2 + 1], fArr3[i2 + 2], fArr3[i2 + 3] != ContactPhotoManager.OFFSET_DEFAULT, fArr3[i2 + 4] != ContactPhotoManager.OFFSET_DEFAULT);
                    f = fArr3[i46];
                    f2 = fArr3[i47];
                }
                f14 = f18;
