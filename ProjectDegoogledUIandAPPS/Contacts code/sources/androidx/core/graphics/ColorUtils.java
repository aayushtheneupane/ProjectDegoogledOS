...
public final class ColorUtils {
    ...
    public static void RGBToHSL(int i, int i2, int i3, float[] fArr) {
        ...
        if (f8 < ContactPhotoManager.OFFSET_DEFAULT) {
            f8 += 360.0f;
        }
        fArr[0] = constrain(f8, ContactPhotoManager.OFFSET_DEFAULT, 360.0f);
        fArr[1] = constrain(f, ContactPhotoManager.OFFSET_DEFAULT, 1.0f);
        fArr[2] = constrain(f7, ContactPhotoManager.OFFSET_DEFAULT, 1.0f);
    }
