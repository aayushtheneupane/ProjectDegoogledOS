...
final class GradientColorInflaterCompat {
    static Shader createFromXmlInner(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws IOException, XmlPullParserException {
        ...
        if (name.equals("gradient")) {
            ...
            float namedFloat = TypedArrayUtils.getNamedFloat(obtainAttributes, xmlPullParser2, "startX", R$styleable.GradientColor_android_startX, ContactPhotoManager.OFFSET_DEFAULT);
            float namedFloat2 = TypedArrayUtils.getNamedFloat(obtainAttributes, xmlPullParser2, "startY", R$styleable.GradientColor_android_startY, ContactPhotoManager.OFFSET_DEFAULT);
            float namedFloat3 = TypedArrayUtils.getNamedFloat(obtainAttributes, xmlPullParser2, "endX", R$styleable.GradientColor_android_endX, ContactPhotoManager.OFFSET_DEFAULT);
            float namedFloat4 = TypedArrayUtils.getNamedFloat(obtainAttributes, xmlPullParser2, "endY", R$styleable.GradientColor_android_endY, ContactPhotoManager.OFFSET_DEFAULT);
            float namedFloat5 = TypedArrayUtils.getNamedFloat(obtainAttributes, xmlPullParser2, "centerX", R$styleable.GradientColor_android_centerX, ContactPhotoManager.OFFSET_DEFAULT);
            float namedFloat6 = TypedArrayUtils.getNamedFloat(obtainAttributes, xmlPullParser2, "centerY", R$styleable.GradientColor_android_centerY, ContactPhotoManager.OFFSET_DEFAULT);
            int namedInt = TypedArrayUtils.getNamedInt(obtainAttributes, xmlPullParser2, BaseAccountType.Attr.TYPE, R$styleable.GradientColor_android_type, 0);
            ...
            float f = namedFloat5;
            float namedFloat7 = TypedArrayUtils.getNamedFloat(obtainAttributes, xmlPullParser2, "gradientRadius", R$styleable.GradientColor_android_gradientRadius, ContactPhotoManager.OFFSET_DEFAULT);
            ...
            if (namedInt == 1) {
                float f2 = f;
                if (namedFloat7 > ContactPhotoManager.OFFSET_DEFAULT) {
    ...
    static final class ColorStops {
        ...
        ColorStops(int i, int i2) {
            ...
            this.mOffsets = new float[]{ContactPhotoManager.OFFSET_DEFAULT, 1.0f};
        }

        ColorStops(int i, int i2, int i3) {
            this.mColors = new int[]{i, i2, i3};
            this.mOffsets = new float[]{ContactPhotoManager.OFFSET_DEFAULT, 0.5f, 1.0f};
        }
    }
}
