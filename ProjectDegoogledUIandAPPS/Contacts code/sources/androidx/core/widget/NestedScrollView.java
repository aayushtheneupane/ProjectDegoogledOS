...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public boolean onNestedFling(View view, float f, float f2, boolean z) {
        ...
        dispatchNestedFling(ContactPhotoManager.OFFSET_DEFAULT, f2, true);
        fling((int) f2);
        return true;
    }
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        int i = BaseAccountType.Weight.NOTE;
        if (!canScroll) {
            ...
            View findNextFocus = FocusFinder.getInstance().findNextFocus(this, findFocus, BaseAccountType.Weight.NOTE);
            if (findNextFocus == null || findNextFocus == this || !findNextFocus.requestFocus(BaseAccountType.Weight.NOTE)) {
                return false;
            }
            return true;
            ...
            if (keyCode != 19) {
                if (keyCode != 20) {
                    ...
                    return arrowScroll(BaseAccountType.Weight.NOTE);
                } else {
                    return fullScroll(BaseAccountType.Weight.NOTE);
                }
            } else if (!keyEvent.isAltPressed()) {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        obtain.offsetLocation(ContactPhotoManager.OFFSET_DEFAULT, (float) this.mNestedYOffset);
        if (actionMasked != 0) {
            if (actionMasked == 1) {
                VelocityTracker velocityTracker = this.mVelocityTracker;
                ...
                if (Math.abs(yVelocity) > this.mMinimumVelocity) {
                    int i = -yVelocity;
                    float f = (float) i;
                    if (!dispatchNestedPreFling(ContactPhotoManager.OFFSET_DEFAULT, f)) {
                        dispatchNestedFling(ContactPhotoManager.OFFSET_DEFAULT, f, true);
                        fling(i);
                    }
    ...
    public boolean onGenericMotionEvent(MotionEvent motionEvent) {
        if ((motionEvent.getSource() & 2) != 0 && motionEvent.getAction() == 8 && !this.mIsBeingDragged) {
            ...
            if (axisValue != ContactPhotoManager.OFFSET_DEFAULT) {
                int scrollRange = getScrollRange();
                int scrollY = getScrollY();
    ...
    private float getVerticalScrollFactorCompat() {
        if (this.mVerticalScrollFactor == ContactPhotoManager.OFFSET_DEFAULT) {
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mEdgeGlowTop != null) {
            ...
            if (!this.mEdgeGlowBottom.isFinished()) {
                ...
                canvas.rotate(180.0f, (float) width2, ContactPhotoManager.OFFSET_DEFAULT);
