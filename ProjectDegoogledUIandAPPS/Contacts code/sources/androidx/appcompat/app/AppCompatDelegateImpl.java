...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private boolean updateForNightMode(int i, boolean z) {
        ...
        boolean z2 = false;
        if (i3 != i2 && !isActivityManifestHandlingUiMode && Build.VERSION.SDK_INT >= 17 && !this.mBaseContextAttached && (this.mHost instanceof android.view.ContextThemeWrapper)) {
        ...
        if (!z2 && !isActivityManifestHandlingUiMode && (this.mContext.getResources().getConfiguration().uiMode & 48) != i3) {
            if (z && this.mBaseContextAttached && (Build.VERSION.SDK_INT >= 17 || this.mCreated)) {
                Object obj = this.mHost;
                if (obj instanceof Activity) {
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        public void onDestroyActionMode(ActionMode actionMode) {
            ...
            if (appCompatDelegateImpl2.mActionModeView != null) {
                ...
                animate.alpha(ContactPhotoManager.OFFSET_DEFAULT);
