...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new ViewPropertyAnimatorListenerAdapter() {
        public void onAnimationEnd(View view) {
            ...
            if (windowDecorActionBar.mContentAnimations && (view2 = windowDecorActionBar.mContentView) != null) {
                ...
                WindowDecorActionBar.this.mContainerView.setTranslationY(ContactPhotoManager.OFFSET_DEFAULT);
            }
    ...
    public void doShow(boolean z) {
        ...
        if (this.mCurWindowVisibility != 0 || (!this.mShowHideAnimationEnabled && !z)) {
            ...
            this.mContainerView.setTranslationY(ContactPhotoManager.OFFSET_DEFAULT);
            ...
            animate.translationY(ContactPhotoManager.OFFSET_DEFAULT);
            ...
            if (this.mContentAnimations && (view2 = this.mContentView) != null) {
                ...
                animate2.translationY(ContactPhotoManager.OFFSET_DEFAULT);
