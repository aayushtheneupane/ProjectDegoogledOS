    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mRemoveActionBarHideOffset = new Runnable() {
            public void run() {
                ...
                ActionBarOverlayLayout actionBarOverlayLayout = ActionBarOverlayLayout.this;
                actionBarOverlayLayout.mCurrentActionBarTopAnimator = actionBarOverlayLayout.mActionBarTop.animate().translationY(ContactPhotoManager.OFFSET_DEFAULT).setListener(ActionBarOverlayLayout.this.mTopAnimatorListener);
            }
        };
