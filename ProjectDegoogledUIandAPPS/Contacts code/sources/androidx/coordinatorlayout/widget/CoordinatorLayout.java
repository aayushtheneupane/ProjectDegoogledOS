...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            if ((!z && !z2) || actionMasked == 0) {
                ...
                if (motionEvent3 == null) {
                    long uptimeMillis = SystemClock.uptimeMillis();
                    motionEvent3 = MotionEvent.obtain(uptimeMillis, uptimeMillis, 3, ContactPhotoManager.OFFSET_DEFAULT, ContactPhotoManager.OFFSET_DEFAULT, 0);
                }
                if (i2 == 0) {
    ...
    public boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (behavior != null) {
            ...
            if (scrimOpacity > ContactPhotoManager.OFFSET_DEFAULT) {
    ...
    public static abstract class Behavior<V extends View> {
        ...
        public boolean blocksInteractionBelow(CoordinatorLayout coordinatorLayout, V v) {
            return getScrimOpacity(coordinatorLayout, v) > ContactPhotoManager.OFFSET_DEFAULT;
        }
