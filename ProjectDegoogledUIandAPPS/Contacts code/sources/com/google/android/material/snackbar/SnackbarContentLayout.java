...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public void animateContentIn(int i, int i2) {
        this.messageView.setAlpha(ContactPhotoManager.OFFSET_DEFAULT);
        long j = (long) i2;
        long j2 = (long) i;
        this.messageView.animate().alpha(1.0f).setDuration(j).setStartDelay(j2).start();
        if (this.actionView.getVisibility() == 0) {
            this.actionView.setAlpha(ContactPhotoManager.OFFSET_DEFAULT);
    ...
    public void animateContentOut(int i, int i2) {
        ...
        long j = (long) i2;
        long j2 = (long) i;
        this.messageView.animate().alpha(ContactPhotoManager.OFFSET_DEFAULT).setDuration(j).setStartDelay(j2).start();
        if (this.actionView.getVisibility() == 0) {
            this.actionView.setAlpha(1.0f);
            this.actionView.animate().alpha(ContactPhotoManager.OFFSET_DEFAULT).setDuration(j).setStartDelay(j2).start();
        }
    }
}
