...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
        ...
        if (viewGroup == null) {
            ...
            ViewCompat.setOnApplyWindowInsetsListener(this.view, new OnApplyWindowInsetsListener() {
                public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                    int unused = BaseTransientBottomBar.this.extraBottomMarginInsets = windowInsetsCompat.getSystemWindowInsetBottom();
    ...
    private void startFadeInAnimation() {
        ValueAnimator alphaAnimator = getAlphaAnimator(ContactPhotoManager.OFFSET_DEFAULT, 1.0f);
    ...
    private void startFadeOutAnimation(final int i) {
        ValueAnimator alphaAnimator = getAlphaAnimator(1.0f, ContactPhotoManager.OFFSET_DEFAULT);
