...
public final class CollapsingTextHelper {
    ...
    public void getCollapsedTextActualBounds(RectF rectF) {
        ...
        rectF.right = !calculateIsRtl ? rectF.left + calculateCollapsedTextWidth() : (float) rect2.right;
    ...
    public void setExpansionFraction(float f) {
        float clamp = MathUtils.clamp(f, (float) ContactPhotoManager.OFFSET_DEFAULT, 1.0f);
    ...
    private void calculateBaseOffsets() {
        ...
        float measureText = charSequence != null ? this.textPaint.measureText(charSequence, 0, charSequence.length()) : ContactPhotoManager.OFFSET_DEFAULT;
    ...
    private void calculateUsingTextSize(float f) {
        ...
        if (this.text != null) {
            ...
            if (width > ContactPhotoManager.OFFSET_DEFAULT) {
    ...
    private void ensureExpandedTexture() {
        if (this.expandedTitleTexture == null && !this.expandedBounds.isEmpty() && !TextUtils.isEmpty(this.textToDraw)) {
            ...
            if (round > 0 && round2 > 0) {
                ...
                CharSequence charSequence2 = this.textToDraw;
                canvas.drawText(charSequence2, 0, charSequence2.length(), ContactPhotoManager.OFFSET_DEFAULT, ((float) round2) - this.textPaint.descent(), this.textPaint);
