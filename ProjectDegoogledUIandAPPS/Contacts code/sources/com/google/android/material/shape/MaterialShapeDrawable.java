...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, ShapeAppearanceModel.OnChangedListener {
    ...
    private boolean hasStroke() {
        Paint.Style style = this.drawableState.paintStyle;
        return (style == Paint.Style.FILL_AND_STROKE || style == Paint.Style.STROKE) && this.strokePaint.getStrokeWidth() > ContactPhotoManager.OFFSET_DEFAULT;
    }
    ...
    private float adjustCornerSizeForStrokeSize(float f) {
        return Math.max(f - getStrokeInsetLength(), ContactPhotoManager.OFFSET_DEFAULT);
    }
    ...
    private android.graphics.PorterDuffColorFilter calculatePaintColorTintFilter(android.graphics.Paint r2, boolean r3) {
        /*
            ...
            int r2 = r2.getColor()
            int r3 = r1.layerElevationOverlayIfNeeded(r2)
    ...
    private float getStrokeInsetLength() {
        return hasStroke() ? this.strokePaint.getStrokeWidth() / 2.0f : ContactPhotoManager.OFFSET_DEFAULT;
    }
    ...
    static final class MaterialShapeDrawableState extends Drawable.ConstantState {
        ...
        public float elevation = ContactPhotoManager.OFFSET_DEFAULT;
