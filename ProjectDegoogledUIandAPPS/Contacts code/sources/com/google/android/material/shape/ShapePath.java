...
public class ShapePath {
    ...
    public ShapePath() {
        reset(ContactPhotoManager.OFFSET_DEFAULT, ContactPhotoManager.OFFSET_DEFAULT);
    }

    public void reset(float f, float f2) {
        reset(f, f2, 270.0f, ContactPhotoManager.OFFSET_DEFAULT);
    }
    ...
    public void lineTo(float f, float f2) {
        ...
        float unused = pathLineOperation.f16x = f;
        float unused2 = pathLineOperation.f17y = f2;
    ...
    public void addArc(float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        float f7 = f5 + f6;
        boolean z = f6 < ContactPhotoManager.OFFSET_DEFAULT;
        if (z) {
            f5 = (f5 + 180.0f) % 360.0f;
        }
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            RectF rectF = new RectF(ContactPhotoManager.OFFSET_DEFAULT, ContactPhotoManager.OFFSET_DEFAULT, (float) Math.hypot((double) (this.operation.f17y - this.startY), (double) (this.operation.f16x - this.startX)), ContactPhotoManager.OFFSET_DEFAULT);
        ...
        public float getAngle() {
            return (float) Math.toDegrees(Math.atan((double) ((this.operation.f17y - this.startY) / (this.operation.f16x - this.startX))));
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        public void applyToPath(Matrix matrix, Path path) {
            ...
            path.lineTo(this.f16x, this.f17y);
