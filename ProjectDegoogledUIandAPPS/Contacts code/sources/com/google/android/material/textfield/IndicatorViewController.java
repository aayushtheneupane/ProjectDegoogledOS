...
final class IndicatorViewController {
            ...
            animatorSet.addListener(new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animator) {
                    ...
                    if (textView != null) {
                        ...
                        if (textView2 != null) {
                            textView2.setTranslationY(ContactPhotoManager.OFFSET_DEFAULT);
    ...
    private ObjectAnimator createCaptionOpacityAnimator(TextView textView, boolean z) {
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(textView, View.ALPHA, new float[]{z ? 1.0f : ContactPhotoManager.OFFSET_DEFAULT});
