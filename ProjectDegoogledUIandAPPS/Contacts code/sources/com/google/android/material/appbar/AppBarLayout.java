...
public class AppBarLayout extends LinearLayout {
    ...
    protected static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        private void animateOffsetTo(CoordinatorLayout coordinatorLayout, T t, int i, float f) {
            ...
            if (abs2 > ContactPhotoManager.OFFSET_DEFAULT) {
        ...
        private void snapToChildIfNeeded(CoordinatorLayout coordinatorLayout, T t) {
            ...
            if (childIndexOnOffset >= 0) {
                ...
                if ((scrollFlags & 17) == 17) {
                    ...
                    animateOffsetTo(coordinatorLayout, t, MathUtils.clamp(i, -t.getTotalScrollRange(), 0), ContactPhotoManager.OFFSET_DEFAULT);
                }
            }
        }
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, T t, int i) {
            ...
            if (i3 >= 0 && (pendingAction & 8) == 0) {
                ...
                if ((pendingAction & 2) != 0) {
                    ...
                    if (z) {
                        animateOffsetTo(coordinatorLayout, t, i5, ContactPhotoManager.OFFSET_DEFAULT);
                    } else {
                        setHeaderTopBottomOffset(coordinatorLayout, t, i5);
                    }
                } else if ((pendingAction & 1) != 0) {
                    if (z) {
                        animateOffsetTo(coordinatorLayout, t, 0, ContactPhotoManager.OFFSET_DEFAULT);
                    } else {
