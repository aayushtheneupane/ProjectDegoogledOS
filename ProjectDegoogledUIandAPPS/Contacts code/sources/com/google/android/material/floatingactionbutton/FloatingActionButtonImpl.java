...
class FloatingActionButtonImpl {
    ...
    private void calculateImageMatrixFromScale(float f, Matrix matrix) {
        ...
        if (drawable != null && this.maxImageSize != 0) {
            ...
            rectF.set(ContactPhotoManager.OFFSET_DEFAULT, ContactPhotoManager.OFFSET_DEFAULT, (float) drawable.getIntrinsicWidth(), (float) drawable.getIntrinsicHeight());
            int i = this.maxImageSize;
            rectF2.set(ContactPhotoManager.OFFSET_DEFAULT, ContactPhotoManager.OFFSET_DEFAULT, (float) i, (float) i);
    ...
    public void hide(final InternalVisibilityChangedListener internalVisibilityChangedListener, final boolean z) {
        if (!isOrWillBeHidden()) {
            ...
            if (shouldAnimateVisibilityChange()) {
                ...
                AnimatorSet createAnimator = createAnimator(motionSpec, ContactPhotoManager.OFFSET_DEFAULT, ContactPhotoManager.OFFSET_DEFAULT, ContactPhotoManager.OFFSET_DEFAULT);
        ...
        if (!isOrWillBeShown()) {
            ...
            if (shouldAnimateVisibilityChange()) {
                if (this.view.getVisibility() != 0) {
                    this.view.setAlpha(ContactPhotoManager.OFFSET_DEFAULT);
                    this.view.setScaleY(ContactPhotoManager.OFFSET_DEFAULT);
                    this.view.setScaleX(ContactPhotoManager.OFFSET_DEFAULT);
                    setImageMatrixScale(ContactPhotoManager.OFFSET_DEFAULT);
                }
    ...
    private ValueAnimator createElevationAnimator(ShadowAnimatorImpl shadowAnimatorImpl) {
        ...
        valueAnimator.setFloatValues(new float[]{ContactPhotoManager.OFFSET_DEFAULT, 1.0f});
    ...
    private abstract class ShadowAnimatorImpl extends AnimatorListenerAdapter implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            if (!this.validValues) {
                ...
                this.shadowSizeStart = materialShapeDrawable == null ? ContactPhotoManager.OFFSET_DEFAULT : materialShapeDrawable.getElevation();
    ...
    public void updateFromViewRotation() {
        if (Build.VERSION.SDK_INT == 19) {
            if (this.rotation % 90.0f != ContactPhotoManager.OFFSET_DEFAULT) {
