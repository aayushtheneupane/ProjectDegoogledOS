...
public final class Iterators {
    ...
    public static boolean removeAll(Iterator<?> it, Collection<?> collection) {
        return removeIf(it, Predicates.m9in(collection));
    }
    ...
    public static boolean retainAll(Iterator<?> it, Collection<?> collection) {
        return removeIf(it, Predicates.not(Predicates.m9in(collection)));
    }
    ...
    public static <T> Iterator<T> concat(Iterator<? extends T> it, Iterator<? extends T> it2) {
        return concat(ImmutableList.m21of(it, it2).iterator());
    }

    public static <T> Iterator<T> concat(Iterator<? extends T> it, Iterator<? extends T> it2, Iterator<? extends T> it3) {
        return concat(ImmutableList.m22of(it, it2, it3).iterator());
    }

    public static <T> Iterator<T> concat(Iterator<? extends T> it, Iterator<? extends T> it2, Iterator<? extends T> it3, Iterator<? extends T> it4) {
        return concat(ImmutableList.m23of(it, it2, it3, it4).iterator());
    }
    ...
    /* JADX WARNING: type inference failed for: r1v0, types: [com.google.common.base.Predicate, com.google.common.base.Predicate<? super T>] */
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static <T> T find(java.util.Iterator<T> r0, com.google.common.base.Predicate<? super T> r1) {
        /*
            com.google.common.collect.UnmodifiableIterator r0 = filter(r0, r1)
    ...
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static <T> com.google.common.base.Optional<T> tryFind(java.util.Iterator<T> r0, com.google.common.base.Predicate<? super T> r1) {
        /*
            com.google.common.collect.UnmodifiableIterator r0 = filter(r0, r1)
            boolean r1 = r0.hasNext()
            if (r1 == 0) goto L_0x0013
            java.lang.Object r0 = r0.next()
            com.google.common.base.Optional r0 = com.google.common.base.Optional.m8of(r0)
            goto L_0x0017
        L_0x0013:
        ...
        L_0x0017:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.common.collect.Iterators.tryFind(java.util.Iterator, com.google.common.base.Predicate):com.google.common.base.Optional");
    }
    ...
    public static <T> PeekingIterator<T> peekingIterator(PeekingIterator<T> peekingIterator) {
        Preconditions.checkNotNull(peekingIterator);
