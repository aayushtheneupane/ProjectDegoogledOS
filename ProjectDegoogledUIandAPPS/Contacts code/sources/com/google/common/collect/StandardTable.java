    ...
    private class Column extends Maps.ImprovedAbstractMap<R, V> {
        ...
        private class EntrySet extends Sets.ImprovedAbstractSet<Map.Entry<R, V>> {
            ...
            public boolean retainAll(Collection<?> collection) {
                return Column.this.removeFromColumnIf(Predicates.not(Predicates.m9in(collection)));
            }
        }
                    ...
                    if (((Map) next.getValue()).containsKey(Column.this.columnKey)) {
                        return new AbstractMapEntry<R, V>() {
                            ...
                            public V setValue(V v) {
                                ...
                                Preconditions.checkNotNull(v);
                                return ((Map) next.getValue()).put(c, v);
                            }
                        };
                    }
                }
        ...
        private class KeySet extends Maps.KeySet<R, V> {
            ...
            public boolean retainAll(Collection<?> collection) {
                return Column.this.removeFromColumnIf(Maps.keyPredicateOnEntries(Predicates.not(Predicates.m9in(collection))));
            }
        }
        ...
        private class Values extends Maps.Values<R, V> {
            ...
            public boolean removeAll(Collection<?> collection) {
                return Column.this.removeFromColumnIf(Maps.valuePredicateOnEntries(Predicates.m9in(collection)));
            }

            public boolean retainAll(Collection<?> collection) {
                return Column.this.removeFromColumnIf(Maps.valuePredicateOnEntries(Predicates.not(Predicates.m9in(collection))));
            }
        }
    }
