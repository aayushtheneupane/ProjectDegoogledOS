...
public class CycleDetectingLockFactory {
    ...
    private static class ExampleStackTrace extends IllegalStateException {
        ...
        static Set<String> EXCLUDED_CLASS_NAMES = ImmutableSet.m64of(CycleDetectingLockFactory.class.getName(), ExampleStackTrace.class.getName(), LockGraphNode.class.getName());
    ...
    private static class LockGraphNode {
        ...
        public void checkAcquiredLock(Policy policy, LockGraphNode lockGraphNode) {
            ...
            Preconditions.checkState(z, "Attempted to acquire multiple locks with the same rank " + lockGraphNode.getLockName());
    ...
    final class CycleDetectingReentrantLock extends ReentrantLock implements CycleDetectingLock {
        ...
        private CycleDetectingReentrantLock(LockGraphNode lockGraphNode2, boolean z) {
            super(z);
            Preconditions.checkNotNull(lockGraphNode2);
            this.lockGraphNode = lockGraphNode2;
        }
