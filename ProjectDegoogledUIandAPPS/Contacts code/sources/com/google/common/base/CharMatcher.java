...
public abstract class CharMatcher implements Predicate<Character> {
    public static final CharMatcher ANY = new FastMatcher("CharMatcher.ANY") {
        ...
        /* renamed from: or */
        public CharMatcher mo8004or(CharMatcher charMatcher) {
    ...
    public static final CharMatcher JAVA_ISO_CONTROL = inRange(0, 31).mo8004or(inRange(127, 159)).withToString("CharMatcher.JAVA_ISO_CONTROL");
    ...
    public CharMatcher mo8004or(CharMatcher charMatcher) {
        Preconditions.checkNotNull(charMatcher);
        return new C0568Or(this, charMatcher);
    }

    /* renamed from: com.google.common.base.CharMatcher$Or */
    private static class C0568Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;

        C0568Or(CharMatcher charMatcher, CharMatcher charMatcher2, String str) {
            super(str);
            Preconditions.checkNotNull(charMatcher);
        ...
        C0568Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
        ...
        public CharMatcher withToString(String str) {
            return new C0568Or(this.first, this.second, str);
        }
    }
