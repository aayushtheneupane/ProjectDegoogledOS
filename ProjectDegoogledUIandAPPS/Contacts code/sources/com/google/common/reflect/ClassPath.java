...
public final class ClassPath {
    ...
    public static final Splitter CLASS_PATH_ATTRIBUTE_SEPARATOR = Splitter.m10on(" ").omitEmptyStrings();
    ...
    public static class ResourceInfo {
        ...
        /* renamed from: of */
        static ResourceInfo m113of(String str, ClassLoader classLoader) {
    ...
    static final class Scanner {
        ...
        private void scanDirectory(File file, ClassLoader classLoader) throws IOException {
            scanDirectory(file, classLoader, "", ImmutableSet.m61of());
        }
                ...
                for (File file2 : listFiles) {
                    ...
                    if (file2.isDirectory()) {
                        ...
                        if (!str2.equals("META-INF/MANIFEST.MF")) {
                            this.resources.add((Object) ResourceInfo.m113of(str2, classLoader));
                        }
                    }
                }
            }
                    ...
                    while (entries.hasMoreElements()) {
                        ...
                        if (!nextElement.isDirectory()) {
                            if (!nextElement.getName().equals("META-INF/MANIFEST.MF")) {
                                this.resources.add((Object) ResourceInfo.m113of(nextElement.getName(), classLoader));
                            }
                        }
                    }
                } finally {
