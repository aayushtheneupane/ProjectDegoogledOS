...
public class VolumeToolTipView extends LinearLayout {
    ...
    private void drawArrow() {
        View findViewById = findViewById(C1777R$id.arrow);
        ...
        paint.setPathEffect(new CornerPathEffect(getResources().getDimension(C1775R$dimen.volume_tool_tip_arrow_corner_radius)));
