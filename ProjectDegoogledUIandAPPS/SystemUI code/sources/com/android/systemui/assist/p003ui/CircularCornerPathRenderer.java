...
public final class CircularCornerPathRenderer extends CornerPathRenderer {
    ...
    static /* synthetic */ class C06611 {
        ...
        static final /* synthetic */ int[] f32x853e7b3e = new int[CornerPathRenderer.Corner.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f32x853e7b3e = r0
                int[] r0 = f32x853e7b3e     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f32x853e7b3e     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                int[] r0 = f32x853e7b3e     // Catch:{ NoSuchFieldError -> 0x002a }
                com.android.systemui.assist.ui.CornerPathRenderer$Corner r1 = com.android.systemui.assist.p003ui.CornerPathRenderer.Corner.TOP_RIGHT     // Catch:{ NoSuchFieldError -> 0x002a }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x002a }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x002a }
            L_0x002a:
                int[] r0 = f32x853e7b3e     // Catch:{ NoSuchFieldError -> 0x0035 }
                com.android.systemui.assist.ui.CornerPathRenderer$Corner r1 = com.android.systemui.assist.p003ui.CornerPathRenderer.Corner.TOP_LEFT     // Catch:{ NoSuchFieldError -> 0x0035 }
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.assist.p003ui.CircularCornerPathRenderer.C06611.<clinit>():void");
        }
    }

    public Path getCornerPath(CornerPathRenderer.Corner corner) {
        this.mPath.reset();
        int i = C06611.f32x853e7b3e[corner.ordinal()];
        if (i == 1) {
