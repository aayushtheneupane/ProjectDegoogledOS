...
public class BatteryPreference extends DropDownPreference implements TunerService.Tunable {
    ...
    public BatteryPreference(Context context, AttributeSet attributeSet) {
        ...
        this.mBattery = context.getString(17041145);
    ...
    public void onAttached() {
        super.onAttached();
        boolean z = false;
        if (Settings.System.getInt(getContext().getContentResolver(), "dummy_show_battery_percent", 0) != 0) {
            z = true;
        }
    ...
    public boolean persistString(String str) {
        ...
        Settings.System.putInt(getContext().getContentResolver(), "dummy_show_battery_percent", equals ? 1 : 0);
