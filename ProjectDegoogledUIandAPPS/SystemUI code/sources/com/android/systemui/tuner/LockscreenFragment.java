...
public class LockscreenFragment extends PreferenceFragment {
    ...
    public void onCreatePreferences(Bundle bundle, String str) {
        ...
        addPreferencesFromResource(C1786R$xml.lockscreen_settings);
    ...
    private void setupGroup(String str, String str2) {
        addTunable(new TunerService.Tunable((SwitchPreference) findPreference(str2), findPreference(str)) {
            private final /* synthetic */ SwitchPreference f$1;
    ...
    private void setSummary(Preference preference, String str) {
        if (str == null) {
            preference.setSummary(C1784R$string.lockscreen_none);
            return;
        }
    ...
    public static class Holder extends RecyclerView.ViewHolder {
        ...
        public Holder(View view) {
            ...
            this.expand = (ExpandableIndicator) view.findViewById(C1777R$id.expand);
        }
    }
        ...
        public void toggleExpando(Adapter adapter) {
            ...
            if (this.mExpanded) {
                this.mChildren.forEach(new Consumer(adapter) {
                    private final /* synthetic */ LockscreenFragment.Adapter f$1;
    ...
    public static class Adapter extends RecyclerView.Adapter<Holder> {
        ...
        public Holder onCreateViewHolder(ViewGroup viewGroup, int i) {
            return new Holder(LayoutInflater.from(viewGroup.getContext()).inflate(C1779R$layout.tuner_shortcut_item, viewGroup, false));
        }
        ...
        public void onBindViewHolder(Holder holder, int i) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener(holder) {
                private final /* synthetic */ LockscreenFragment.Holder f$1;
    ...
    private static class ShortcutButton implements IntentButtonProvider.IntentButton {
        ...
        public ShortcutButton(Context context, ShortcutParser.Shortcut shortcut) {
            ...
            Drawable drawable = iconState2.drawable;
