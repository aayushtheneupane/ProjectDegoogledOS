...
public class PluginFragment extends PreferenceFragment {
    ...
    public void loadPrefs() {
        ...
        packageManager.getPackagesHoldingPermissions(new String[]{"com.android.systemui.permission.PLUGIN"}, 516).forEach(new Consumer(arrayMap, pluginManager, context, createPreferenceScreen) {
            ...
            private final /* synthetic */ PluginManager f$2;
            private final /* synthetic */ Context f$3;
            private final /* synthetic */ PreferenceScreen f$4;
    ...
    private static class PluginPreference extends SwitchPreference {
        ...
        public PluginPreference(Context context, PackageInfo packageInfo, PluginEnabler pluginEnabler) {
            ...
            setWidgetLayoutResource(C1779R$layout.tuner_widget_settings_switch);
        }
        ...
        private boolean isPluginEnabled() {
            ...
            while (true) {
                ...
                if (!this.mPluginEnabler.isEnabled(new ComponentName(packageInfo.packageName, serviceInfoArr[i].name))) {
                    return false;
                }
                i++;
            }
        ...
        public boolean persistBoolean(boolean z) {
            ...
            while (true) {
                ...
                ComponentName componentName = new ComponentName(packageInfo.packageName, serviceInfoArr[i].name);
        ...
        public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
            ...
            int i = 0;
            preferenceViewHolder.findViewById(C1777R$id.settings).setVisibility(this.mHasSettings ? 0 : 8);
            View findViewById = preferenceViewHolder.findViewById(C1777R$id.divider);
            if (!this.mHasSettings) {
                i = 8;
            }
            findViewById.setVisibility(i);
            preferenceViewHolder.findViewById(C1777R$id.settings).setOnClickListener(new View.OnClickListener() {
