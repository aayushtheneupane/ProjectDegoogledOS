    ...
    private static class Data {
        ...
        public float getAnglesVariance() {
            ...
            if (AnglesClassifier.VERBOSE) {
                ...
                FalsingLog.m19i(access$000, "getAnglesVariance: (first pass) " + anglesVariance);
                String access$0002 = AnglesClassifier.TAG;
                FalsingLog.m19i(access$0002, "   - mFirstLength=" + this.mFirstLength);
                String access$0003 = AnglesClassifier.TAG;
                FalsingLog.m19i(access$0003, "   - mLength=" + this.mLength);
            }
            if (this.mFirstLength < this.mLength / 2.0f) {
                ...
                if (AnglesClassifier.VERBOSE) {
                    ...
                    FalsingLog.m19i(access$0004, "getAnglesVariance: (second pass) " + anglesVariance);
                }
            }
        ...
        public float getAnglesPercentage() {
            if (this.mAnglesCount != 0.0f) {
                ...
                if (AnglesClassifier.VERBOSE) {
                    String access$000 = AnglesClassifier.TAG;
                    FalsingLog.m19i(access$000, "getAnglesPercentage: left=" + this.mLeftAngles + " right=" + this.mRightAngles + " straight=" + this.mStraightAngles + " count=" + this.mAnglesCount + " result=" + max);
                }
                return max;
            } else if (!AnglesClassifier.VERBOSE) {
                return 1.0f;
            } else {
                FalsingLog.m19i(AnglesClassifier.TAG, "getAnglesPercentage: count==0, result=1");
                return 1.0f;
            }
        }
    }
