...
public class HumanInteractionClassifier extends Classifier {
    ...
    public void updateConfiguration() {
        this.mEnableClassifier = Settings.Global.getInt(this.mContext.getContentResolver(), "HIC_enable", this.mContext.getResources().getBoolean(C1773R$bool.config_lockscreenAntiFalsingClassifierEnabled) ? 1 : 0) != 0;
    }
    ...
    private void addTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.mClassifierData.update(motionEvent2)) {
            ...
            while (true) {
                ...
                if (FalsingLog.ENABLED) {
                    FalsingLog.m19i(" addTouchEvent", sb.toString());
                }
    ...
    public boolean isFalseTouch() {
        ...
        if (this.mEnableClassifier) {
            ...
            if (FalsingLog.ENABLED) {
                FalsingLog.m19i("isFalseTouch", "eval=" + evaluation + " result=" + (z ? 1 : 0));
            }
        }
        return z;
    }
