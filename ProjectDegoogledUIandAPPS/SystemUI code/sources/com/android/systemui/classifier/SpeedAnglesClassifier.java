    ...
    private static class Data {
        ...
        public float getAnglesVariance() {
            ...
            if (SpeedAnglesClassifier.VERBOSE) {
                FalsingLog.m19i("SPD_ANG", "getAnglesVariance: sum^2=" + this.mSumSquares + " count=" + this.mCount + " result=" + f4);
            }
            return f4;
        }
        ...
        public float getAnglesPercentage() {
            ...
            if (SpeedAnglesClassifier.VERBOSE) {
                FalsingLog.m19i("SPD_ANG", "getAnglesPercentage: angles=" + this.mAcceleratingAngles + " count=" + this.mAnglesCount + " result=" + f2);
            }
            return f2;
        }
    }
