...
public class UsbResolverActivity extends ResolverActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        UsbResolverActivity.super.onCreate(bundle, intent2, getResources().getText(17039686), (Intent[]) null, arrayList, true);
        CheckBox checkBox = (CheckBox) findViewById(16908723);
        if (checkBox == null) {
            return;
        }
        if (this.mDevice == null) {
            checkBox.setText(C1784R$string.always_use_accessory);
        } else {
            checkBox.setText(C1784R$string.always_use_device);
        }
    }
