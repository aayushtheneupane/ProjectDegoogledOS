...
public class GuestResumeSessionReceiver extends BroadcastReceiver {
    ...
    public void register(Context context) {
        ...
        context2.registerReceiverAsUser(this, UserHandle.SYSTEM, new IntentFilter("android.intent.action.USER_SWITCHED"), (String) null, (Handler) null);
    }
    ...
    private static class ResetSessionDialog extends SystemUIDialog implements DialogInterface.OnClickListener {
        ...
        public ResetSessionDialog(Context context, int i) {
            super(context);
            setTitle(context.getString(C1784R$string.guest_wipe_session_title));
            setMessage(context.getString(C1784R$string.guest_wipe_session_message));
            setCanceledOnTouchOutside(false);
            setButton(-2, context.getString(C1784R$string.guest_wipe_session_wipe), this);
            setButton(-1, context.getString(C1784R$string.guest_wipe_session_dontwipe), this);
            this.mUserId = i;
        }
