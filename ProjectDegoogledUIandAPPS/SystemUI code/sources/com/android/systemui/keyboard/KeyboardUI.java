...
public class KeyboardUI extends SystemUI implements InputManager.OnTabletModeChangedListener {
    ...
    public void init() {
        ...
        this.mKeyboardName = context.getString(17039808);
        if (!TextUtils.isEmpty(this.mKeyboardName) && (localBluetoothManager = (LocalBluetoothManager) Dependency.get(LocalBluetoothManager.class)) != null) {
            this.mEnabled = true;
    ...
    private final class KeyboardUIHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (i != 8) {
                ...
                KeyboardUI.this.mDialog.setTitle(C1784R$string.enable_bluetooth_title);
                KeyboardUI.this.mDialog.setMessage(C1784R$string.enable_bluetooth_message);
                KeyboardUI.this.mDialog.setPositiveButton(C1784R$string.enable_bluetooth_confirmation_ok, bluetoothDialogClickListener);
