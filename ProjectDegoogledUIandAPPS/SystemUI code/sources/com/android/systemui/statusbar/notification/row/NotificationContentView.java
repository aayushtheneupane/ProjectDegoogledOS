...
public class NotificationContentView extends FrameLayout {
    ...
    public void initView() {
        this.mMinContractedHeight = getResources().getDimensionPixelSize(C1775R$dimen.min_notification_layout_height);
        this.mNotificationContentMarginEnd = getResources().getDimensionPixelSize(17105310);
    }
    ...
    private int getExtraRemoteInputHeight(RemoteInputView remoteInputView) {
        ...
        if (remoteInputView.isActive() || remoteInputView.isSending()) {
            return getResources().getDimensionPixelSize(17105309);
        }
        return 0;
    }
    ...
    public void onViewAdded(View view) {
        ...
        view.setTag(C1777R$id.row_tag_for_content_view, this.mContainingNotification);
    }
    ...
    private int getMinContentHeightHint() {
        ...
        if (this.mIsChildInGroup && isVisibleOrTransitioning(3)) {
            return this.mContext.getResources().getDimensionPixelSize(17105300);
        }
        ...
        if (this.mHeadsUpChild != null && isVisibleOrTransitioning(2)) {
            ...
            i = getViewHeight(0) + this.mContext.getResources().getDimensionPixelSize(17105300);
        }
    ...
    private void applyMediaTransfer(NotificationEntry notificationEntry) {
        ...
        if (view != null && notificationEntry.isMediaNotification()) {
            View findViewById = view.findViewById(16909097);
    ...
    private RemoteInputView applyRemoteInput(View view, NotificationEntry notificationEntry, boolean z, PendingIntent pendingIntent, RemoteInputView remoteInputView, NotificationViewWrapper notificationViewWrapper) {
        ...
        if (z) {
            ...
            if (i == 0) {
                i = this.mContext.getColor(C1774R$color.default_remote_input_background);
            }
            remoteInputView.setBackgroundColor(ContrastColorUtil.ensureTextBackgroundColor(i, this.mContext.getColor(C1774R$color.remote_input_text_enabled), this.mContext.getColor(C1774R$color.remote_input_hint)));
    ...
    private SmartReplyView applySmartReplyView(View view, InflatedSmartReplies.SmartRepliesAndActions smartRepliesAndActions, NotificationEntry notificationEntry, InflatedSmartReplies inflatedSmartReplies) {
        View findViewById = view.findViewById(16909377);
    ...
    public void updateExpandButtons(boolean z) {
        ...
        View view = this.mExpandedChild;
        boolean z2 = false;
        if (view == null || view.getHeight() == 0 || ((this.mIsHeadsUp || this.mHeadsUpAnimatingAway) && this.mHeadsUpChild != null && this.mContainingNotification.canShowHeadsUp() ? this.mExpandedChild.getHeight() > this.mHeadsUpChild.getHeight() : this.mExpandedChild.getHeight() > this.mContractedChild.getHeight())) {
            z2 = z;
        }
        if (this.mExpandedChild != null) {
    ...
    public int getHeadsUpHeight(boolean z) {
        return getViewHeight(this.mHeadsUpChild == null ? 0 : 2, z) + getExtraRemoteInputHeight(this.mHeadsUpRemoteInput) + getExtraRemoteInputHeight(this.mExpandedRemoteInput);
    }
