...
public class StackStateAnimator {
    ...
    public StackStateAnimator(NotificationStackScrollLayout notificationStackScrollLayout) {
        ...
        this.mGoToFullShadeAppearingTranslation = notificationStackScrollLayout.getContext().getResources().getDimensionPixelSize(C1775R$dimen.go_to_full_shade_appearing_translation);
        this.mPulsingAppearingTranslation = notificationStackScrollLayout.getContext().getResources().getDimensionPixelSize(C1775R$dimen.pulsing_notification_appear_translation);
    ...
    private void processAnimationEvents(java.util.ArrayList<com.android.systemui.statusbar.notification.stack.NotificationStackScrollLayout.AnimationEvent> r15) {
        ...
        L_0x014a:
            ...
            com.android.systemui.statusbar.StatusBarIconView r5 = r1.icon
            com.android.systemui.statusbar.StatusBarIconView r8 = r1.centeredIcon
            if (r8 == 0) goto L_0x0169
            android.view.ViewParent r8 = r8.getParent()
            if (r8 == 0) goto L_0x0169
            com.android.systemui.statusbar.StatusBarIconView r5 = r1.centeredIcon
        L_0x0169:
