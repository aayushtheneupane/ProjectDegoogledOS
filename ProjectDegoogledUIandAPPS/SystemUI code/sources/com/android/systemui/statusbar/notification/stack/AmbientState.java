...
public class AmbientState {
    ...
    private static int getZDistanceBetweenElements(Context context) {
        return Math.max(1, context.getResources().getDimensionPixelSize(C1775R$dimen.z_distance_between_notifications));
    }
    ...
    public boolean isPulsing(NotificationEntry notificationEntry) {
        ...
        return headsUpManager.isAlerting(notificationEntry.key);
    }
