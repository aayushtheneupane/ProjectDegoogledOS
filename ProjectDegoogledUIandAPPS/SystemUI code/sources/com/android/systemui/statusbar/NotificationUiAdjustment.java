...
public class NotificationUiAdjustment {
    ...
    NotificationUiAdjustment(String str, List<Notification.Action> list, CharSequence[] charSequenceArr) {
        List<Notification.Action> list2;
        ...
        this.smartActions = list2;
        if (charSequenceArr == null) {
            charSequenceArr2 = new CharSequence[0];
        } else {
            charSequenceArr2 = (CharSequence[]) charSequenceArr.clone();
        }
        this.smartReplies = charSequenceArr2;
    }

    public static NotificationUiAdjustment extractFromNotificationEntry(NotificationEntry notificationEntry) {
        return new NotificationUiAdjustment(notificationEntry.key, notificationEntry.systemGeneratedSmartActions, notificationEntry.systemGeneratedSmartReplies);
    }
    ...
    public static boolean needReinflate(NotificationUiAdjustment notificationUiAdjustment, NotificationUiAdjustment notificationUiAdjustment2) {
        ...
        return areDifferent(notificationUiAdjustment.smartActions, notificationUiAdjustment2.smartActions) || !Arrays.equals(notificationUiAdjustment.smartReplies, notificationUiAdjustment2.smartReplies);
    }
