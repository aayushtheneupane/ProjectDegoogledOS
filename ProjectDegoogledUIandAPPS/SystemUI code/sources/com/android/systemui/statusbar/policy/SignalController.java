...
public abstract class SignalController<T extends State, I extends IconGroup> {
    ...
    public CharSequence getStringIfExists(int i) {
    ...
    static class State {
        ...
        public void toString(StringBuilder sb) {
            ...
            sb.append(',');
            sb.append("activityDormant=");
            sb.append(this.activityDormant);
            sb.append(',');
            sb.append("rssi=");
            sb.append(this.rssi);
            sb.append(',');
        ...
        public boolean equals(Object obj) {
            ...
            if (state.connected == this.connected && state.enabled == this.enabled && state.level == this.level && state.inetCondition == this.inetCondition && state.iconGroup == this.iconGroup && state.activityIn == this.activityIn && state.activityOut == this.activityOut && state.activityDormant == this.activityDormant && state.rssi == this.rssi) {
                return true;
            }
            return false;
        }
