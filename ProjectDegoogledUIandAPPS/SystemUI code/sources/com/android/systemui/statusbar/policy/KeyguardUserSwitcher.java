...
public class KeyguardUserSwitcher {
    ...
    public KeyguardUserSwitcher(Context context, ViewStub viewStub, KeyguardStatusBarView keyguardStatusBarView, NotificationPanelView notificationPanelView) {
        boolean z = context.getResources().getBoolean(C1773R$bool.config_keyguardUserSwitcher);
    ...
    private void reinflateViews() {
        ...
        LayoutInflater.from(this.mUserSwitcherContainer.getContext()).inflate(C1779R$layout.keyguard_user_switcher_inner, this.mUserSwitcherContainer);
        this.mUserSwitcher = (ViewGroup) this.mUserSwitcherContainer.findViewById(C1777R$id.keyguard_user_switcher_inner);
    ...
    public static class Adapter extends UserSwitcherController.BaseUserAdapter implements View.OnClickListener {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (!(view instanceof UserDetailItemView) || !(view.getTag() instanceof UserSwitcherController.UserRecord)) {
                view = LayoutInflater.from(this.mContext).inflate(C1779R$layout.keyguard_user_switcher_item, viewGroup, false);
