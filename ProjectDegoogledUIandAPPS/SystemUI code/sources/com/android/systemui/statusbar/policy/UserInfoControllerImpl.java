...
public class UserInfoControllerImpl implements UserInfoController {
    ...
    private void queryForUserInformation() {
        try {
            ...
            final boolean z = this.mContext.getThemeResId() != C1785R$style.Theme_SystemUI_Light;
            Resources resources = this.mContext.getResources();
            final int max = Math.max(resources.getDimensionPixelSize(C1775R$dimen.multi_user_avatar_expanded_size), resources.getDimensionPixelSize(C1775R$dimen.multi_user_avatar_keyguard_size));
