...
public class KeyButtonDrawable extends Drawable {
    ...
    public static KeyButtonDrawable create(Context context, int i, boolean z, Color color) {
        return create(new ContextThemeWrapper(context, Utils.getThemeAttr(context, C1772R$attr.lightIconTheme)), new ContextThemeWrapper(context, Utils.getThemeAttr(context, C1772R$attr.darkIconTheme)), i, z, color);
    }
    ...
    public static KeyButtonDrawable create(Context context, Context context2, int i, boolean z, Color color) {
        return create(context, Utils.getColorAttrDefaultColor(context, C1772R$attr.singleToneColor), Utils.getColorAttrDefaultColor(context2, C1772R$attr.singleToneColor), i, z, color);
    }
    ...
    public static KeyButtonDrawable create(Context context, int i, int i2, int i3, boolean z, Color color) {
        ...
        if (z) {
            keyButtonDrawable.setShadowProperties(resources.getDimensionPixelSize(C1775R$dimen.nav_key_button_shadow_offset_x), resources.getDimensionPixelSize(C1775R$dimen.nav_key_button_shadow_offset_y), resources.getDimensionPixelSize(C1775R$dimen.nav_key_button_shadow_radius), context.getColor(C1774R$color.nav_key_button_shadow_color));
        }
