...
public class DeadZone {
    ...
    public void onConfigurationChanged(int i) {
        ...
        this.mHold = resources.getInteger(C1778R$integer.navigation_bar_deadzone_hold);
        this.mDecay = resources.getInteger(C1778R$integer.navigation_bar_deadzone_decay);
        this.mSizeMin = resources.getDimensionPixelSize(C1775R$dimen.navigation_bar_deadzone_size);
        this.mSizeMax = resources.getDimensionPixelSize(C1775R$dimen.navigation_bar_deadzone_size_max);
        boolean z = true;
        if (resources.getInteger(C1778R$integer.navigation_bar_deadzone_orientation) != 1) {
            z = false;
        }
        this.mVertical = z;
        setFlashOnTouchCapture(resources.getBoolean(C1773R$bool.config_dead_zone_flash));
    }
