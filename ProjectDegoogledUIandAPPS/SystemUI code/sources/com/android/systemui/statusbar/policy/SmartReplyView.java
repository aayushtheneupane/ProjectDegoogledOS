...
public class SmartReplyView extends ViewGroup {
    ...
    private final int mHeightUpperLimit = NotificationUtils.getFontScaledHeight(this.mContext, C1775R$dimen.smart_reply_button_max_height);
    ...
    public SmartReplyView(Context context, AttributeSet attributeSet) {
        ...
        this.mCurrentBackgroundColor = context.getColor(C1774R$color.smart_reply_button_background);
        this.mDefaultBackgroundColor = this.mCurrentBackgroundColor;
        this.mDefaultTextColor = this.mContext.getColor(C1774R$color.smart_reply_button_text);
        this.mDefaultTextColorDarkBg = this.mContext.getColor(C1774R$color.smart_reply_button_text_dark_bg);
        this.mDefaultStrokeColor = this.mContext.getColor(C1774R$color.smart_reply_button_stroke);
        this.mRippleColor = this.mContext.getColor(C1774R$color.notification_ripple_untinted_color);
    ...
    public static SmartReplyView inflate(Context context) {
        return (SmartReplyView) LayoutInflater.from(context).inflate(C1779R$layout.smart_reply_view, (ViewGroup) null);
    }
    ...
    static Button inflateReplyButton(SmartReplyView smartReplyView, Context context, int i, SmartReplies smartReplies, SmartReplyController smartReplyController, NotificationEntry notificationEntry, boolean z) {
        ...
        Button button = (Button) LayoutInflater.from(context).inflate(C1779R$layout.smart_reply_button, smartReplyView, false);
        ...
        button.setAccessibilityDelegate(new View.AccessibilityDelegate() {
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
                ...
                accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, SmartReplyView.this.getResources().getString(C1784R$string.accessibility_send_smart_reply)));
            }
        });
    ...
    static android.widget.Button inflateActionButton(com.android.systemui.statusbar.policy.SmartReplyView r11, android.content.Context r12, android.content.Context r13, int r14, com.android.systemui.statusbar.policy.SmartReplyView.SmartActions r15, com.android.systemui.statusbar.SmartReplyController r16, com.android.systemui.statusbar.notification.collection.NotificationEntry r17, com.android.systemui.statusbar.policy.HeadsUpManager r18, boolean r19) {
        /*
            ...
            int r1 = com.android.systemui.C1779R$layout.smart_action_button
            r3 = 0
            ...
            int r4 = com.android.systemui.C1775R$dimen.smart_action_button_icon_size
