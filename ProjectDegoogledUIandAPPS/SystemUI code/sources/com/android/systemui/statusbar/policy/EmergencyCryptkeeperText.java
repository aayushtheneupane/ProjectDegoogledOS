...
public class EmergencyCryptkeeperText extends TextView {
    ...
    public void update() {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            IccCardConstants.State simState = this.mKeyguardUpdateMonitor.getSimState(filteredSubscriptionInfo.get(i2).getSubscriptionId());
        ...
        if (z2) {
            if (size != 0) {
                ...
                charSequence = getContext().getText(17039944);
