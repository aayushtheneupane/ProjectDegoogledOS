...
public class CastDrawable extends DrawableWrapper {
    ...
    public void inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        setDrawable(resources.getDrawable(C1776R$drawable.ic_cast, theme).mutate());
        this.mFillDrawable = resources.getDrawable(C1776R$drawable.ic_cast_connected_fill, theme).mutate();
        this.mHorizontalPadding = resources.getDimensionPixelSize(C1775R$dimen.status_bar_horizontal_padding);
    }
