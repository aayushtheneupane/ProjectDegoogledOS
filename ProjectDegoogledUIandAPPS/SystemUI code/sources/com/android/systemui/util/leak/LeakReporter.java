    ...
    public void dumpLeak(int i) {
        ...
        try {
            ...
            try {
                ...
                notificationManager.notify("LeakReporter", 0, new Notification.Builder(this.mContext, notificationChannel.getId()).setAutoCancel(true).setShowWhen(true).setContentTitle("Memory Leak Detected").setContentText(String.format("SystemUI has detected %d leaked objects. Tap to send", new Object[]{Integer.valueOf(i)})).setSmallIcon(17303532).setContentIntent(PendingIntent.getActivityAsUser(this.mContext, 0, getIntent(file2, file3), 201326592, (Bundle) null, UserHandle.CURRENT)).build());
            } catch (Throwable th2) {
                Throwable th3 = th2;
                fileOutputStream.close();
                throw th3;
