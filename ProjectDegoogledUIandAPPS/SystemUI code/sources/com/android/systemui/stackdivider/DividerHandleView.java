...
public class DividerHandleView extends View {
    ...
    public DividerHandleView(Context context, AttributeSet attributeSet) {
        ...
        this.mPaint.setColor(getResources().getColor(C1774R$color.docked_divider_handle, (Resources.Theme) null));
        this.mPaint.setAntiAlias(true);
        this.mWidth = getResources().getDimensionPixelSize(C1775R$dimen.docked_divider_handle_width);
        this.mHeight = getResources().getDimensionPixelSize(C1775R$dimen.docked_divider_handle_height);
        int i = this.mWidth;
