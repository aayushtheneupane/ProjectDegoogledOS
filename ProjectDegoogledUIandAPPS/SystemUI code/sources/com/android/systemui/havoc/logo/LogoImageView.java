...
public class LogoImageView extends ImageView {
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        public void observe() {
            ContentResolver contentResolver = LogoImageView.this.mContext.getContentResolver();
        ...
        public void onChange(boolean z) {
            LogoImageView.this.updateSettings();
        }
    }
    ...
    public void updateHavocLogo() {
        Drawable drawable;
        if (!this.mHavocLogo || this.mHavocLogoPosition == 1) {
