...
public class PipAccessibilityInteractionConnection extends IAccessibilityInteractionConnection.Stub {
            ...
            if (i == 16) {
                this.mHandler.post(new Runnable() {
                    public final void run() {
                        PipAccessibilityInteractionConnection.this.mo10778x29fe36a1();
                    }
                });
            } else if (i == 262144) {
    ...
    /* renamed from: lambda$performAccessibilityAction$0$PipAccessibilityInteractionConnection */
    public /* synthetic */ void mo10778x29fe36a1() {
