...
public class PipControlsView extends LinearLayout {
    ...
    public PipControlsView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mLayoutInflater.inflate(C1779R$layout.tv_pip_controls, this);
    ...
    public void onFinishInflate() {
        ...
        this.mFullButtonView = (PipControlButtonView) findViewById(C1777R$id.full_button);
        ...
        this.mCloseButtonView = (PipControlButtonView) findViewById(C1777R$id.close_button);
        ...
        this.mPlayPauseButtonView = (PipControlButtonView) findViewById(C1777R$id.play_pause_button);
    ...
    public void updateUserActions() {
        ...
        if (!this.mCustomActions.isEmpty()) {
            while (this.mCustomButtonViews.size() < this.mCustomActions.size()) {
                PipControlButtonView pipControlButtonView = (PipControlButtonView) this.mLayoutInflater.inflate(C1779R$layout.tv_pip_custom_control, this, false);
        ...
        if (playbackState == 2) {
            ...
            if (playbackState == 0) {
                this.mPlayPauseButtonView.setImageResource(C1776R$drawable.ic_pause_white);
                this.mPlayPauseButtonView.setText(C1784R$string.pip_pause);
            } else {
                this.mPlayPauseButtonView.setImageResource(C1776R$drawable.ic_play_arrow_white);
                this.mPlayPauseButtonView.setText(C1784R$string.pip_play);
            }
        }
