...
public class KeyguardClockSwitch extends RelativeLayout {
    ...
    public KeyguardClockSwitch(Context context, AttributeSet attributeSet, StatusBarStateController statusBarStateController, SysuiColorExtractor sysuiColorExtractor, ClockManager clockManager) {
        ...
        this.mClockTransition.addTarget(C1777R$id.default_clock_view);
        ...
        this.mBoldClockTransition.addTarget(C1777R$id.default_clock_view_bold);
    ...
    public void onFinishInflate() {
        ...
        this.mClockView = (TextClock) findViewById(C1777R$id.default_clock_view);
        this.mClockViewBold = (TextClock) findViewById(C1777R$id.default_clock_view_bold);
        this.mSmallClockFrame = (FrameLayout) findViewById(C1777R$id.clock_view);
        this.mKeyguardStatusArea = findViewById(C1777R$id.keyguard_status_area);
    }
    ...
    public void setClockPlugin(ClockPlugin clockPlugin) {
        ...
        View view3 = this.mKeyguardStatusArea;
    ...
    public void setKeyguardShowingHeader(boolean z) {
        if (this.mShowingHeader != z) {
            ...
            if (!hasCustomClock()) {
                float dimensionPixelSize = (float) this.mContext.getResources().getDimensionPixelSize(C1775R$dimen.widget_small_font_size);
                float dimensionPixelSize2 = (float) this.mContext.getResources().getDimensionPixelSize(C1775R$dimen.widget_big_font_size);
                ...
                int dimensionPixelSize3 = this.mContext.getResources().getDimensionPixelSize(z ? C1775R$dimen.widget_vertical_padding_clock : C1775R$dimen.title_clock_padding);
    ...
    private class ClockVisibilityTransition extends Visibility {
        ...
        private Animator createAnimator(final View view, float f, final int i, final int i2, float f2, float f3) {
            ...
            ofFloat.addListener(new KeepAwakeAnimationListener(KeyguardClockSwitch.this.getContext()) {
