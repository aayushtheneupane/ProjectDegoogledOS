...
public class TypeClockController implements ClockPlugin {
    ...
    private void createViews() {
        this.mView = this.mLayoutInflater.inflate(C1779R$layout.type_aod_clock, (ViewGroup) null);
        this.mTypeClock = (TypographicClock) this.mView.findViewById(C1777R$id.type_clock);
        this.mLockClock = (TypographicClock) this.mLayoutInflater.inflate(C1779R$layout.typographic_clock, (ViewGroup) null);
    ...
    public String getTitle() {
        return this.mResources.getString(C1784R$string.clock_title_type);
    }
