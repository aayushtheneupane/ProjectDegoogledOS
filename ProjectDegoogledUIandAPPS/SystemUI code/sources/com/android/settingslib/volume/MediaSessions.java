...
public class MediaSessions {
    ...
    public MediaSessions(Context context, Looper looper, Callbacks callbacks) {
        ...
        this.mHandler = new C0560H(looper);
    ...
    private final class MediaControllerRecord extends MediaController.Callback {
        ...
        /* renamed from: cb */
        private String m3cb(String str) {
        ...
        public void onAudioInfoChanged(MediaController.PlaybackInfo playbackInfo) {
            if (C0557D.BUG) {
                ...
                Log.d(access$200, m3cb("onAudioInfoChanged") + Util.playbackInfoToString(playbackInfo) + " sentRemote=" + this.sentRemote);
            }
        ...
        public void onExtrasChanged(Bundle bundle) {
            if (C0557D.BUG) {
                String access$200 = MediaSessions.TAG;
                Log.d(access$200, m3cb("onExtrasChanged") + bundle);
            }
        }
        ...
        public void onMetadataChanged(MediaMetadata mediaMetadata) {
            if (C0557D.BUG) {
                String access$200 = MediaSessions.TAG;
                Log.d(access$200, m3cb("onMetadataChanged") + Util.mediaMetadataToString(mediaMetadata));
            }
        }
        ...
        public void onPlaybackStateChanged(PlaybackState playbackState) {
            if (C0557D.BUG) {
                String access$200 = MediaSessions.TAG;
                Log.d(access$200, m3cb("onPlaybackStateChanged") + Util.playbackStateToString(playbackState));
            }
        }
        ...
        public void onQueueChanged(List<MediaSession.QueueItem> list) {
            if (C0557D.BUG) {
                String access$200 = MediaSessions.TAG;
                Log.d(access$200, m3cb("onQueueChanged") + list);
            }
        }
        ...
        public void onQueueTitleChanged(CharSequence charSequence) {
            if (C0557D.BUG) {
                String access$200 = MediaSessions.TAG;
                Log.d(access$200, m3cb("onQueueTitleChanged") + charSequence);
            }
        }

        public void onSessionDestroyed() {
            if (C0557D.BUG) {
                Log.d(MediaSessions.TAG, m3cb("onSessionDestroyed"));
            }
        }
        ...
        public void onSessionEvent(String str, Bundle bundle) {
            if (C0557D.BUG) {
                String access$200 = MediaSessions.TAG;
                Log.d(access$200, m3cb("onSessionEvent") + "event=" + str + " extras=" + bundle);
            }
        }
    }

    /* renamed from: com.android.settingslib.volume.MediaSessions$H */
    private final class C0560H extends Handler {
        private C0560H(Looper looper) {
            super(looper);
        }
