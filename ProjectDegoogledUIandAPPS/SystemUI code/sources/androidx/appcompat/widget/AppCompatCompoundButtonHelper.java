...
class AppCompatCompoundButtonHelper {
    ...
    public void loadFromAttributes(android.util.AttributeSet r4, int r5) {
        ...
        L_0x0063:
            ...
            android.widget.CompoundButton r3 = r3.mView     // Catch:{ all -> 0x0080 }
            int r5 = androidx.appcompat.R$styleable.CompoundButton_buttonTintMode     // Catch:{ all -> 0x0080 }
            r0 = -1
            int r5 = r4.getInt(r5, r0)     // Catch:{ all -> 0x0080 }
            r0 = 0
            android.graphics.PorterDuff$Mode r5 = androidx.appcompat.widget.DrawableUtils.parseTintMode(r5, r0)     // Catch:{ all -> 0x0080 }
            androidx.core.widget.CompoundButtonCompat.setButtonTintMode(r3, r5)     // Catch:{ all -> 0x0080 }
        L_0x007c:
            r4.recycle()
            return
        L_0x0080:
