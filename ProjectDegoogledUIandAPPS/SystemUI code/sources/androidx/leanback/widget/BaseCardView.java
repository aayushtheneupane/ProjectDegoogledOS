...
public class BaseCardView extends FrameLayout {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (hasInfoRegion()) {
            ...
            for (int i9 = 0; i9 < this.mInfoViewList.size(); i9++) {
                View view2 = this.mInfoViewList.get(i9);
            ...
            if (hasExtraRegion()) {
                ...
                for (int i11 = 0; i11 < this.mExtraViewList.size(); i11++) {
                    View view3 = this.mExtraViewList.get(i11);
        ...
        if (hasInfoRegion()) {
            ...
            for (int i8 = 0; i8 < this.mInfoViewList.size(); i8++) {
                ...
                if (view2.getVisibility() != 8) {
                    ...
                    f2 += f3;
                    view2.layout(getPaddingLeft(), (int) f2, this.mMeasuredWidth + getPaddingLeft(), (int) f2);
                    f -= f3;
                    if (f <= 0.0f) {
                        break;
                    }
            ...
            if (hasExtraRegion()) {
                for (int i9 = 0; i9 < this.mExtraViewList.size(); i9++) {
                    ...
                    if (view3.getVisibility() != 8) {
                        view3.layout(getPaddingLeft(), (int) f2, this.mMeasuredWidth + getPaddingLeft(), (int) (((float) view3.getMeasuredHeight()) + f2));
                        f2 += (float) view3.getMeasuredHeight();
                    }
                }
            }
        }
    ...
    private void animateInfoHeight(boolean z) {
        ...
        if (f2 != f) {
            this.mAnim = new InfoHeightAnimation(f2, f);
            this.mAnim.setDuration((long) this.mSelectedAnimDuration);
            this.mAnim.setInterpolator(new AccelerateDecelerateInterpolator());
            this.mAnim.setAnimationListener(new Animation.AnimationListener() {
                public void onAnimationRepeat(Animation animation) {
    ...
    private void animateInfoAlpha(boolean z) {
        ...
        if (f2 != f3) {
            ...
            this.mAnim = new InfoAlphaAnimation(f3, f);
