...
public class MediaRouteControllerDialog extends AlertDialog {
    ...
    public void onCreate(Bundle bundle) {
        ...
        C02464 r2 = new View.OnClickListener() {
            public void onClick(View view) {
    ...
    public void animateGroupListItemsInternal(Map<MediaRouter.RouteInfo, Rect> map, Map<MediaRouter.RouteInfo, BitmapDrawable> map2) {
        ...
        if (set != null && this.mGroupMemberRoutesRemoved != null) {
            ...
            C02519 r3 = new Animation.AnimationListener() {
    ...
    private void fadeInAddedRoutes() {
        C024312 r0 = new Animation.AnimationListener() {
            public void onAnimationRepeat(Animation animation) {
            }
    ...
    private class FetchArtTask extends AsyncTask<Void, Void, Bitmap> {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:25:0x0054 A[Catch:{ IOException -> 0x00a3 }] */
        ...
        public android.graphics.Bitmap doInBackground(java.lang.Void... r10) {
            ...
            L_0x000e:
                ...
                java.io.InputStream r0 = r9.openInputStreamByScheme(r0)     // Catch:{ IOException -> 0x00a8, all -> 0x00a5 }
            ...
            L_0x00aa:
                ...
                r6.append(r10)     // Catch:{ all -> 0x00c4 }
                android.net.Uri r10 = r9.mIconUri     // Catch:{ all -> 0x00c4 }
                r6.append(r10)     // Catch:{ all -> 0x00c4 }
                java.lang.String r10 = r6.toString()     // Catch:{ all -> 0x00c4 }
                android.util.Log.w(r3, r10, r5)     // Catch:{ all -> 0x00c4 }
                if (r0 == 0) goto L_0x00cb
