...
final class RegisteredMediaRouteProvider extends MediaRouteProvider implements ServiceConnection {
    ...
    /* access modifiers changed from: package-private */
    public void onDynamicRouteDescriptorChanged(Connection connection, int i, List<MediaRouteProvider.DynamicGroupRouteController.DynamicRouteDescriptor> list) {
        if (this.mActiveConnection == connection) {
            if (DEBUG) {
    ...
    private final class RegisteredDynamicController extends MediaRouteProvider.DynamicGroupRouteController implements ControllerConnection {
        ...
        public void attachConnection(Connection connection) {
            C02711 r0 = new MediaRouter.ControlRequestCallback() {
            ...
            this.mControllerId = connection.createDynamicGroupRouteController(this.mInitialMemberRouteId, r0);
            if (this.mSelected) {
        ...
        /* access modifiers changed from: package-private */
        public void onDynamicRoutesChanged(List<MediaRouteProvider.DynamicGroupRouteController.DynamicRouteDescriptor> list) {
    ...
    private final class Connection implements IBinder.DeathRecipient {
        ...
        public boolean register() {
            ...
            if (!sendRequest(1, this.mPendingRegisterRequestId, 3, (Object) null, (Bundle) null)) {
                return false;
            }
            try {
