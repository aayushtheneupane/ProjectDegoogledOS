    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        for (int i19 = 0; i19 < i14; i19++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i17) {
                ...
                if (this.mOrientation == 1) {
                    i10 = RecyclerView.LayoutManager.getChildMeasureSpec(spaceForSpanRange, 1073741824, i21, layoutParams.width, false);
                    ...
                    i9 = RecyclerView.LayoutManager.getChildMeasureSpec(spaceForSpanRange, 1073741824, i20, layoutParams.height, false);
                    i10 = makeMeasureSpec;
                }
